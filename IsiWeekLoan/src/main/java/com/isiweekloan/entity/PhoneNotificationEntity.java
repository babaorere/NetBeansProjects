...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "phone_notification", schema = "isiweekloanservices", catalog = "")
public class PhoneNotificationEntity {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, idPerson, idLoanContract, subject, sentAt, body, dateOfCall);
    }
    ...
    public boolean equals(final Object inO) {
        ...
        PhoneNotificationEntity that = (PhoneNotificationEntity) inO;
        return Objects.equals(id, that.id) && Objects.equals(idPerson, that.idPerson) && Objects.equals(idLoanContract, that.idLoanContract) && Objects.equals(subject, that.subject) && Objects.equals(sentAt, that.sentAt) && Objects.equals(body, that.body) && Objects.equals(dateOfCall, that.dateOfCall);
    }
