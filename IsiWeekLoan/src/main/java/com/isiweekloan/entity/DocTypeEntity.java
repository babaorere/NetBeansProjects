...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "doc_type", schema = "isiweekloanservices", catalog = "")
public class DocTypeEntity {

    @OneToMany(cascade = CascadeType.ALL, mappedBy = "idDocType", fetch = FetchType.LAZY)
    ...
    public boolean equals(final Object inO) {
        ...
        DocTypeEntity that = (DocTypeEntity) inO;
