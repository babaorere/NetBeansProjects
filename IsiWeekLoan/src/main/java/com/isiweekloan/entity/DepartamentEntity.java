...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "departament", schema = "isiweekloanservices", catalog = "")
public class DepartamentEntity {

    @OneToMany(cascade = CascadeType.ALL, mappedBy = "idDepartment", fetch = FetchType.LAZY)
    ...
    public boolean equals(final Object inO) {
        ...
        DepartamentEntity that = (DepartamentEntity) inO;
