...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "loan_status", schema = "isiweekloanservices", catalog = "")
public class LoanStatusEntity {

    @OneToMany(cascade = CascadeType.ALL, mappedBy = "idLoanStatus", fetch = FetchType.LAZY)
    ...
    public boolean equals(final Object inO) {
        ...
        LoanStatusEntity that = (LoanStatusEntity) inO;
