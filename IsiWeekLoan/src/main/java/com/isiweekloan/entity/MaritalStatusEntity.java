...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "marital_status", schema = "isiweekloanservices", catalog = "")
public class MaritalStatusEntity {

    @OneToMany(cascade = CascadeType.ALL, mappedBy = "idMaritalStatus", fetch = FetchType.LAZY)
    ...
    public boolean equals(final Object inO) {
        ...
        MaritalStatusEntity that = (MaritalStatusEntity) inO;
