...
public class ArchivoDatos {
    ...
    private static Vehiculo[] arrAuto;
    ...
    public static Vehiculo[] leerDeArchivo() {
        ...
        try ( Scanner sc = new Scanner(new File(FNAME))) {
            ...
            while (sc.hasNextLine()) {
                ...
                arrAuto[cant++] = new Vehiculo(marca, velocidad, potencia, pasajeros, costo, consumo, anio);
    ...
    public static boolean guardarEnArchivo(Vehiculo[] arrAuto) {
