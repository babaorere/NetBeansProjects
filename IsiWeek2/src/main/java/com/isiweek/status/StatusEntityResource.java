...
public class StatusEntityResource {
    ...
    public StatusEntityResource(final StatusService statusEntityService) {
        this.statusEntityService = statusEntityService;
    }

    @GetMapping
    public ResponseEntity<List<StatusDTO>> getAllStatusEntities() {
        return ResponseEntity.ok(statusEntityService.findAll());
    }

    @GetMapping("/{id}")
    public ResponseEntity<StatusDTO> getStatusEntity(
    ...
    public ResponseEntity<Long> createStatusEntity(
            @RequestBody @Valid final StatusDTO statusEntityDTO) {
