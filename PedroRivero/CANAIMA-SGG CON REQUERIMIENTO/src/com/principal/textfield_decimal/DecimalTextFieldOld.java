 ...
 * @author CAPIP
 */
public enum DecimalTextFieldOld {
    ...
    public static JFormattedTextField getTextField(BigDecimal inmin, BigDecimal inmax) {
        JFormattedTextField textf = null;
        try {
            textf = new JFormattedTextField(new DefaultFormatterFactory(DecimalFormatter.getDisplayFormatter(), DecimalFormatter.getDisplayFormatter(), DecimalFormatter.getEditFormatter()));
