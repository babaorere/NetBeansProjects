...
public final class PagoConsultar extends javax.swing.JFrame {
     ...
     * @param inparent
     */
    public PagoConsultar(java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
    ...
    void initComponents() {
        ...
        // NOI18N
        txtNumPag.setFont(new java.awt.Font("Arial", 3, 18));
        txtNumPag.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtNumPag.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtNumPag.setSelectionColor(new java.awt.Color(175, 204, 125));
...
//GEN-LAST:event_btnAceptarActionPerformed
    ...
    private void txtNumPagActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtNumPagActionPerformed
        actConsultar();
    }
...
//GEN-LAST:event_txtNumPagActionPerformed
    ...
    private static final Logger logger = LogManager.getLogger(PagoConsultar.class);
}
