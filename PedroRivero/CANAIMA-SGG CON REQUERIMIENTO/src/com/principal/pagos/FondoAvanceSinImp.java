...
import com.principal.bancos.BancosChequeAvanceCambiar;
...
public final class FondoAvanceSinImp extends javax.swing.JFrame {
     ...
     * @param inparent
     */
    public FondoAvanceSinImp(final java.awt.Window inparent) {
        super();
        initComponents();
    ...
    private void setCompBehavior() {
        ...
        txtMontoTotal.getDocument().addDocumentListener(new DocumentListener() {
    ...
    private void initComponents() {
        ...
        // NOI18N
        txtIvaRetenido.setFont(new java.awt.Font("Arial", 3, 14));
        jPanel5.add(txtIvaRetenido);
        txtIvaRetenido.setBounds(160, 40, 120, 30);
        txtISLR.setBackground(new java.awt.Color(175, 204, 125));
        txtISLR.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        txtISLR.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtISLR.setEnabled(false);
        // NOI18N
        txtISLR.setFont(new java.awt.Font("Arial", 3, 14));
        jPanel5.add(txtISLR);
        ...
        txtMontoRet.setBackground(new java.awt.Color(175, 204, 125));
        txtMontoRet.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        txtMontoRet.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtMontoRet.setEnabled(false);
        // NOI18N
        txtMontoRet.setFont(new java.awt.Font("Arial", 3, 14));
        ...
        tbtnCero.setBackground(java.awt.SystemColor.inactiveCaption);
        buttonGroup.add(tbtnCero);
        // NOI18N
        tbtnCero.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        tbtn75.setBackground(java.awt.SystemColor.inactiveCaption);
        buttonGroup.add(tbtn75);
        // NOI18N
        tbtn75.setFont(new java.awt.Font("Arial", 2, 14));
        tbtn75.setText("75%");
        ...
        tbtn100.setBackground(java.awt.SystemColor.inactiveCaption);
        buttonGroup.add(tbtn100);
        // NOI18N
        tbtn100.setFont(new java.awt.Font("Arial", 2, 14));
        tbtn100.setText("100%");
        ...
        // NOI18N
        cmbCuentas.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        txtNumCheque.setBackground(new java.awt.Color(175, 204, 125));
        // NOI18N
        txtNumCheque.setFont(new java.awt.Font("Arial", 3, 18));
        txtNumCheque.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtNumCheque.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtNumCheque.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        ...
        txtSaldoCuenta.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtSaldoCuenta.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtSaldoCuenta.setEnabled(false);
        // NOI18N
        txtSaldoCuenta.setFont(new java.awt.Font("Arial", 3, 18));
        jPanel3.add(txtSaldoCuenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 130, 180, 40));
        // NOI18N
        ...
        txtMontoTotal.setBackground(new java.awt.Color(175, 204, 125));
        ...
        // NOI18N
        txtMontoTotal.setFont(new java.awt.Font("Arial", 3, 14));
        ...
        txtIVA_Aplicado.setBackground(new java.awt.Color(175, 204, 125));
        txtIVA_Aplicado.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        txtIVA_Aplicado.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtIVA_Aplicado.setEnabled(false);
        // NOI18N
        txtIVA_Aplicado.setFont(new java.awt.Font("Arial", 3, 14));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.ipadx = 176;
        ...
        txtRetenciones.setBackground(new java.awt.Color(175, 204, 125));
        txtRetenciones.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        txtRetenciones.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtRetenciones.setEnabled(false);
        // NOI18N
        txtRetenciones.setFont(new java.awt.Font("Arial", 3, 14));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.ipadx = 176;
        ...
        jPanel7Layout.setHorizontalGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel7Layout.createSequentialGroup().addGap(57, 57, 57).addComponent(jLabel35).addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addGroup(jPanel7Layout.createSequentialGroup().addGap(12, 12, 12).addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(rbtnIvaExcento, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(rbtnIvaAct, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addContainerGap()));
        jPanel7Layout.setVerticalGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel7Layout.createSequentialGroup().addGap(9, 9, 9).addComponent(jLabel35).addGap(18, 18, 18).addComponent(rbtnIvaExcento).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(rbtnIvaAct, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE).addGap(153, 153, 153)));
        jPanel1.add(jPanel7);
        ...
        txtPagoNum.setBackground(new java.awt.Color(175, 204, 125));
        txtPagoNum.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtPagoNum.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtPagoNum.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtPagoNum.setEnabled(false);
        // NOI18N
        txtPagoNum.setFont(new java.awt.Font("Arial", 3, 32));
        ...
        // NOI18N
        txtRif.setFont(new java.awt.Font("Arial", 3, 18));
        txtRif.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtRif.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtRif.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtRif.setEnabled(false);
        txtRif.setSelectionColor(new java.awt.Color(175, 204, 125));
        ...
        // NOI18N
        btnGuardar.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        // NOI18N
        btnEditarCheque.setFont(new java.awt.Font("Arial", 2, 16));
        btnEditarCheque.setText(" EDITAR ULT. CH. ");
        btnEditarCheque.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        btnGuardar1.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnGuardar1.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        tblBenef.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "BENEFICIARIOS", "RIF / CI", "DIRECCIÓN", "TELÉFONOS" }) {
...
//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            txtMontoTotal.requestFocusInWindow();
            JOptionPane.showMessageDialog(null, "Monto inválido" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        ...
        try {
            ...
            txtMontoTotal.requestFocusInWindow();
            JOptionPane.showMessageDialog(null, "Error al recuperar el monto Total: " + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        ...
        try {
            ...
            txtMontoTotal.requestFocusInWindow();
            JOptionPane.showMessageDialog(null, "Error en el IVA" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        ...
        try {
            ...
            txtMontoTotal.requestFocusInWindow();
            JOptionPane.showMessageDialog(null, "Monto grabable inválido" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        ...
        try {
            ...
            txtMontoTotal.requestFocusInWindow();
            JOptionPane.showMessageDialog(null, "Monto excento inválido" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        if (sTotExe.isEmpty()) {
        ...
        try {
            ...
            txtMontoTotal.requestFocusInWindow();
            JOptionPane.showMessageDialog(null, "Base imponible inválido" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al formatear el monto total: " + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        ///////////////////////////////////////////////////////////////////////////////////////////
        ...
        try {
            ...
            txtMontoTotal.requestFocusInWindow();
            JOptionPane.showMessageDialog(null, "Monto retenido inválido" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Saldo inválido" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        try {
        ...
        try {
            final PreparedStatement pstCheck = ConnCapip.getInstance().getConnection().prepareStatement("SELECT * FROM bancos_operaciones " + "WHERE cuenta= ? AND soporte_o_cheque= ?");
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de verificar el número de cheque" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        if (JOptionPane.showConfirmDialog(this, "¿Seguro desea Guardar?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
            try {
...
//GEN-FIRST:event_btnSalirActionPerformed
        ...
        if (montoAPagar.isEmpty() || montoAPagar.equals("0,00")) {
            ...
            salir = JOptionPane.showConfirmDialog(this, "¿Hay datos cargados . ¿ Seguro desea Salir ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION;
        }
        if (salir) {
            if (parent != null) {
...
//GEN-LAST:event_tblBenefMouseClicked
    private void tbtnCeroActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_tbtnCeroActionPerformed
        setTotales();
    }

//GEN-LAST:event_tbtnCeroActionPerformed
    private void tbtn75ActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_tbtn75ActionPerformed
        setTotales();
    }

//GEN-LAST:event_tbtn75ActionPerformed
    private void tbtn100ActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_tbtn100ActionPerformed
        setTotales();
    }

//GEN-LAST:event_tbtn100ActionPerformed
    private void rbtnIvaActActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_rbtnIvaActActionPerformed
...
//GEN-LAST:event_rbtnIvaActActionPerformed
    private void rbtnIvaExcentoActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_rbtnIvaExcentoActionPerformed
        tbtnCero.setEnabled(false);
        tbtn75.setEnabled(false);
        tbtn100.setEnabled(false);
        setTotales();
...
//GEN-LAST:event_txaConceptoKeyTyped
    private void btnEditarChequeActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnEditarChequeActionPerformed
        if (ultNumOrden <= 0) {
            return;
        }
...
//GEN-FIRST:event_btnGuardar1ActionPerformed
        final java.awt.Window me = this;
        java.awt.EventQueue.invokeLater(new Runnable() {
...
//GEN-LAST:event_cmbCuentasItemStateChanged
    private void txtNumChequeKeyTyped(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_txtNumChequeKeyTyped
...
//GEN-LAST:event_txtNumChequeKeyTyped
    private void txtMontoTotalActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtMontoTotalActionPerformed
        cmbCuentas.requestFocusInWindow();
    }
...
//GEN-LAST:event_cmbIvaItemStateChanged
    private void checkIdAvaEfe() throws Exception {
        final ResultSet rs = ConnCapip.getInstance().executeQuery("SELECT MAX(id+1) FROM avance_efectivo");
        if (rs.next()) {
    ...
    private ParamRptPagAva AvaGuardar() throws Exception {
        ...
        try {
            ...
            logger.error(inex);
            throw new Exception("Monto a pagar", inex);
        }
        if (dMontoPagar <= 0.00d) {
            throw new Exception("Monto a pagar");
        }
    ...
    private ParamRptPagAva pagoMasterGenerar() throws Exception {
        ...
        final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement(// 1, 2, 3, 4
                "INSERT INTO avance_efectivo"
                + // 5, 6, 7, 8,
                "(id_user, id_session, date_session, ejefis, "
                + // 9, 10, 11, 12, 13, 14
                "benef_razonsocial, benef_rif_ci, fecha_pago, observacion, " + "banco, cuenta, cheque, fecha_cheque, endosable_sn, a_pagar_bs) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        pst.setString(6, rif);
        // fecha
        pst.setDate(7, fechaHoy);
        // observacion
        pst.setString(8, obs);
        // banco
        pst.setString(9, banco);
        // cuenta
        pst.setString(10, sCuenta);
        // cheque
        pst.setString(11, cheque);
        // fecha cheque
        pst.setDate(12, fechaCheque);
        pst.setString(13, endosable_sn);
        // monto_pagar
        pst.setBigDecimal(14, a_pagar_bs);
        if (pst.executeUpdate() != 1) {
            throw new Exception("Error al insertar el registro");
        }
        // Recobrar el numero de pago
        final ResultSet rsId = ConnCapip.getInstance().getConnection().prepareStatement("SELECT last_insert_id() AS last_id FROM avance_efectivo").executeQuery();
        if (rsId.next()) {
        ...
        // Verificar si el soporte/cheque para la cuenta, en el presente ejercicio fiscal es valido
        try {
            final PreparedStatement pstCheck = ConnCapip.getInstance().getConnection().prepareStatement("SELECT * FROM bancos_operaciones " + "WHERE ejefis= ? AND cuenta= ? AND tipo_operacion= 'FA' AND soporte_o_cheque= ?");
        ...
        final PreparedStatement pst2 = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO bancos_operaciones(" + "cuenta, banco, descripcion, fecha, tipo_operacion, " + "soporte_o_cheque, conciliado, debe, haber, cuenta_numop, cuenta_numop_tipo, " + "num_pag_ava, ejefis, ejefismes, iduser) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        // cuenta
        pst2.setString(1, sCuenta);
        // banco
        pst2.setString(2, banco);
        // desc
        pst2.setString(3, Propiedades.setColStrLen("bancos_operaciones", "descripcion", "FA" + "-" + numAdeEfe + " - " + razonSocial));
        // fecha
        pst2.setString(4, sFecha);
        // tipo
        pst2.setString(5, "FA");
        // soporte
        pst2.setString(6, cheque);
        // conciliado
        pst2.setString(7, "EN TRANSITO");
        // debe
        pst2.setDouble(8, 0.00d);
        // haber
        pst2.setDouble(9, a_pagar_bs.doubleValue());
        // cuenta_numop
        pst2.setLong(10, iCuenta);
        // cuenta_numop
        pst2.setLong(11, ModelMapNextOp.getNext(Globales.getEjeFisYear(), sCuenta + "-" + "FA"));
        // pago_ava
        pst2.setInt(12, numAdeEfe);
     ...
     */
    private void avaDetailGenerar(final String insNumpago) throws Exception {
        ...
        final PreparedStatement pst2 = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO ava_efe_aux_report(codpresu,partida,total,fchsession,idsession,iduser) VALUES (?,?,?,?,?,?)");
        // cod presup
        pst2.setString(1, "SIN IMP");
        // partida
        pst2.setString(2, "SIN IMP");
     ...
     * @throws Exception
     */
    public static ParamRptPagAva genParamRptAva(long inid_ava) throws Exception {
        if (inid_ava < 0) {
            throw new Exception("Número de orden inválido");
        }
        AvanceEfectivoModel regAva;
        final ResultSet rsAva = ConnCapip.getInstance().executeQuery("SELECT * FROM avance_efectivo WHERE id= " + inid_ava);
        if (rsAva.next()) {
        ...
        return new // Monto totat == monto pagar
                ParamRptPagAva(// Monto totat == monto pagar
                        regAva.getId(), // Monto totat == monto pagar
                        "", // Monto totat == monto pagar
                        "", // Monto totat == monto pagar
                        regAva.getBenef_razonsocial(), // Monto totat == monto pagar
                        regAva.getBenef_rif_ci(), // Monto totat == monto pagar
                        "", // Monto totat == monto pagar
                        Format.toStr(regAva.getA_pagar_bs()), // Monto totat == monto pagar
                        regAva.getBanco(), // Monto totat == monto pagar
                        regAva.getCuenta(), // Monto totat == monto pagar
                        regAva.getCheque(), // Monto totat == monto pagar
                        "0,00", // Monto totat == monto pagar
                        "0,00", // Monto totat == monto pagar
                        Format.toStr(regAva.getA_pagar_bs()), "0,00", Format.toStr(regAva.getFecha_pago()), NumLiteral_1, NumLiteral_2, regAva.getObservacion());
    }
    ...
    public static void rptOrdAva(ParamRptPagAva inparam, boolean inexport) throws Exception {
        if (inparam == null) {
            return;
        }
        final Map<String, Object> param = new HashMap<>(101);
        param.put("numPag", inparam.getId_orden_pago());
        param.put("NumLiteral_1", inparam.getEnLetras_1());
        param.put("NumLiteral_2", inparam.getEnLetras_2());
        param.put("montoPagar", inparam.getMontoPagar());
        param.put("montoTotal", inparam.getMontoTotal());
        param.put("resta", inparam.getResta());
        param.put("razonSocial", inparam.getBenef_RazonSocial());
        param.put("rif", inparam.getBenef_rif_ci());
        param.put("banco", inparam.getBanco());
        param.put("cuenta", inparam.getCuenta());
        param.put("cheque", inparam.getCheque());
        param.put("ivaRet", inparam.getIvaRet());
        param.put("ivaTotal", inparam.getIvaTot());
        param.put("concepto", inparam.getConcepto());
        param.put("fechaHoy", inparam.getFechaHoy());
        param.put("numcaus", inparam.getNumCaus());
        param.put("numcomprs", inparam.getNumComprs());
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        final JasperPrint jasperPrint = JasperFillManager.fillReport(pathRpt, new HashMap<>(param), cn);
                        JasperViewer.viewReport(jasperPrint, false);
                        if (inexport) {
                            JasperExportManager.exportReportToPdfFile(jasperPrint, Propiedades.CAPIP_DIR_LOCAL_ORDENPAGO + "/" + inparam.getId_orden_pago() + "_avance.pdf");
                        }
                    } catch (final Exception inex) {
                        JOptionPane.showMessageDialog(null, inex);
                        logger.error(inex);
     ...
     */
    @SuppressWarnings({"unchecked"})
    public static void rptChAva(long inid_orden_pago, ParamRptPagAva inparamAva) throws Exception {
        final Map<String, Object> param = new HashMap<>(101);
        param.put("Numorden", String.valueOf(inid_orden_pago));
        param.put("Numliteral_1", inparamAva.getEnLetras_1());
        param.put("Numliteral_2", inparamAva.getEnLetras_2());
        param.put("iduser", UserPassIn.getIdUser());
        param.put("idsession", UserPassIn.getIdSession());
        param.put("user", UserPassIn.getIdUser() <= 0 ? "DEBUG" : UserModel.getUser(UserPassIn.getIdUser()));
        param.put("rpt_fecha_hora", Globales.getServerTimeStamp());
        ...
        final ResultSet rs = ConnCapip.getInstance().executeQuery("SELECT * FROM avance_efectivo WHERE id= " + inid_orden_pago);
        if (rs.next()) {
        ...
        final ChequeModel cheque = new ChequeModel(Format.toStr(reg.getA_pagar_bs()), reg.getBenef_razonsocial(), reg.getBenef_rif_ci(), inparamAva.getEnLetras_1(), inparamAva.getEnLetras_2(), Propiedades.CAPIP_CLIENTE_DOMICILIO_FISCAL, new java.util.Date(reg.getFecha_pago().getTime()), reg.getEndosable_sn().equals("S") ? "" : "NO ENDOSABLE");
        list.add(cheque);
        final Class aClass = FrmPrincipal.getInstance().getClass();
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        JasperViewer.viewReport(jasperPrint, false);
                        JasperExportManager.exportReportToPdfFile(jasperPrint, Propiedades.CAPIP_DIR_LOCAL_ORDENPAGO + "/" + inid_orden_pago + "-CH-AvaEfe.pdf");
                    } catch (final Exception inex) {
                        JOptionPane.showMessageDialog(null, inex);
                        logger.error(inex);
                    }
        ...
        param.put("numPag", inparamAva.getId_orden_pago());
        param.put("montoPagar", inparamAva.getMontoPagar());
        param.put("montoTotal", inparamAva.getMontoTotal());
        param.put("resta", inparamAva.getResta());
        param.put("razonSocial", inparamAva.getBenef_RazonSocial());
        param.put("rif", inparamAva.getBenef_rif_ci());
        param.put("banco", inparamAva.getBanco());
        param.put("cuenta", inparamAva.getCuenta());
        param.put("cheque", inparamAva.getCheque());
        param.put("ivaRet", inparamAva.getIvaRet());
        param.put("ivaTotal", inparamAva.getIvaTot());
        param.put("concepto", inparamAva.getConcepto());
        param.put("fechaHoy", inparamAva.getFechaHoy());
        param.put("numcaus", inparamAva.getNumCaus());
        param.put("numcomprs", inparamAva.getNumComprs());
        param.put("titulo", "FONDO DE AVANCE");
        param.put("iduser", UserPassIn.getIdUser());
        param.put("idsession", UserPassIn.getIdSession());
        param.put("user", UserPassIn.getIdUser() <= 0 ? "DEBUG" : UserModel.getUser(UserPassIn.getIdUser()));
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        JasperViewer.viewReport(jasperPrint, false);
                        JasperExportManager.exportReportToPdfFile(jasperPrint, Propiedades.CAPIP_DIR_LOCAL_ORDENPAGO + "/" + inid_orden_pago + "_asiento_ch.pdf");
                    } catch (final Exception inex) {
                        JOptionPane.showMessageDialog(null, inex);
                        logger.error(inex);
                    }
    ...
    private void setTotales() {
        ...
        try {
            ...
            txtIVA_Aplicado.setText("");
            txtA_Pagar.setText("");
            JOptionPane.showMessageDialog(null, "Monto Total inválido: " + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
    ...
    private static final Logger logger = LogManager.getLogger(FondoAvanceSinImp.class);
}
