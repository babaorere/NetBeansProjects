...
public final class FondoAvanceEfectivoReport extends XJFrameJTable {
    ...
    void initComponents() {
        ...
        // NOI18N
        txtExcel.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Número", "Fecha", "Beneficiario", "RIF/CI", "Monto Bs.", "Reg" }) {
...
//GEN-FIRST:event_btnReportSummaryActionPerformed
        ...
        for (int i = 0; i < tblMaster.getRowCount(); i++) {
            ...
            try {
                final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO ava_efe_rpt_summary(" + "num, fecha, razonsocial, rif, total, " + "fchsession, idsession, iduser) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
...
//GEN-LAST:event_btnReportSummaryActionPerformed
    private void txtExcelActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtExcelActionPerformed
        try {
...
//GEN-LAST:event_txtEjeFisActionPerformed
    ...
    private void PagoRpt(int inselRow) {
        ...
        ParamRptPagAva param = new ParamRptPagAva(numPag, (numCaus == null) ? "" : numCaus.toString(), (numComprs == null) ? "" : numComprs.toString(), razonSocial, rif, "", sa_pagar_bs, banco, cuenta, cheque, "0,00", "0,00", sa_pagar_bs, "0,00", fechaHoy, NumLiteral_1, NumLiteral_2, concepto);
    ...
    private static final Logger logger = LogManager.getLogger(FondoAvanceEfectivoReport.class);
}
