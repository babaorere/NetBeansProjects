...
public final class PagoReport extends XJFrameJTable {
    ...
    private static final int colAnulado = 1;

    private static final int colNum = 2;

    private static final int colxPago = 3;

    private static final int colxCuenta = 4;

    private static final int colFecha = 5;

    private static final int colBenef = 6;

    private static final int colRifCI = 7;

    private static final int colMonto = 8;

    private static final int colAPagar = 9;

    private static final int colResta = 10;
     ...
     * @param inparent
     */
    public PagoReport(final java.awt.Window inparent) {
        super(inparent);
        initComponents();
        setOwnBehavior();
        setCompBehavior();
    ...
    protected void ConfigComponents(final Map<String, Object> inparam) {
        ...
        tcr = new DefaultTableCellRenderer();
        tcr.setHorizontalAlignment(SwingConstants.CENTER);
        tblMaster.getColumnModel().getColumn(colAnulado).setCellRenderer(tcr);
        tcr = new DefaultTableCellRenderer();
        tcr.setHorizontalAlignment(SwingConstants.CENTER);
    ...
    public void UpdateJTable() {
        ...
        try {
            ...
            while (rs.next()) {
                PagoModel aux = new PagoModel(rs);
                datos[colCuenta] = aux.getCuenta();
                datos[colAnulado] = aux.getAnulado_sn().equals("N") ? "" : "Anu.";
                datos[colNum] = aux.getId_orden_pago();
                datos[colxPago] = aux.getNum_x_Pag();
                datos[colxCuenta] = aux.getNum_x_Cuenta();
                ...
                pagado = pagado.add(aux.getA_pagar_bs());
                datos[colAPagar] = Format.toDouble(aux.getA_pagar_bs());
        ...
        txtAPagar.setValue(pagado);
        txtResta.setValue(resta);
        txtCant.setText(String.valueOf(tblMaster.getRowCount()));
    }
    ...
    String sqlPeriodo() {
        ...
        if (btnAno.isSelected()) {
            ...
            ejeFisMesDesde = 1;
            ejeFisMesHasta = 12;
            sql = "SELECT * FROM orden_pago WHERE (ejefis BETWEEN '" + ejeFis + "/01/01' AND '" + ejeFis + "/12/31') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnEne.isSelected()) {
            mesDesde = "Enero";
            mesHasta = "Enero";
            ejeFisMesDesde = 1;
            ejeFisMesHasta = 1;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/01/01') AND  (ejefis < '" + ejeFis + "/02/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnFeb.isSelected()) {
            mesDesde = "Febrero";
            mesHasta = "Febrero";
            ejeFisMesDesde = 2;
            ejeFisMesHasta = 2;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/02/01') AND (ejefis < '" + ejeFis + "/03/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnMar.isSelected()) {
            mesDesde = "Marzo";
            mesHasta = "Marzo";
            ejeFisMesDesde = 3;
            ejeFisMesHasta = 3;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/03/01') AND (ejefis < '" + ejeFis + "/04/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnAbr.isSelected()) {
            mesDesde = "Abril";
            mesHasta = "Abril";
            ejeFisMesDesde = 4;
            ejeFisMesHasta = 4;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/04/01') AND (ejefis < '" + ejeFis + "/05/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnMay.isSelected()) {
            mesDesde = "Mayo";
            mesHasta = "Mayo";
            ejeFisMesDesde = 5;
            ejeFisMesHasta = 5;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/05/01') AND (ejefis < '" + ejeFis + "/06/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnJun.isSelected()) {
            mesDesde = "Junio";
            mesHasta = "Junio";
            ejeFisMesDesde = 6;
            ejeFisMesHasta = 6;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/06/01') AND (ejefis < '" + ejeFis + "/07/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnJul.isSelected()) {
            mesDesde = "Julio";
            mesHasta = "Julio";
            ejeFisMesDesde = 7;
            ejeFisMesHasta = 7;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/07/01') AND (ejefis < '" + ejeFis + "/08/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnAgo.isSelected()) {
            mesDesde = "Agosto";
            mesHasta = "Agosto";
            ejeFisMesDesde = 8;
            ejeFisMesHasta = 8;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/08/01') AND (ejefis < '" + ejeFis + "/09/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnSep.isSelected()) {
            mesDesde = "Septiembre";
            mesHasta = "Septiembre";
            ejeFisMesDesde = 9;
            ejeFisMesHasta = 9;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/09/01') AND (ejefis < '" + ejeFis + "/10/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnOct.isSelected()) {
            mesDesde = "Octubre";
            mesHasta = "Octubre";
            ejeFisMesDesde = 10;
            ejeFisMesHasta = 10;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/10/01') AND (ejefis < '" + ejeFis + "/11/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnNov.isSelected()) {
            mesDesde = "Noviembre";
            mesHasta = "Noviembre";
            ejeFisMesDesde = 11;
            ejeFisMesHasta = 11;
            sql = "SELECT * FROM orden_pago WHERE (ejefis >= '" + ejeFis + "/11/01') AND (ejefis < '" + ejeFis + "/12/01') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else if (btnDic.isSelected()) {
            mesDesde = "Diciembre";
            mesHasta = "Diciembre";
            ejeFisMesDesde = 12;
            ejeFisMesHasta = 12;
            sql = "SELECT * FROM orden_pago WHERE (ejefis BETWEEN '" + ejeFis + "/12/01' AND '" + ejeFis + "/12/31') " + sqlEstado() + " ORDER BY id_orden_pago ASC";
        } else {
            mesDesde = "Enero";
            mesHasta = "Diciembre";
            ejeFisMesDesde = 1;
    ...
    void initComponents() {
        ...
        txtAPagar = com.principal.textfield_decimal.DecimalTextField.getTextField();
        lblResta = new javax.swing.JLabel();
        txtResta = com.principal.textfield_decimal.DecimalTextField.getTextField();
        ...
        setTitle("REPORTE SUMARIO DE PAGOS");
        ...
        // NOI18N
        cbxEstado.setFont(new java.awt.Font("Arial", 2, 16));
        cbxEstado.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Todos", "Pend. Pago", "Pagados", "Anulados" }));
        ...
        // NOI18N
        cbxFilter.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        // NOI18N
        txtFiltro.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        txtEjeFis.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Cuenta", "Edo.", "ID B.D.", "Núm. x Pago", "Núm. x Cuenta", "Fecha", "Beneficiario", "RIF/CI", "Monto Bs.", "Pagado Bs.", "Resta Bs.", "Reg" }) {

            Class[] types = new Class[] { java.lang.String.class, java.lang.Object.class, java.lang.Long.class, java.lang.Long.class, java.lang.Long.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class };
        ...
        if (tblMaster.getColumnModel().getColumnCount() > 0) {
            ...
            tblMaster.getColumnModel().getColumn(0).setPreferredWidth(180);
            tblMaster.getColumnModel().getColumn(0).setMaxWidth(250);
            tblMaster.getColumnModel().getColumn(1).setMinWidth(15);
            tblMaster.getColumnModel().getColumn(1).setPreferredWidth(40);
            tblMaster.getColumnModel().getColumn(1).setMaxWidth(50);
            ...
            tblMaster.getColumnModel().getColumn(3).setPreferredWidth(120);
            ...
            tblMaster.getColumnModel().getColumn(5).setPreferredWidth(100);
            tblMaster.getColumnModel().getColumn(5).setMaxWidth(150);
            tblMaster.getColumnModel().getColumn(6).setMinWidth(150);
            tblMaster.getColumnModel().getColumn(6).setPreferredWidth(300);
            tblMaster.getColumnModel().getColumn(6).setMaxWidth(500);
            tblMaster.getColumnModel().getColumn(7).setMinWidth(100);
            ...
            tblMaster.getColumnModel().getColumn(10).setMinWidth(100);
        ...
        // NOI18N
        btnSeleccionar.setFont(new java.awt.Font("Arial", 2, 15));
        ...
        // NOI18N
        txtCant.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        btnCancelar.setFont(new java.awt.Font("Arial", 2, 15));
        ...
        // NOI18N
        btnReportSummary.setFont(new java.awt.Font("Arial", 2, 15));
        ...
        // NOI18N
        lblMonto.setFont(new java.awt.Font("Tahoma", 3, 14));
        lblMonto.setText("Pagado Bs.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.ipadx = 10;
        ...
        txtAPagar.setBackground(new java.awt.Color(175, 204, 125));
        // NOI18N
        txtAPagar.setFont(new java.awt.Font("Arial", 3, 14));
        txtAPagar.setMaximumSize(new java.awt.Dimension(150, 21));
        txtAPagar.setMinimumSize(new java.awt.Dimension(150, 21));
        txtAPagar.setPreferredSize(new java.awt.Dimension(150, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.ipady = 10;
        jpCmdState.add(txtAPagar, gridBagConstraints);
        // NOI18N
        lblResta.setFont(new java.awt.Font("Tahoma", 3, 14));
        ...
        // NOI18N
        btnRetornar.setFont(new java.awt.Font("Arial", 2, 15));
...
//GEN-FIRST:event_btnReportSummaryActionPerformed
        ...
        try {
            ConnCapip.getInstance().getConnection().prepareStatement("DELETE FROM ordenpago_rpt_summary WHERE fchsession <= '" + fchDelete + "' OR iduser=" + UserPassIn.getIdUser() + " AND idsession=" + UserPassIn.getIdSession()).executeUpdate();
        } catch (final Exception inex) {
            JOptionPane.showMessageDialog(null, inex);
            logger.error(inex);
            return;
        ...
        for (int i = 0; i < tblMaster.getRowCount(); i++) {
            PagoModel reg = (PagoModel) tblMaster.getValueAt(i, colReg);
            try {
                final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO ordenpago_rpt_summary" + "(num, anu, fecha, razonsocial, rif, total, " + "fchsession, idsession, iduser) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
                pst.setLong(1, reg.getId());
                final String anu = reg.getAnulado_sn();
                pst.setString(2, anu.equals("N") ? "" : "S");
                pst.setString(3, Format.toStr(reg.getFecha_pago()));
                pst.setString(4, reg.getBenef_razonsocial());
                pst.setString(5, reg.getBenef_rif_ci());
                BigDecimal total_bs = reg.getTotal_bs();
                pst.setDouble(6, total_bs.doubleValue());
                pst.setDate(7, fchSession);
                pst.setLong(8, UserPassIn.getIdSession());
                pst.setLong(9, UserPassIn.getIdUser());
                pst.executeUpdate();
                if (anu.equals("N")) {
                    tot = tot.add(total_bs).setScale(2, RoundingMode.HALF_UP);
                }
            } catch (final Exception inex) {
                JOptionPane.showMessageDialog(null, inex);
                logger.error(inex);
...
//GEN-FIRST:event_btnSeleccionarActionPerformed
        // la accion es asignada programaticamente con el jbSeleccionar
    }
...
//GEN-FIRST:event_btnExcelActionPerformed
        try {
            final String fileName = "RptPago_" + new SimpleDateFormat("yyyy-MM-dd hh-mm-ss").format(Globales.getServerTimeStamp());
...
//GEN-LAST:event_txtEjeFisActionPerformed
    private void cbxEstadoItemStateChanged(java.awt.event.ItemEvent evt) {
//GEN-FIRST:event_cbxEstadoItemStateChanged
...
//GEN-LAST:event_cbxEstadoItemStateChanged
    ...
    protected void jbSeleccionarActionPerformed(AWTEvent ine) {
        ...
        if (jtable != null) {
            ...
            if (selRow >= 0) {
                try {
                    final PagoModel regPago = (PagoModel) tblMaster.getValueAt(selRow, colReg);
                    PagoOrden.genReport(regPago.getId_orden_pago(), "ORDEN DE PAGO", false, regPago.isByCheck());
                } catch (final Exception inex) {
    ...
    @SuppressWarnings("unchecked")
    public void reportSummary(BigDecimal intot) {
        if (tblMaster.getRowCount() <= 0) {
        ...
        final InputStream pathRpt = aClass.getResourceAsStream("/reportes/pagoRptSummary.jasper");
        if (pathRpt != null) {
            new Thread() {
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new PagoReport(null).setVisible(true);
            }
        });
    }
    ...
    private static final Logger logger = LogManager.getLogger(PagoReport.class);
}
