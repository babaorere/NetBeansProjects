...
public final class PagoDirectoNormal extends javax.swing.JFrame implements CuentaUpdatable {
    ...
    private JFormattedTextField txtffCant;
    private JFormattedTextField txtffPUnitario;
    private JFormattedTextField txtffA_Pagar;

    /**
     * Lleva la referencia del registro del presupuesto seleccionado
     */
     ...
     * @param inparent
     */
    public PagoDirectoNormal(final java.awt.Window inparent) {
        super();
        initComponents();
    ...
    public void setVisible(boolean inb) {
        ...
        if (inb) {
            ...
            // Al hacer el get, establecemos el PresupeSel.idSelIO en cero (0)
            ...
            if (idSelIO >= 1) {
                try {
                    ...
                    regPptoSel = null;
                    JOptionPane.showMessageDialog(this, "Error al tratar de recuperar la Selección" + System.getProperty("line.separator") + inex);
                    logger.error(inex);
                }
            } else {
                regPptoSel = null;
    ...
    private void setCompBehavior() {
        ...
        txtffCant = (JFormattedTextField) txtCant;
        txtffPUnitario = (JFormattedTextField) txtPUnitario;
        txtffA_Pagar = (JFormattedTextField) txtA_Pagar;
        ...
        Compromiso.setTxtPUnitarioBehavior(txtffCant, txtffPUnitario, txtSubTotal);
        // Para que cada vez que se modifique el campo se actualice el subtotal
        txtOtrasRetenciones.getDocument().addDocumentListener(new DocumentListener() {
...
//            oRet = Format.toBigDec(txtOtrasRetenciones.getText());
            oRet = (BigDecimal) txtOtrasRetenciones.getValue();

            //            txtOtrasRetenciones.commitEdit();
            //            Object obj = txtOtrasRetenciones.getValue();
            //
            //            if (obj instanceof BigDecimal) {
            //                oRet = (BigDecimal) obj;
            //            } else if (obj instanceof Long) {
            //                oRet = BigDecimal.valueOf((Long) obj);
            //            } else if (obj instanceof Double) {
            //                oRet = BigDecimal.valueOf((Double) obj);
            //            } else {
            //                oRet = BigDecimal.ZERO;
            //            }
        } catch (final Exception inex) {
            oRet = BigDecimal.ZERO;
            logger.error(inex);
        ...
        final BigDecimal montoAPagar = total_bs.subtract(ivaRet).subtract(islrRet).subtract(oRet).setScale(2, RoundingMode.HALF_UP);
        try {
            ...
            txtTotalRet.setText(Format.toStr(ivaRet.add(islrRet).add(oRet)));
    ...
    private void actComprInsertItem(boolean inisIVA) {
        ...
        try {
            if (!PresupeModel.checkMontoDescontar(sCodPartida, subtotal)) {
                ...
                txtffCant.setValue(BigDecimal.ZERO);
                txtDesc.setText("0");
                txtffPUnitario.setValue(BigDecimal.ZERO);
                return;
            }
        } catch (final Exception inex) {
    ...
    private void initComponents() {
        ...
        txtCant = com.principal.textfield_decimal.CustomDecimalTxt.getTxt();
        txtPUnitario = com.principal.textfield_decimal.CustomDecimalTxt.getTxt();
        ...
        txtA_Pagar = com.principal.textfield_decimal.CustomDecimalTxt.getTxt();
        ...
        txtBeneficiario.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        txtBeneficiario.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtBeneficiario.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtBeneficiario.setEnabled(false);
        txtBeneficiario.setSelectionColor(new java.awt.Color(175, 204, 125));
        getContentPane().add(txtBeneficiario, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 290, 30));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 40, 70, 30));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 270, 170, -1));
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 750, 60));
        ...
        txtSubTotal.setSelectionColor(new java.awt.Color(175, 204, 125));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 80, 750, 180));
        ...
        jPanel1.add(txtCant, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 60, 30));
        ...
        txtPUnitario.setSelectionColor(new java.awt.Color(175, 204, 125));
        ...
        jPanel1.add(txtPUnitario, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 0, 140, 30));
        ...
        jPanel1.add(cmbIva, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 355, 250, 30));

        jLabel2.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        jLabel2.setText("IVA Aplicado");
        ...
        getContentPane().add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 630, 110, 40));
        ...
        jPanel3.add(txtCheque, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 128, 110, 30));
        ...
        jPanel3.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 98, 110, -1));
        ...
        jPanel3.add(txtSaldoCuenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 118, 170, 40));

        jLabel33.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel33.setText("CHEQUE Nº");
        jPanel3.add(jLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 138, 70, -1));
        ...
        jLabel24.setBounds(10, 100, 130, 30);

        jLabel25.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel25.setText("TOTAL RETENCION");
        jPanel5.add(jLabel25);
        jLabel25.setBounds(10, 155, 110, 14);
        ...
        txtIvaRet.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        ...
        txtIslrRet.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        ...
        txtOtrasRetenciones.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        ...
        txtTotalRet.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        ...
        cmbIslrPorc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbIslrPorcActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtTotalBs.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        ...
        txtBenef_rif_ci.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        txtBenef_rif_ci.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtBenef_rif_ci.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtBenef_rif_ci.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtBenef_rif_ci.setEnabled(false);
        txtBenef_rif_ci.setSelectionColor(new java.awt.Color(175, 204, 125));
        getContentPane().add(txtBenef_rif_ci, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 10, 142, 30));
        ...
        btnAtras.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        getContentPane().add(btnAtras, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 630, 80, 40));

        btnEditarCheque.setBackground(java.awt.SystemColor.inactiveCaption);
        btnEditarCheque.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        btnEditarCheque.setText(" EDITAR CH. ");
        ...
        getContentPane().add(btnEditarCheque, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 630, 150, 40));

        chkByCheck.setBackground(java.awt.SystemColor.inactiveCaption);
        chkByCheck.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        getContentPane().add(chkByCheck, new org.netbeans.lib.awtextra.AbsoluteConstraints(305, 630, 120, 40));
...
//GEN-FIRST:event_btnIVAActionPerformed
        ...
        try {
            ...
            final IvaAplicModel regIva = CAPIP_IVA_APLICADO.get(id_iva_aplicado);
            if (regIva == null) {
                JOptionPane.showMessageDialog(this, "Error al tratar de recuperar el IVA" + System.getProperty("line.separator") + "");
                return;
            }
            final PptoModel regPpto = PptoModel.getReg_x_Id("presupe", regIva.getId_part_ppto());
            if (regPpto == null) {
                JOptionPane.showMessageDialog(this, "Error al tratar la partida Ppto. asociada al IVA" + System.getProperty("line.separator") + "");
                return;
            }
...
//GEN-LAST:event_btnGuardarActionPerformed
    ...
    private void actGuardar() {
        ...
        try {
            (new Compromiso(null)).genReport((long) param.get("id_compr"), new HashMap<>(param), true);
        } catch (final Exception inex) {
            JOptionPane.showMessageDialog(this, "Error al tratar de generar el Reporte de Compromiso" + System.getProperty("line.separator") + inex);
            logger.error(inex);
        }
        try {
            (new Causado(null)).genReport((long) param.get("id_causado"), param);
        } catch (final Exception inex) {
            JOptionPane.showMessageDialog(this, "Error al tratar de generar el Reporte de Causado" + System.getProperty("line.separator") + inex);
            logger.error(inex);
        }
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de generar el Reporte de I.V.A." + System.getProperty("line.separator") + inex);
            logger.error(inex);
        }
        try {
        ...
        try {
            PagoOrden.genReport((long) param.get("id_orden_pago"), "ORDEN DE PAGO DIRECTA", true, chkByCheck.isSelected());
        } catch (final Exception inex) {
...
//GEN-LAST:event_tblBenefMouseClicked
    ...
    private void actSelectBenef() {
        ...
        txtBeneficiario.setText(tblBenef.getValueAt(fila, 0).toString());
        txtBeneficiario.setCaretPosition(0);
        txtBenef_rif_ci.setText(tblBenef.getValueAt(fila, 1).toString());
...
//GEN-LAST:event_btnAtrasActionPerformed
    ...
    private void comprGuardar(final Map<String, Object> inparam) throws Exception {
        inparam.put("id_compr", comprNextNum.nextNum());
        Compromiso.genMaster(inparam, tblItem, IVA_DEC_VALUE);
        Compromiso.genDetail(inparam, tblItem);
        comprNextNum.update();
    }
    ...
    private boolean valIvaComp(final Map<String, Object> inparam) {
        ...
        if (iva_retenido_bs.compareTo(BigDecimal.ZERO) > 0 && num_fact.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Orden de Pago con IVA. Debe indicar el número de factura");
            return false;
        }
     ...
     * @throws Exception
     */
    private void causadoGuardar(final Map<String, Object> inparam) throws Exception {
        inparam.put("id_causado", cauNextNum.nextNum());
        Causado.genCausadoMaster(inparam, null);
        Causado.genCausadoDetail(inparam, null);
        cauNextNum.update();
    }
    ...
    private void genIvaDetail(final Map<String, Object> inparam) throws Exception {
        ...
        PreparedStatement pstCompr = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE " + tipo_compr.getTbl() + " SET iva_grav_bs= ?, iva_porc_ret= ? WHERE id_compr= ?");
        ...
        final PreparedStatement pstCau = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE causado SET resta_bs= resta_bs - ?, iva_ret_sn= 'S' WHERE id_causado= ?");
     ...
     *
     */
    private void IvaRetencionSN(final Map<String, Object> inparam, final String insn) {
        try {
            final long id_causado = (long) inparam.get("id_causado");
            final PreparedStatement pstCau = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE causado SET iva_ret_sn= ? WHERE id_causado= ?");
            pstCau.setString(1, insn);
            pstCau.setLong(2, id_causado);
            if (pstCau.executeUpdate() != 1) {
                throw new Exception("Error sl actualizar el impuesto Retenido");
            }
        } catch (Exception inex) {
            JOptionPane.showMessageDialog(this, "Error al tratar de actualizar el iva_ret_sn" + System.getProperty("line.separator") + inex);
            logger.error(inex);
        }
    }
    ...
    private void genIslrDetail(final Map<String, Object> inparam) throws Exception {
        ...
        final PreparedStatement pstCau = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE causado SET resta_bs= resta_bs - ?, islr_ret_sn= 'S' WHERE id_causado= ?");
     ...
     *
     */
    private void IslrRetencionSN(final Map<String, Object> inparam, final String insn) {
        try {
            final long id_causado = (long) inparam.get("id_causado");
            final PreparedStatement pstCau = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE causado SET islr_ret_sn= ? WHERE id_causado= ?");
            pstCau.setString(1, insn);
            pstCau.setLong(2, id_causado);
            if (pstCau.executeUpdate() != 1) {
                throw new Exception("Error sl actualizar el impuesto Retenido");
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de actualizar el islr_ret_sn" + System.getProperty("line.separator") + inex);
            logger.error(inex);
        }
    }
     ...
     *
     */
    private void OtrasRetencionSN(final Map<String, Object> inparam, final String insn) {
        try {
            final long id_causado = (long) inparam.get("id_causado");
            final PreparedStatement pstCau = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE causado SET oret_ret_sn= ? WHERE id_causado= ?");
            pstCau.setString(1, insn);
            pstCau.setLong(2, id_causado);
            if (pstCau.executeUpdate() != 1) {
                throw new Exception("Error sl actualizar el impuesto Retenido");
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de actualizar el oret_ret_sn" + System.getProperty("line.separator") + inex);
            logger.error(inex);
        }
    }
    ...
    private void pagoGuardar(final Map<String, Object> inparam) throws Exception {
        ...
        PagoOrden.genPagoMaster(inparam, chkByCheck.isSelected());
    ...
    private void genPagoDetail(Map<String, Object> inparam) throws Exception {
        ...
        final CauModel regCau = CauModel.getxID((long) inparam.get("id_causado"));
...
//GEN-FIRST:event_txtCantActionPerformed
        JFormattedTextField aux = (JFormattedTextField) txtCant;
...
//GEN-FIRST:event_txtPUnitarioActionPerformed
        // llamar a la seleccion de la partida
        invokePresupeSel();

    }

    /**
     * Proceder a verificar condiciones, y si todo va bien, presentamos la ventana de seleccion de la partida de presupuesto
     */
    private void invokePresupeSel() {
...
//GEN-LAST:event_txtOtrasRetencionesKeyTyped
    private void cmbIslrPorcActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_cmbIslrPorcActionPerformed
    }

//GEN-LAST:event_cmbIslrPorcActionPerformed
...
//GEN-LAST:event_txtNumControlKeyTyped
    ...
    private void clearComp() {
        ...
        cmbIslrPorc.setSelectedIndex(-1);
        txtIslrRet.setText("0,00");
        txtOtrasRetenciones.setValue(BigDecimal.valueOf(0.00d));
        txtTotalRet.setText("0,00");
        txaConcepto.setText("");
        txtSumaTotalCau.setText("0,00");
        txtIva_bs.setText("0,00");
        txtffA_Pagar.setValue(BigDecimal.ZERO);
        txtSumaTotalCau_menosRet.setText("0,00");
        cmbCuentas.setSelectedIndex(-1);
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new PagoDirectoNormal(null).setVisible(true);
            }
        });
    }
