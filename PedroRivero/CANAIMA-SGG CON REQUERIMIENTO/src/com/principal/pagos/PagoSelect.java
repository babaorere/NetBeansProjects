...
public final class PagoSelect extends XJFrameSelect {
    ...
    void initComponents() {
        ...
        // NOI18N
        jtCantBeneficiarios.setFont(new java.awt.Font("Arial", 3, 14));
        ...
        // NOI18N
        jftMontoCred.setFont(new java.awt.Font("Arial", 3, 14));
    ...
    private static final Logger logger = LogManager.getLogger(PagoSelect.class);
}
