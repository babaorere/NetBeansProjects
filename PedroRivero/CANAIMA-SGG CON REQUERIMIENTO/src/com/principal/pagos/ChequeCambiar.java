...
public final class ChequeCambiar extends javax.swing.JFrame {
     ...
     * @param inparent
     */
    public ChequeCambiar(java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
...
//GEN-LAST:event_btnAceptarActionPerformed
    private void actConsultar() {
        ...
        try {
            final ResultSet rs = ConnCapip.getInstance().executeQuery("SELECT * FROM orden_pago WHERE id_orden_pago= " + numPag);
            if (!rs.next()) {
            ...
            final PreparedStatement psBanDet = ConnCapip.getInstance().getConnection().prepareStatement("SELECT * FROM bancos_operaciones " + "WHERE (tipo_operacion= 'CH' OR tipo_operacion= 'SC') AND num_pag_ava= ? AND anulado_sn= 'N'");
...
//GEN-LAST:event_txtNumActionPerformed
    ...
    private static final Logger logger = LogManager.getLogger(ChequeCambiar.class);
}
