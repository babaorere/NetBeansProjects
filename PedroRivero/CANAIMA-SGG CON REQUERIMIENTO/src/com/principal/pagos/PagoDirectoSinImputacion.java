...
public final class PagoDirectoSinImputacion extends javax.swing.JFrame implements CuentaUpdatable {
     ...
     * @param inparent
     */
    public PagoDirectoSinImputacion(final java.awt.Window inparent) {
        super();
        initComponents();
    ...
    void initComponents() {
        ...
        // NOI18N
        cmbCuentas.setFont(new java.awt.Font("Tahoma", 3, 12));
        ...
        // NOI18N
        btnEditarCheque.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        getContentPane().add(btnAnular, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 710, -1, -1));
        // NOI18N
        ...
        getContentPane().add(cmbIva, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 710, 160, 30));
        // NOI18N
...
//GEN-LAST:event_txtNumControlKeyTyped
    ...
    private static final Logger logger = LogManager.getLogger(PagoDirectoSinImputacion.class);
}
