...
public final class PagoImputacion extends javax.swing.JFrame implements CuentaUpdatable {
     ...
     * @param inparent
     */
    public PagoImputacion(final java.awt.Window inparent) {
        super();
        initComponents();
    ...
    void initComponents() {
        ...
        // NOI18N
        tblItem.setFont(new java.awt.Font("Arial", 3, 11));
        ...
        // NOI18N
        btnEliminar.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnIVA.setFont(new java.awt.Font("Arial", 3, 18));
        btnIVA.setText("IVA");
        ...
        // NOI18N
        txtCheque.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        txtPendImputar.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        jScrollPane6.setFont(new java.awt.Font("Arial", 1, 18));
        // NOI18N
        txtBancoCuenta.setFont(new java.awt.Font("Arial", 1, 18));
        ...
        // NOI18N
        btnAtras.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnEditarCheque.setFont(new java.awt.Font("Arial", 3, 18));
...
//GEN-LAST:event_btnAtrasActionPerformed
    ...
    private boolean valPagoComp(Map<String, Object> inparam) {
        ...
        final BigDecimal total_bs = (BigDecimal) inparam.get("total_bs");
    ...
    private void genPagoDetail(Map<String, Object> inparam) throws Exception {
        final long id_avance_efectivo = (long) inparam.get("id_avance_efectivo");
        ...
        if (regCau.getResta_bs().compareTo(BigDecimal.ZERO) > 0.00d) {
            ...
            final PreparedStatement pstCauPagHist = ConnCapip.getInstance().getConnection().prepareStatement(// 1, 2, 3, 4
                    "INSERT INTO causado_avance_efectivo_nn"
                    + // 5, 6, 7
                    "(id_user, id_session, date_session, ejefis, " + "id_causado, id_avance_efectivo, apagar_bs) " + "VALUES (?, ?, ?, ?, ?, ?, ?)");
...
//GEN-LAST:event_txtNroFactKeyTyped
    private void txtOrdPagoActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtOrdPagoActionPerformed
        checkIdAvanceEfectivo();
    }

//GEN-LAST:event_txtOrdPagoActionPerformed
    private void txtOrdPagoFocusLost(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_txtOrdPagoFocusLost
    }
...
//GEN-LAST:event_txtNumControlKeyTyped
     ...
     * @return
     */
    private boolean valIdAvanceEfectivo(Map<String, Object> inparam) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error. Número de orden inválido" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return false;
        }
        ...
        try {
            final ResultSet rs = ConnCapip.getInstance().executeQuery("SELECT * FROM avance_efectivo WHERE id= " + id_avance_efectivo);
            if (rs.next()) {
        ...
        inparam.put("id_avance_efectivo", id_avance_efectivo);
        inparam.put("banco", reg.getBanco());
        inparam.put("cuenta", reg.getCuenta());
        inparam.put("cheque", reg.getCheque());
        ...
        if (regCuenta != null) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Error al tratar de recuperar la Cuenta" + System.getProperty("line.separator") + inex);
                regCuenta = null;
                logger.error(inex);
            }
        }
        ...
        try {
            final ResultSet rs = ConnCapip.getInstance().executeQuery("SELECT SUM(apagar_bs) FROM causado_avance_efectivo_nn WHERE id_avance_efectivo=" + id_avance_efectivo);
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de recuperar el registro NN" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return false;
        }
    ...
    @Override
    public void setCuenta(CuentaModel inregCuenta) {
        if (inregCuenta == null) {
            actSalir();
            return;
        }
    ...
    private static final Logger logger = LogManager.getLogger(PagoImputacion.class);
}
