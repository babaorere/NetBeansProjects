...
public final class FrmConfing extends javax.swing.JFrame {
    ...
    private static final String CAPIP_CLAVE_BD = "$%&@root";

    private static final String CAPIP_DIR_SERVIDOR;

    private static final String CAPIP_DIR_LOCAL;

    public static final String CAPIP_PATH_MYSQLDUMP;

    static {
        if (isWindows()) {
            CAPIP_DIR_SERVIDOR = "C:/CAPIP_SISTEMAS";
            CAPIP_DIR_LOCAL = "C:/CAPIP_SISTEMAS";
            CAPIP_PATH_MYSQLDUMP = "C:/Program Files/MySQL/MySQL Server 5.7/bin";
        } else if (isUnix()) {
            CAPIP_DIR_SERVIDOR = "/opt/CAPIP_SISTEMAS";
            CAPIP_DIR_LOCAL = "/opt/CAPIP_SISTEMAS";
            CAPIP_PATH_MYSQLDUMP = "/usr/bin/";
        } else {
            CAPIP_DIR_SERVIDOR = "";
            CAPIP_DIR_LOCAL = "";
            CAPIP_PATH_MYSQLDUMP = "";
        }
    }
     ...
     * @param inaux
     */
    public FrmConfing(final StringBuilder inaux) {
        if (inaux != null) {
            strB = inaux;
        } else {
    ...
    private void CargarPropiedades() {
        try {
            ...
            if (fPropLocal == null) {
                ...
                isLoadLocal = JOptionPane.showConfirmDialog(this, "Desea cargar el archivo de Propiedadees Local", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION;
            }
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de ubicar el archivo de Propiedades" + System.getProperty("line.separator") + inex);
            ClearFields();
            CargarPropPorDefecto();
            logger.error(inex);
        }
    ...
    void initComponents() {
        ...
        setResizable(false);
        // NOI18N
        tbbPanel.setFont(new java.awt.Font("Tahoma", 0, 18));
        // NOI18N
        pnlCifrado.setFont(new java.awt.Font("Tahoma", 0, 14));
        ...
        // NOI18N
        txtCifClave.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        txtCifReClave.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        txtCifBytes.setFont(new java.awt.Font("Tahoma", 0, 14));
        ...
        jLabel8.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel8.setMinimumSize(new java.awt.Dimension(180, 25));
        ...
        // NOI18N
        txtCifCliente.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        jLabel32.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel32.setMinimumSize(new java.awt.Dimension(180, 25));
        ...
        // NOI18N
        txtCifRifCi.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        jLabel33.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel33.setMinimumSize(new java.awt.Dimension(180, 25));
        jLabel33.setPreferredSize(new java.awt.Dimension(180, 25));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        // NOI18N
        txtDomicilioFiscal.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        jLabel6.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel6.setMinimumSize(new java.awt.Dimension(180, 25));
        ...
        // NOI18N
        txtCifLicencia.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        jLabel21.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel21.setMinimumSize(new java.awt.Dimension(180, 25));
        jLabel21.setPreferredSize(new java.awt.Dimension(180, 25));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        // NOI18N
        txtCifFechaLicencia.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        jLabel4.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel4.setMinimumSize(new java.awt.Dimension(180, 25));
        jLabel4.setPreferredSize(new java.awt.Dimension(180, 25));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        // NOI18N
        txtCifServidor.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        jLabel3.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel3.setMinimumSize(new java.awt.Dimension(180, 25));
        ...
        // NOI18N
        txtCifDirServidor.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        jLabel9.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel9.setMinimumSize(new java.awt.Dimension(180, 25));
        ...
        // NOI18N
        txtCifDirLocal.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        jLabel10.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel10.setMinimumSize(new java.awt.Dimension(180, 25));
        ...
        // NOI18N
        txtCifBaseDatos.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        jLabel7.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel7.setMinimumSize(new java.awt.Dimension(180, 25));
        ...
        // NOI18N
        txtCifUsuarioBD.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        jLabel5.setMaximumSize(new java.awt.Dimension(180, 25));
        jLabel5.setMinimumSize(new java.awt.Dimension(180, 25));
        ...
        // NOI18N
        txtCifClaveBD.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        btnClear.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        btnGenerar.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnGenerar.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        btnCifCancelar.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnCifCancelar.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        // NOI18N
        txtLinea_4.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        txtAux_2.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        txtLinea_2.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        txtLinea_3.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        txtLinea_1.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        txtAux_1.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        txtPath_mysqldump.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        chkNumPago.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        btnGenerar_1.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnGenerar_1.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        btnDesCancelar1.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnDesCancelar1.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        // NOI18N
        mnuArchivo.setFont(new java.awt.Font("Segoe UI", 0, 24));
        mnuGenerar.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_ENTER, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        // NOI18N
        mnuGenerar.setFont(new java.awt.Font("Segoe UI", 0, 24));
        ...
        mnuSalir.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_ESCAPE, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        // NOI18N
        mnuSalir.setFont(new java.awt.Font("Segoe UI", 0, 24));
        ...
        // NOI18N
        mnuAyuda.setFont(new java.awt.Font("Segoe UI", 0, 24));
        // NOI18N
        mnuAcercaDe.setFont(new java.awt.Font("Segoe UI", 0, 24));
...
//GEN-FIRST:event_mnuAcercaDeActionPerformed
...
//GEN-FIRST:event_mnuSalirActionPerformed
        actSalir();
    }

//GEN-LAST:event_mnuSalirActionPerformed
    private void mnuGenerarActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_mnuGenerarActionPerformed
        actGenerar();
    }

//GEN-LAST:event_mnuGenerarActionPerformed
    private void btnDesCancelar1ActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnDesCancelar1ActionPerformed
        mnuSalir.doClick();
    }

//GEN-LAST:event_btnDesCancelar1ActionPerformed
    private void btnGenerar_1ActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnGenerar_1ActionPerformed
        btnGenerar.doClick();
    }

//GEN-LAST:event_btnGenerar_1ActionPerformed
    private void btnCifCancelarActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnCifCancelarActionPerformed
        mnuSalir.doClick();
    }

//GEN-LAST:event_btnCifCancelarActionPerformed
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnGenerarActionPerformed
        actGenerar();
    }
...
//GEN-LAST:event_btnClearActionPerformed
    private void txtCifRifCiKeyTyped(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_txtCifRifCiKeyTyped
...
//GEN-LAST:event_txtCifRifCiKeyTyped
    private void txtCifReClaveActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtCifReClaveActionPerformed
        txtCifReClave.transferFocus();
    }

//GEN-LAST:event_txtCifReClaveActionPerformed
    private void txtCifClaveKeyTyped(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_txtCifClaveKeyTyped
...
//GEN-LAST:event_txtCifClaveKeyTyped
    private void txtCifClaveKeyReleased(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_txtCifClaveKeyReleased
...
//GEN-LAST:event_txtCifClaveKeyReleased
    private void txtCifClaveActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtCifClaveActionPerformed
...
//GEN-LAST:event_txtCifClaveActionPerformed
    ...
    private void actGenerar() {
        ...
        final String dirLocal = txtCifDirLocal.getText().trim();
        if (dirLocal.isEmpty()) {
        ...
        try (final FileOutputStream os = new FileOutputStream(dirLocal + File.separator + CAPIP_SISTEMAS_PROPERTIES)) {
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de crear el archivo de propiedades" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        } finally {
            setCursor(null);
    ...
    public String encrypt(final String instrToEncrypt) {
        try {
            final Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
            cipher.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(charToByte(Arrays.copyOf(txtCifClave.getPassword(), 16)), "AES"));
            return Base64.getEncoder().encodeToString(cipher.doFinal(instrToEncrypt.getBytes("UTF-8")));
        } catch (Exception inex) {
            JOptionPane.showMessageDialog(this, "Error al tratar de cifrar" + System.getProperty("line.separator") + inex);
            logger.error(inex);
        }
        return null;
    }
     ...
     * @return
     */
    public String encrypt(final byte[] instrToEncrypt) {
        try {
            final Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
            cipher.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(charToByte(Arrays.copyOf(txtCifClave.getPassword(), 16)), "AES"));
     ...
     * @param inin
     */
    public void SetPass(final char[] inin) {
        txtCifClave.setText(new String(inin));
        txtCifReClave.setText(new String(inin));
    }
     ...
     * @throws Exception
     */
    public String decrypt(final String instrToDecrypt) throws Exception {
        final Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5PADDING");
     ...
     * @param inis
     */
    private void CargarProp(final InputStream inis) {
        Properties prop;
        try {
            prop = new Properties();
            prop.loadFromXML(inis);
        } catch (Exception inex) {
            JOptionPane.showMessageDialog(this, "Error al tratar de leer el archivo de propiedades" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        try {
     ...
     * @param inis
     */
    private void CargarPropLocal(final InputStream inis) {
        Properties prop;
        try {
            prop = new Properties();
            prop.loadFromXML(inis);
    ...
    private void CargarPropPorDefecto() {
        ...
        ;
        txtCifLicencia.setText(uuid.toString());
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new com.principal.capip_configurador.FrmConfing(new StringBuilder()).setVisible(true);
            }
        });
    }
    ...
    private static final Logger logger = LogManager.getLogger(FrmConfing.class);
}
