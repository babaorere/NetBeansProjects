...
public class DlgIvaPorcAplic extends javax.swing.JDialog {
    ...
    void initComponents() {
        ...
        txtValorPorc = com.principal.textfield_decimal.DecimalTextField.getTextField();
        ...
        // NOI18N
        btnSave.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnNew.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnCancel.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        txtValorPorc.setFont(new java.awt.Font("Arial", 3, 12));
        ...
        // NOI18N
        cbxPartida.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Partida", "Desc. Partida", "Valor Porc. %", "reg_iva", "reg_part" }) {

            Class[] types = new Class[] { java.lang.String.class, java.lang.Object.class, java.lang.Double.class, java.lang.Object.class, java.lang.Object.class };
        ...
        // NOI18N
        btnReturn.setFont(new java.awt.Font("Arial", 3, 18));
...
//GEN-LAST:event_btnReturnActionPerformed
     ...
     * @param evt
     */
    private void txtValorPorcKeyTyped(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_txtValorPorcKeyTyped
...
//GEN-LAST:event_txtValorPorcKeyTyped
    private void txtValorPorcActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtValorPorcActionPerformed
...
//GEN-LAST:event_btnEliminarActionPerformed
    ...
    private boolean actSaveNew(final Map<String, Object> inparam) {
        ...
        try {
            final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO iva_aplicado" + "(id_part_ppto, valor_porc) " + "VALUES (?, ?)");
    ...
    private boolean actSaveOld(final Map<String, Object> inparam) {
        ...
        final BigDecimal valor_porc = (BigDecimal) inparam.get("valor_porc");
        try {
            final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE iva_aplicado " + "set id_part_ppto= ?, valor_porc= ? " + "WHERE id_iva_aplicado= ?");
    ...
    private static final Logger logger = LogManager.getLogger(DlgIvaPorcAplic.class);
}
