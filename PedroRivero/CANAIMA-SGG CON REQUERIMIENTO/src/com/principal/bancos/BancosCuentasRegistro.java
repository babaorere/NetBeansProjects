...
public final class BancosCuentasRegistro extends javax.swing.JFrame {
     ...
     * @param inparent
     */
    public BancosCuentasRegistro(final java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
    ...
    void initComponents() {
        ...
        // NOI18N
        txtSaldo.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondo azul 22.png")));
...
//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        final String banco = Propiedades.setColStrLen("bancos", "banco", txtBanco.getText().trim().toUpperCase());
        if (banco.isEmpty()) {
        ...
        try {
            ...
            final PreparedStatement pstBancos = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO bancos(" + "cuenta, banco, saldoi, ejefis, ejefismes, iduser) " + "VALUES (?, ?, ?, ?, ?, ?)", Statement.RETURN_GENERATED_KEYS);
...
//GEN-FIRST:event_txtBancoActionPerformed
...
//GEN-FIRST:event_txtSaldoActionPerformed
...
//GEN-LAST:event_txtSaldoActionPerformed
    ...
    private static final Logger logger = LogManager.getLogger(BancosCuentasRegistro.class);
}
