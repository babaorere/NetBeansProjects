 ...
 */
public final class BancosDeposito extends javax.swing.JFrame {
    ...
    final static int colFecha = colId + 1;

    final static int colSoporte = colFecha + 1;

    final static int colDesc = colSoporte + 1;

    final static int colMonto = colDesc + 1;

    final static int colReg = colMonto + 1;
     ...
     * @param inparent
     */
    public BancosDeposito(final java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
    ...
    void MostrarDatosBancosDet(String cuenta) {
        ...
        final String sql;
        if (cuenta.isEmpty()) {
            sql = "SELECT * FROM bancos_operaciones WHERE tipo_operacion='DP' AND anulado_sn= 'N' ORDER BY id DESC";
        } else {
            sql = "SELECT * FROM bancos_operaciones WHERE cuenta= '" + cuenta + "' && tipo_operacion='DP' AND anulado_sn= 'N' ORDER BY id DESC";
        }
    ...
    void initComponents() {
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "ID", "FECHA", "SOPORTE", "DESCRIPCION", "MONTO BS.", "Reg" }) {
        ...
        jLabel3.setText("DEPOSITOS BANCARIOS");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(246, 11, 230, -1));
        cmbCuentas.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        cmbCuentas.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        getContentPane().add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 50, -1, -1));
        ...
        // NOI18N
        txtSoporte.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        txtDescrip.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnGuardar.setFont(new java.awt.Font("Arial", 3, 14));
        ...
        // NOI18N
        btnReversar.setFont(new java.awt.Font("Arial", 3, 14));
        ...
        // NOI18N
        btnConsultar.setFont(new java.awt.Font("Arial", 3, 14));
        ...
        // NOI18N
        btnNuevo.setFont(new java.awt.Font("Arial", 3, 14));
        ...
        jLabel1.setText("TOTAL DEPOSITOS BS.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        ...
        // NOI18N
        jtTotal.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        txtBanco.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        txtCuenta.setFont(new java.awt.Font("Arial", 3, 16));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.ipadx = 206;
        ...
        // NOI18N
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondo azul 22.png")));
...
//GEN-LAST:event_btnSalirActionPerformed
    private void cmbCuentasActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_cmbCuentasActionPerformed
...
//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        final String tipo_operacion = "DP";
        ...
        if (edo == edoNuevo) {
            try {
                ...
                final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement(// 1, 2, 3, 4, 5,
                        ...
                        + // 11, 12, 13, 14, 15
                        "soporte_o_cheque, conciliado, debe, haber, cuenta_numop, " + "cuenta_numop_tipo, num_pag_ava, ejefis, ejefismes, iduser) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                // cuanta
                pst.setString(1, cuenta);
                // banco
                pst.setString(2, banco);
                // desc
                pst.setString(3, setColStrLen("bancos_operaciones", "descripcion", desc));
                // fecha
                pst.setString(4, sFecha);
                // tipo
                pst.setString(5, tipo_operacion);
                // soporte
                pst.setString(6, setColStrLen("bancos_operaciones", "soporte_o_cheque", soporte));
                // conciliado
                pst.setString(7, "");
                // debe
                pst.setDouble(8, monto);
                // haber
                pst.setDouble(9, 0.00d);
                // cuenta_numop
                pst.setLong(10, ModelMapNextOp.getNext(Globales.getEjeFisYear(), cuenta));
                // cuenta_numop
                pst.setLong(11, ModelMapNextOp.getNext(Globales.getEjeFisYear(), cuenta + "-" + tipo_operacion));
                // num_pag_ava
                pst.setInt(12, 0);
                ...
                //                BancosContabilidad.sumarCuenta(cuenta, monto);
                MostrarDatosBancosDet(cuenta);
            ...
            try {
                ConnCapip.getInstance().BeginTransaction();
                final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE bancos_operaciones SET soporte_o_cheque= ?, descripcion= ?, debe= ? " + "WHERE id= ? AND anulado_sn= 'N'");
                pst.setString(1, setColStrLen("bancos_operaciones", "soporte_o_cheque", soporte));
                // desc
                pst.setString(2, desc);
                // debe
                pst.setDouble(3, monto);
                // id
                pst.setLong(4, reg.getId());
                if (pst.executeUpdate() != 1) {
                    JOptionPane.showMessageDialog(null, "Error al guardar los datos");
                    txtSoporte.requestFocusInWindow();
                    try {
                ...
                //                if (monto != montoIni) {
                //                    BancosContabilidad.restarCuenta(reg.getCuenta(), montoIni); // reversar operación de deposito
                ////                    BancosContabilidad.sumarCuenta(reg.getCuenta(), monto);
                //                }
                MostrarDatosBancosDet(cuenta);
                ConnCapip.getInstance().EndTransaction();
                JOptionPane.showMessageDialog(null, "Operación realizada");
...
//GEN-LAST:event_btnResetActionPerformed
    private void jtTotalActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jtTotalActionPerformed
...
//GEN-LAST:event_jtTotalActionPerformed
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new BancosDeposito(null).setVisible(true);
            }
        });
    }
    ...
    private static final Logger logger = LogManager.getLogger(BancosDeposito.class);
}
