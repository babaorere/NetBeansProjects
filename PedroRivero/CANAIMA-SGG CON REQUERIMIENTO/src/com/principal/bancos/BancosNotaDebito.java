...
public final class BancosNotaDebito extends javax.swing.JFrame {
     ...
     * @param inparent
     */
    public BancosNotaDebito(final java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
    ...
    void initComponents() {
        ...
        // NOI18N
        tblMaster.setFont(new java.awt.Font("Arial", 3, 12));
        tblMaster.setForeground(new java.awt.Color(0, 51, 102));
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "ID", "FECHA", "SOPORTE", "DESCRIPCIÓN", "MONTO BS.", "Reg" }) {
        ...
        // NOI18N
        cmbCuentas.setFont(new java.awt.Font("Tahoma", 2, 16));
        ...
        // NOI18N
        btnReversar.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        // NOI18N
        btnNuevo.setFont(new java.awt.Font("Arial", 2, 14));
...
//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (edo == edoNuevo) {
            try {
                ...
                pst.setString(3, Propiedades.setColStrLen("bancos_operaciones", "descripcion", desc));
                pst.setString(4, sFecha);
                pst.setString(5, tipo_operacion);
                pst.setString(6, Propiedades.setColStrLen("bancos_operaciones", "soporte_o_cheque", soporte));
                // conciliado
                pst.setString(7, "");
                // debe
                pst.setDouble(8, 0.00d);
                // haber
                pst.setDouble(9, monto);
                // secuencial
                pst.setDouble(10, ModelMapNextOp.getNext(Globales.getEjeFisYear(), cuenta));
                // cuenta_numop
...
//GEN-LAST:event_jButton1ActionPerformed
    ...
    private static final Logger logger = LogManager.getLogger(BancosNotaDebito.class);
}
