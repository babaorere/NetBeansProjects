...
public final class BancosContabilidad extends javax.swing.JFrame {
    ...
    public BancosContabilidad(java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
    ...
    private void MostrarTblCuentas() {
        ...
        try {
            final ResultSet rs = ConnCapip.getInstance().executeQuery("SELECT * FROM bancos WHERE ejefis= " + Globales.getServerYear() + " ORDER BY banco, cuenta ASC");
            while (rs.next()) {
                final String cuenta = rs.getString("cuenta");
                final BigDecimal saldoi = rs.getBigDecimal("saldoi");
                // tomar todos los movimientos
                final BigDecimal mov = BancosContabilidad.getMovHasta(cuenta, ejeFis, 12);
                datos[0] = cuenta;
     ...
     * @param incuenta
     */
    private void MostrarTblAuxiliar(String incuenta) {
        if (incuenta == null) {
            return;
        }
        // Para evitar multiples llamadas al metodo valueChanged
     ...
     * @return
     */
    private String sqlAuxBancosDet(final String incuenta) {
        if ((incuenta == null) || incuenta.isEmpty()) {
            return sqlAuxBancosDet();
        }
        final String sql;
        if (btnAno.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Enero";
            meshasta = "Diciembre";
        } else if (tbtnEne.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 1 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Enero";
            meshasta = "Enero";
        } else if (tbtnFeb.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 2 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Febrero";
            meshasta = "Febrero";
        } else if (tbtnMar.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 3 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Marzo";
            meshasta = "Marzo";
        } else if (jToggleButtonabr.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 4 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Abril";
            meshasta = "Abril";
        } else if (jToggleButtonmay.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 5 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Mayo";
            meshasta = "Mayo";
        } else if (jToggleButtonjun.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 6 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Junio";
            meshasta = "Junio";
        } else if (jToggleButtonjul.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 7 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Julio";
            meshasta = "Julio";
        } else if (jToggleButtonago.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 8 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Agosto";
            meshasta = "Agosto";
        } else if (jToggleButtonsep.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 9 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Septiembre";
            meshasta = "Septiembre";
        } else if (jToggleButtonoct.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 10 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Octubre";
            meshasta = "Octubre";
        } else if (jToggleButtonnov.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 11 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Noviembre";
            meshasta = "Noviembre";
        } else if (jToggleButtondic.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 12 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
            mesdesde = "Diciembre";
            meshasta = "Diciembre";
        } else {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + incuenta + "' AND anulado_sn= 'N' ORDER BY id DESC";
     ...
     */
    public static BigDecimal getMovHasta(final String incuenta, final long yyyy, final long MM) throws Exception {
        if ((incuenta == null) || incuenta.isEmpty() || (yyyy < 2017) || (MM < 0) || (MM > 12)) {
            return BigDecimal.ZERO;
        }
        final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("SELECT SUM(debe - haber) FROM bancos_operaciones " + "WHERE cuenta= ? AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = ? AND EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) <= ? AND anulado_sn= 'N'");
        pst.setString(1, incuenta);
        pst.setLong(2, yyyy);
     ...
     * @throws java.lang.Exception
     */
    public static BigDecimal getMovAnt(final String incuenta, final long inyyyy, final long inMM) throws Exception {
        if ((incuenta == null) || incuenta.isEmpty() || (inyyyy < 2017) || (inMM < 0) || (inMM > 12)) {
            return BigDecimal.ZERO;
        }
        final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("SELECT SUM(debe - haber) FROM bancos_operaciones WHERE cuenta= ? AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = ? AND EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) < ? AND anulado_sn= 'N'");
        pst.setString(1, incuenta);
        pst.setLong(2, inyyyy);
        pst.setLong(3, inMM);
        BigDecimal mov;
        final ResultSet rs = pst.executeQuery();
        if (rs.next()) {
     ...
     * @throws java.lang.Exception
     */
    public static BigDecimal getSaldoI(final String incuenta, final long inejefis, final long inMM) throws Exception {
        BigDecimal saldoi;
        // Hallar el banco
        ...
        if (rs.next()) {
            ...
            final ResultSet rsSaldoAnual = ConnCapip.getInstance().executeQuery("SELECT * FROM banco_saldo_anual WHERE id_banco= " + id_banco + " AND YEAR(ejefis) = " + inejefis);
            if (rsSaldoAnual.next()) {
                saldoIniAnual = rsSaldoAnual.getBigDecimal("saldoi");
            } else {
                saldoIniAnual = BigDecimal.ZERO;
            }
            saldoi = saldoIniAnual.add(getMovAnt(incuenta, inejefis, inMM));
        } else {
     ...
     * @throws java.lang.Exception
     */
    public static BigDecimal getSaldoF(final String incuenta, final long inyyyy, final long inMM) throws Exception {
        BigDecimal saldof;
        // Hallar el banco
        final ResultSet rs = ConnCapip.getInstance().executeQuery("SELECT * FROM bancos WHERE cuenta='" + incuenta + "'");
        if (rs.next()) {
            final long id_banco = rs.getLong("id");
            BigDecimal saldoIniAnual;
            final ResultSet rsSaldoAnual = ConnCapip.getInstance().executeQuery("SELECT * FROM banco_saldo_anual WHERE id_banco= " + id_banco + " AND YEAR(ejefis) = " + inyyyy);
            if (rsSaldoAnual.next()) {
                saldoIniAnual = rsSaldoAnual.getBigDecimal("saldoi");
            } else {
                saldoIniAnual = BigDecimal.ZERO;
            }
            saldof = saldoIniAnual.add(getMovHasta(incuenta, inyyyy, inMM));
        } else {
            JOptionPane.showMessageDialog(null, "Cuenta no encontrada");
    ...
    void initComponents() {
        ...
        btnExcelCuentas.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnExcelCuentas.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        // NOI18N
        tblCuentas.setFont(new java.awt.Font("Arial", 3, 16));
        tblCuentas.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Cuenta", "Banco", "Monto" }) {
        ...
        tblCuentas.setSelectionBackground(new java.awt.Color(175, 204, 125));
        ...
        btnRegistrar.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnRegistrar.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        // NOI18N
        btnEliminar.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        btnImprimir.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnImprimir.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        btnDeposito.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnDeposito.setFont(new java.awt.Font("Arial", 2, 14));
        btnDeposito.setText("DEPOSITOS");
        btnDeposito.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        btnTrans.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnTrans.setFont(new java.awt.Font("Arial", 2, 14));
        btnTrans.setText("TRANSFERENCIA");
        btnTrans.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        btnCredito.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnCredito.setFont(new java.awt.Font("Arial", 2, 14));
        btnCredito.setText("NOTAS DE CREDITO");
        btnCredito.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        btnDebito.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnDebito.setFont(new java.awt.Font("Arial", 2, 14));
        btnDebito.setText("NOTAS DE DEBITO");
        btnDebito.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        btnConciliaciones.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnConciliaciones.setFont(new java.awt.Font("Arial", 2, 14));
        btnConciliaciones.setText("CONCILIACIONES BANCARIAS");
        btnConciliaciones.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jTextFieldfecha.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        // NOI18N
        tblAuxBco.setFont(new java.awt.Font("Arial", 3, 16));
        tblAuxBco.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "FECHA", "SOPORTE", "DESCRIPCION", "TIPO", "DEBE BS.", "HABER BS.", "CONCILIADO" }) {

            Class[] types = new Class[] { java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.String.class };
        ...
        btnTiposCuentas.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        btnTiposCuentas.setFont(new java.awt.Font("Arial", 2, 18));
        btnTiposCuentas.setText("REPORTE LIBRO BANCO");
        btnTiposCuentas.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        // NOI18N
        btnExcel.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        txtLibro.setBackground(new java.awt.Color(175, 204, 125));
        // NOI18N
        txtLibro.setFont(new java.awt.Font("Arial", 3, 18));
        txtLibro.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtLibro.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtLibro.setEnabled(false);
        txtLibro.setSelectionColor(new java.awt.Color(175, 204, 125));
        ...
        tbtnEne.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(tbtnEne);
        // NOI18N
        tbtnEne.setFont(new java.awt.Font("Arial", 3, 18));
        tbtnEne.setText("Ene");
        ...
        tbtnFeb.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(tbtnFeb);
        // NOI18N
        tbtnFeb.setFont(new java.awt.Font("Arial", 3, 18));
        tbtnFeb.setText("Feb");
        ...
        tbtnMar.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(tbtnMar);
        // NOI18N
        tbtnMar.setFont(new java.awt.Font("Arial", 3, 18));
        tbtnMar.setText("Mar");
        ...
        jToggleButtonabr.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(jToggleButtonabr);
        // NOI18N
        jToggleButtonabr.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jToggleButtonmay.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(jToggleButtonmay);
        // NOI18N
        jToggleButtonmay.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jToggleButtonjun.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(jToggleButtonjun);
        // NOI18N
        jToggleButtonjun.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jToggleButtonjul.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(jToggleButtonjul);
        // NOI18N
        jToggleButtonjul.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jToggleButtonago.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(jToggleButtonago);
        // NOI18N
        jToggleButtonago.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jToggleButtonsep.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(jToggleButtonsep);
        // NOI18N
        jToggleButtonsep.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jToggleButtonoct.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(jToggleButtonoct);
        // NOI18N
        jToggleButtonoct.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jToggleButtonnov.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(jToggleButtonnov);
        // NOI18N
        jToggleButtonnov.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jToggleButtondic.setBackground(new java.awt.Color(175, 204, 125));
        grpMes.add(jToggleButtondic);
        // NOI18N
        jToggleButtondic.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnExcel1.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        // NOI18N
        lblSaldoI.setFont(new java.awt.Font("Arial", 3, 14));
        ...
        txtSaldoI.setBackground(new java.awt.Color(175, 204, 125));
        ...
        txtSaldoI.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtSaldoI.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtSaldoI.setEnabled(false);
        // NOI18N
        txtSaldoI.setFont(new java.awt.Font("Arial", 3, 16));
        getContentPane().add(txtSaldoI, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 530, 180, 30));
        txtBenef.setBackground(new java.awt.Color(175, 204, 125));
        // NOI18N
        txtBenef.setFont(new java.awt.Font("Arial", 3, 14));
        txtBenef.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtBenef.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        ...
        txtDebe.setBackground(new java.awt.Color(175, 204, 125));
        ...
        txtHaber.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtHaber.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtHaber.setEnabled(false);
        // NOI18N
        txtHaber.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        txtSaldoF.setBackground(new java.awt.Color(175, 204, 125));
        ...
        txtSaldoF.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtSaldoF.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtSaldoF.setEnabled(false);
        // NOI18N
        txtSaldoF.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondo azul 22.png")));
...
//GEN-FIRST:event_btnDepositoActionPerformed
        java.awt.Window me = this;
        java.awt.EventQueue.invokeLater(new Runnable() {
...
//GEN-FIRST:event_btnTransActionPerformed
        java.awt.Window me = this;
        java.awt.EventQueue.invokeLater(new Runnable() {
...
//GEN-LAST:event_btnTransActionPerformed
    private void btnDebitoActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnDebitoActionPerformed
        java.awt.Window me = this;
        java.awt.EventQueue.invokeLater(new Runnable() {
...
//GEN-FIRST:event_btnCreditoActionPerformed
        java.awt.Window me = this;
        java.awt.EventQueue.invokeLater(new Runnable() {
...
//GEN-LAST:event_btnCreditoActionPerformed
    private void btnConciliacionesActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnConciliacionesActionPerformed
        java.awt.Window me = this;
        java.awt.EventQueue.invokeLater(new Runnable() {
...
//GEN-FIRST:event_tblCuentasMouseClicked
        //        CalcularTodo();
    }
...
//GEN-LAST:event_tblCuentasMouseClicked
    ...
    private void tblAuxBcoMouseClicked(java.awt.event.MouseEvent evt) {
//GEN-FIRST:event_tblAuxBcoMouseClicked
...
//GEN-LAST:event_tblAuxBcoMouseClicked
    private void tbtnEneActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_tbtnEneActionPerformed
        final String cuenta;
...
//GEN-LAST:event_tbtnEneActionPerformed
    private void tbtnFebActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_tbtnFebActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_tbtnFebActionPerformed
    private void tbtnMarActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_tbtnMarActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_tbtnMarActionPerformed
    private void jToggleButtonabrActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jToggleButtonabrActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_jToggleButtonabrActionPerformed
    private void jToggleButtonmayActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jToggleButtonmayActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_jToggleButtonmayActionPerformed
    private void jToggleButtonjunActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jToggleButtonjunActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_jToggleButtonjunActionPerformed
    private void jToggleButtonjulActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jToggleButtonjulActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_jToggleButtonjulActionPerformed
    private void jToggleButtonagoActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jToggleButtonagoActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_jToggleButtonagoActionPerformed
    private void jToggleButtonsepActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jToggleButtonsepActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_jToggleButtonsepActionPerformed
    private void jToggleButtonoctActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jToggleButtonoctActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_jToggleButtonoctActionPerformed
    private void jToggleButtonnovActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jToggleButtonnovActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_jToggleButtonnovActionPerformed
    private void jToggleButtondicActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jToggleButtondicActionPerformed
        final String cuenta;
        if (txtLibro.getText().isEmpty()) {
            cuenta = "";
        } else {
...
//GEN-LAST:event_btnExcel1ActionPerformed
    private void btnExcelCuentasActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnExcelCuentasActionPerformed
        try {
...
//GEN-LAST:event_btnExcelCuentasActionPerformed
    private void btnTiposCuentasActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnTiposCuentasActionPerformed
...
//GEN-LAST:event_btnTiposCuentasActionPerformed
    ...
    private void actReporteLibroBanco() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al formatear el Saldo" + System.getProperty("line.separator") + inex);
            logger.error(inex);
            return;
        }
        param.put("saldo", saldo);
        // Generar y agrupar los registros
        final ArrayList<com.principal.modelos.LibroBancoRptModel> list = new ArrayList<>();
        for (int i = 0; i < tblAuxBco.getRowCount(); i++) {
            ...
            list.add(new com.principal.modelos.LibroBancoRptModel(i + 1, fecha, soporte, desc, tipo, debe, haber, conciliado));
        }
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        JasperExportManager.exportReportToPdfFile(jasperPrint, Propiedades.CAPIP_DIR_LOCAL + "/" + "libroBanco " + id_file + ".pdf");
                    } catch (final Exception inex) {
                        JOptionPane.showMessageDialog(null, inex);
                        logger.error(inex);
                    }
    ...
    //        final ResultSet rs = ConnCapip.getInstance().executeQuery("SELECT * FROM bancos WHERE cuenta='" + cuenta + "'");
    //        if (rs.next()) {
    ...
    //        final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE bancos SET saldof='" + saldoNuevo + "' WHERE id= " + id_banco);
    //        if (pst.executeUpdate() != 1) {
    //            throw new Exception("Error al actualizar saldo final");
    //        }
    //
    //        // Actualizar el saldo anual de banco
    //        final PreparedStatement pstSaldoAnual = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE banco_saldo_anual SET saldof= ? WHERE id_banco= ? AND YEAR(ejefis) = ?");
    ...
    private static final Logger logger = LogManager.getLogger(BancosContabilidad.class);
}
