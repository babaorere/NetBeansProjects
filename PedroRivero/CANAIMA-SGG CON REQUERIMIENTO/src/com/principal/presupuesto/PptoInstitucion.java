...
import static com.principal.capipsistema.Globales.TBL_PPTO_INGRESO;
...
import static com.principal.presupuesto.WinState.ADD;
import static com.principal.presupuesto.WinState.MODIFY;
import static com.principal.presupuesto.XJFrame.JBRESET;
import static com.principal.presupuesto.XJFrame.JBRETURN;
import static com.principal.presupuesto.XJFrame.JCBFILTER;
import static com.principal.presupuesto.XJFrame.JTABLE;
import static com.principal.presupuesto.XJFrame.JTFILTRO;
...
public final class PptoInstitucion extends XJFrameJTable {
     ...
     * @param inparent
     */
    public PptoInstitucion(final java.awt.Window inparent) {
        super(inparent);
        initComponents();
        setOwnBehavior();
        setCompBehavior();
    ...
    public void InitConditions() {
        ...
        tabla = com.principal.capipsistema.Globales.TBL_PPTO_EGRESO;
    ...
    void initComponents() {
        ...
        txtTotalPpto = new javax.swing.JFormattedTextField(com.principal.presupuesto.PptoGlobales.getCurFormatter());
        btnCancelar = new javax.swing.JButton();
        txtCodigo = new javax.swing.JFormattedTextField();
        txtMontoIni = new javax.swing.JFormattedTextField(com.principal.presupuesto.PptoGlobales.getCurFormatter());
        ...
        btnPptoGasto.setBackground(java.awt.SystemColor.inactiveCaption);
        bgPpto.add(btnPptoGasto);
        // NOI18N
        btnPptoGasto.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        btnPptoIngreso.setBackground(java.awt.SystemColor.inactiveCaption);
        bgPpto.add(btnPptoIngreso);
        // NOI18N
        btnPptoIngreso.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        // NOI18N
        cmbOrden.setFont(new java.awt.Font("Arial", 2, 15));
        ...
        // NOI18N
        jbResetear.setFont(new java.awt.Font("Arial", 2, 15));
        ...
        // NOI18N
        jcbFilter.setFont(new java.awt.Font("Arial", 2, 15));
        ...
        // NOI18N
        rbEjeFisAct.setFont(new java.awt.Font("Arial", 1, 14));
        rbEjeFisAct.setSelected(true);
        ...
        // NOI18N
        rbEjeFisNext.setFont(new java.awt.Font("Arial", 1, 14));
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Código", "Partida", "Monto Ini. Bs.", "Monto Disp. Bs.", "Cod. Contable", "Reg" }) {

            Class[] types = new Class[] { java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.String.class, java.lang.Object.class };
        ...
        // NOI18N
        jlCodigo.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        jlPartida.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        txtPartida.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        jlMonto.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        btnAgregar.setFont(new java.awt.Font("Arial", 1, 15));
        btnAgregar.setText("AGREGAR");
        ...
        jbEliminar.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        jbEliminar.setFont(new java.awt.Font("Arial", 1, 15));
        ...
        // NOI18N
        txtTotalPpto.setFont(new java.awt.Font("Arial", 3, 20));
        ...
        txtCodigo.setEnabled(false);
        // NOI18N
        txtCodigo.setFont(new java.awt.Font("Arial", 1, 15));
        ...
        txtMontoIni.setEnabled(false);
        // NOI18N
        txtMontoIni.setFont(new java.awt.Font("Arial", 3, 20));
        ...
        // NOI18N
        jlPartida1.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        txtCodContable.setEnabled(false);
        // NOI18N
        txtCodContable.setFont(new java.awt.Font("Arial", 1, 16));
        ...
        jbCreditoA.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        jbCreditoA.setFont(new java.awt.Font("Arial", 1, 15));
        ...
        jbTransfP.setBackground(java.awt.SystemColor.inactiveCaption);
        // NOI18N
        jbTransfP.setFont(new java.awt.Font("Arial", 1, 15));
        ...
        // NOI18N
        jbRetornar.setFont(new java.awt.Font("Arial", 1, 15));
        ...
        // NOI18N
        lblMsj.setFont(new java.awt.Font("Tahoma", 0, 14));
...
//GEN-FIRST:event_jbEliminarActionPerformed
        if (JOptionPane.showConfirmDialog(this, "La operación de Eliminar es irreversible. ¿ Desea continuar ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) != JOptionPane.OK_OPTION) {
            return;
        }
        java.awt.EventQueue.invokeLater(() -> {
...
//GEN-LAST:event_jbEliminarActionPerformed
    private void btnPptoGastoActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnPptoGastoActionPerformed
        tabla = com.principal.capipsistema.Globales.TBL_PPTO_EGRESO;
...
//GEN-LAST:event_btnPptoGastoActionPerformed
    private void btnPptoIngresoActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnPptoIngresoActionPerformed
...
//GEN-LAST:event_btnPptoIngresoActionPerformed
     ...
     * @param evt
     */
    private void jbCreditoAActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jbCreditoAActionPerformed
...
//GEN-LAST:event_jbCreditoAActionPerformed
     ...
     * @param evt
     */
    private void jbTransfPActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jbTransfPActionPerformed
        // Para que cuando retorne, actualice la vista
        update = true;
        final javax.swing.JFrame me = this;
        java.awt.EventQueue.invokeLater(new Runnable() {
...
//GEN-LAST:event_txtCodigoActionPerformed
    private void txtMontoIniActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtMontoIniActionPerformed
        switch (winState) {
            case ADD:
...
//GEN-LAST:event_txtMontoIniActionPerformed
    private void txtPartidaActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtPartidaActionPerformed
...
//GEN-LAST:event_btnCancelarActionPerformed
    private void btnAgregarFocusGained(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_btnAgregarFocusGained
        getRootPane().setDefaultButton(btnAgregar);
    }

//GEN-LAST:event_btnAgregarFocusGained
    private void btnModificarFocusGained(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_btnModificarFocusGained
        getRootPane().setDefaultButton(btnModificar);
    }

//GEN-LAST:event_btnModificarFocusGained
    private void jbEliminarFocusGained(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_jbEliminarFocusGained
        getRootPane().setDefaultButton(jbEliminar);
    }

//GEN-LAST:event_jbEliminarFocusGained
    private void btnAgregarFocusLost(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_btnAgregarFocusLost
        getRootPane().setDefaultButton(null);
    }

//GEN-LAST:event_btnAgregarFocusLost
    private void btnModificarFocusLost(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_btnModificarFocusLost
        getRootPane().setDefaultButton(null);
    }

//GEN-LAST:event_btnModificarFocusLost
    private void jbEliminarFocusLost(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_jbEliminarFocusLost
        getRootPane().setDefaultButton(null);
    }
...
//GEN-LAST:event_txtCodigoKeyTyped
    private void txtPartidaKeyTyped(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_txtPartidaKeyTyped
...
//GEN-LAST:event_txtPartidaKeyTyped
    private void txtMontoIniKeyTyped(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_txtMontoIniKeyTyped
...
//GEN-LAST:event_txtMontoIniKeyTyped
    private void rbEjeFisActActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_rbEjeFisActActionPerformed
        final Calendar fechaOp = Calendar.getInstance();
        ejeFis = fechaOp.get(Calendar.YEAR);
        ejeFisMes = ejeFis * 100 + fechaOp.get(Calendar.MONTH) + 1;
        UpdatePanels();
...
//GEN-LAST:event_rbEjeFisActActionPerformed
     ...
     * @param evt
     */
    private void rbEjeFisNextActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_rbEjeFisNextActionPerformed
        final Calendar fechaOp = Calendar.getInstance();
        ...
        try {
            if (rbEjeFisNext.isSelected()) {
                ...
                if (rsNext.next() && (rsNext.getInt("COUNT(*)") > 0)) {
                    if (JOptionPane.showConfirmDialog(this, "Existen registros para el proximo año Fiscal" + System.getProperty("line.separator") + " ¿ Desea eliminar estos registros ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                        ...
                        if (rsAct.next() && (rsAct.getInt("COUNT(*)") > 0)) {
                            if (JOptionPane.showConfirmDialog(this, "¿ Desea copiar los registros actuales, al nuevo Ejercicio Fiscal ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                                ...
                                while (rsCopy.next()) {
                                    PreparedStatement pstCopy = ConnPpto.conn.prepareStatement(// 1, 2, 3, 4
                                            "INSERT INTO " + tabla + " "
                                            + // 5, 6, 7
                                            "(codigo, partida, monto_ini, monto, "
                                            + // 8, 9, 10
                                            "ejefis, ejefismes, fchsession, " + "idsession, iduser, anulado_sn) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                                    ...
                                    // monto
                                    pstCopy.setBigDecimal(4, ZERO);
                                    pstCopy.setInt(5, ejeFis);
                                    // ejefismes
                                    pstCopy.setInt(6, ejeFisMes);
                    ...
                    // No hay registros para el proximo Ejercicio Fiscal if (rsNext.next() && (rsNext.getInt("COUNT(*)") > 0)) {
                    // Verificar si existe un presupuesto actual
                    final ResultSet rsAct = ConnPpto.executeQuery("SELECT COUNT(*) FROM " + tabla + " WHERE ejefis=" + (ejeFis - 1));
                    if (rsAct.next() && (rsAct.getInt("COUNT(*)") > 0)) {
                        if (JOptionPane.showConfirmDialog(this, "No existe presupuesto para el nuevo Ejercicio Fiscal" + System.getProperty("line.separator") + "¿ Desea copiar los registros actuales, al nuevo Ejercicio Fiscal ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                            final java.sql.Date fchSession = new java.sql.Date(fechaOp.getTimeInMillis());
                            final ResultSet rsCopy = ConnPpto.executeQuery("SELECT * FROM " + tabla + " WHERE ejefis=" + (ejeFis - 1));
                            setCursor(new Cursor(Cursor.WAIT_CURSOR));
                            while (rsCopy.next()) {
                                PreparedStatement pstCopy = ConnPpto.conn.prepareStatement("INSERT INTO " + tabla + "" + "(codigo, partida, monto_ini, monto, " + "ejefis, ejefismes, fchsession, " + "idsession, iduser, anulado_sn) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                                pstCopy.setString(1, rsCopy.getString("codigo"));
                                pstCopy.setString(2, rsCopy.getString("partida"));
                                pstCopy.setString(3, rsCopy.getString("monto_ini"));
                                // monto
...
//GEN-LAST:event_rbEjeFisNextActionPerformed
    private void tblMasterKeyTyped(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_tblMasterKeyTyped
    }

//GEN-LAST:event_tblMasterKeyTyped
    private void jbRetornarActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jbRetornarActionPerformed
    }

//GEN-LAST:event_jbRetornarActionPerformed
    private void txtCodContableActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtCodContableActionPerformed
        // TODO add your handling code here:
    }

//GEN-LAST:event_txtCodContableActionPerformed
    private void txtCodContableKeyTyped(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_txtCodContableKeyTyped
        // TODO add your handling code here:
    }
...
//GEN-LAST:event_cmbOrdenItemStateChanged
    ...
    private void Agregar() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (reg.getAnulado_sn().equals("N")) {
                    ...
                    if (JOptionPane.showConfirmDialog(this, "Ya existe un registro ANULADO (Eliminado) con el mismo Código." + System.getProperty("line.separator") + "¿ Desea recuperar dicho Registro ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
        ...
        final java.sql.Date fchSession = new java.sql.Date(fechaOp.getTimeInMillis());
        try {
            final PreparedStatement pst = ConnPpto.conn.prepareStatement("INSERT INTO " + tabla + "(codigo, partida, monto_ini, monto, ejefis, ejefismes, fchsession, idsession, iduser, cod_contable) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            pst.setString(1, codigo);
            pst.setString(2, partida);
            // monto inicial
            pst.setBigDecimal(3, monto);
    ...
    private void Modificar() {
        ...
        try {
            ...
            if (regSel.getMontoIni().compareTo(regSel.getMonto()) != 0) {
                if (JOptionPane.showConfirmDialog(this, "Este registro ya cuenta con operaciones en la Base de Datos." + System.getProperty("line.separator") + "¿ Desea actualizar el monto inicial de todos modos ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) != JOptionPane.OK_OPTION) {
                    // Abortar operacion
                    return;
                }
            }
    ...
    private static final Logger logger = LogManager.getLogger(PptoInstitucion.class);
}
