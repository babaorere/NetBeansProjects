...
import static com.principal.capipsistema.Globales.TBL_PPTO_ADICIONAL;
import static com.principal.capipsistema.Globales.TBL_PPTO_EGRESO;
...
public final class CreditoAdicional extends XJFrameJTable {
     ...
     * @param inparent
     */
    public CreditoAdicional(final JFrame inparent) {
        super(inparent);
        initComponents();
        setOwnBehavior();
        setCompBehavior();
    ...
    public void InitConditions() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error, otra aplicación ha bloqueado la Tabla de Presupuesto" + System.getProperty("line.separator") + inex);
            logger.error(inex);
        }
        Boolean centReCrear;
        try {
            ...
            if (rs.next()) {
                if (rs.getInt("SUM(monto)") > 0) {
                    centReCrear = JOptionPane.showConfirmDialog(this, "Hay datos guardados. ¿ Desea cargarlos ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) != JOptionPane.OK_OPTION;
                } else {
                    centReCrear = true;
                }
            } else {
    ...
    protected void UpdateJTable() {
        ...
        try {
            ...
            ConnCapip.getInstance().getConnection().createStatement().execute("UNLOCK TABLES");
        } catch (final Exception inex) {
            JOptionPane.showMessageDialog(null, inex);
            logger.error(inex);
        }
    ...
    private boolean Generar() {
        ...
        if (now.get(Calendar.YEAR) != com.principal.capipsistema.Globales.getEjeFisYear()) {
        ...
        try {
            ...
            final PreparedStatement ps = ConnPpto.conn.prepareStatement("INSERT INTO " + PptoGlobales.TBL_CREDITO_ADICIONAL + "(soporte, descripcion, monto, fecha,ejefis,ejefismes,fchsession,idsession,iduser) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    private boolean ModificarPartida() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al tratar de actualizar el registro" + System.getProperty("line.separator") + inex);
            txtMontoPartida.requestFocusInWindow();
            logger.error(inex);
            return false;
        }
    ...
    void initComponents() {
        ...
        txtTotalAcumPartidas = new javax.swing.JFormattedTextField(com.principal.presupuesto.PptoGlobales.getCurFormatter());
        txtCodigo = new javax.swing.JFormattedTextField(com.principal.presupuesto.PptoGlobales.getCodEgresoMaskFormatter());
        txtMontoPartida = new javax.swing.JFormattedTextField(com.principal.presupuesto.PptoGlobales.getCurFormatter());
        ...
        // NOI18N
        jtDesc.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        txtMontoCred.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        txtFechaCred.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        btnReIniciar.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Código", "Partida", "Monto Bs.", "Reg" }) {

            Class[] types = new Class[] { java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Object.class };
        ...
        // NOI18N
        txtTotalAcumPartidas.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        txtCodigo.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        txtMontoPartida.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        jbGenerar.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        // NOI18N
        jbConsultarC.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        // NOI18N
        lblMensaje.setFont(new java.awt.Font("Tahoma", 0, 14));
...
//GEN-FIRST:event_jbGenerarActionPerformed
        if (Generar()) {
            ClearDatosCredito();
            UpdateJTable();
            UpdatePanelDetails();
...
//GEN-LAST:event_jbGenerarActionPerformed
    private void jbConsultarCActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jbConsultarCActionPerformed
...
//GEN-LAST:event_jbConsultarCActionPerformed
    private void txtMontoPartidaActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtMontoPartidaActionPerformed
        txtMontoPartida.transferFocus();
    }

//GEN-LAST:event_txtMontoPartidaActionPerformed
    private void txtSoporteFocusGained(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_txtSoporteFocusGained
...
//GEN-LAST:event_txtSoporteActionPerformed
    private void jtDescFocusGained(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_jtDescFocusGained
        jtDesc.selectAll();
    }

//GEN-LAST:event_jtDescFocusGained
    private void jtDescActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jtDescActionPerformed
        jtDesc.transferFocus();
    }

//GEN-LAST:event_jtDescActionPerformed
    private void txtMontoCredFocusGained(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_txtMontoCredFocusGained
...
//GEN-LAST:event_txtMontoCredFocusGained
    private void txtMontoCredActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtMontoCredActionPerformed
        txtMontoCred.transferFocus();
    }

//GEN-LAST:event_txtMontoCredActionPerformed
    private void txtFechaCredFocusGained(java.awt.event.FocusEvent evt) {
//GEN-FIRST:event_txtFechaCredFocusGained
        txtFechaCred.selectAll();
    }

//GEN-LAST:event_txtFechaCredFocusGained
    private void txtFechaCredActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtFechaCredActionPerformed
        try {
...
//GEN-FIRST:event_jbCancelarActionPerformed
        UpdateJTable();
        UpdateEnabledAndFocus();
    }
...
//GEN-LAST:event_btnReIniciarActionPerformed
    ...
    protected void Salir() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Monto Total Acumulado inválido" + System.getProperty("line.separator") + inex);
        ...
        if (montoA.compareTo(ZERO) > 0) {
            if (JOptionPane.showConfirmDialog(this, "Hay datos cargados ¿ Confirmar salida ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) != JOptionPane.OK_OPTION) {
                return;
            }
            if (JOptionPane.showConfirmDialog(this, "¿ Desea conservar los datos acttuales ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) != JOptionPane.OK_OPTION) {
                try {
    ...
    private static final Logger logger = LogManager.getLogger(CreditoAdicional.class);
}
