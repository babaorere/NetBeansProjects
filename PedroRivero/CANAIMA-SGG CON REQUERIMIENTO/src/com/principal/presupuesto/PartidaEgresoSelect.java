...
public final class PartidaEgresoSelect extends XJFrameSelect {
     ...
     * @param inidSelIO
     */
    public PartidaEgresoSelect(JFrame inparent, int inidSelIO) {
    ...
    public void UpdateJTable() {
        ...
        try {
            final ResultSet rs = ConnPpto.executeQuery("SELECT * FROM " + TBL_PPTO_EGRESO + " WHERE ejefis= " + com.principal.capipsistema.Globales.getEjeFisYear());
            while (rs.next()) {
                final PptoModel aux = new PptoModel(rs);
                datos[colCodigo] = aux;
    ...
    protected void UpdatePanelDetails() {
        if (jtable.getRowCount() > 0) {
            ...
            if (selectedRow >= 0) {
                ...
                jtPartida.setCaretPosition(0);
                try {
                    jftMonto.setText(com.principal.capipsistema.Globales.curFormat.valueToString(((Number) jtable.getValueAt(selectedRow, colMonto)).doubleValue()));
                } catch (final Exception inex) {
                    JOptionPane.showMessageDialog(null, "Error en Monto: " + System.getProperty("line.separator") + inex);
    ...
    void initComponents() {
        ...
        jtTotalPpto = new javax.swing.JFormattedTextField(com.principal.presupuesto.PptoGlobales.getCurFormatter());
        jftCodigo = new javax.swing.JFormattedTextField(com.principal.presupuesto.PptoGlobales.getCodEgresoMaskFormatter());
        jftMonto = new javax.swing.JFormattedTextField(com.principal.presupuesto.PptoGlobales.getCurFormatter());
        jpComandos = new javax.swing.JPanel();
        jbRetornar = new javax.swing.JButton();
        jlFondo = new javax.swing.JLabel();
        setTitle("SELECCIONAR PARTIDA EGRESO");
        ...
        jtable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Código", "Partida", "Monto Bs." }) {
        ...
        jtPartida.setBackground(new java.awt.Color(175, 204, 125));
        // NOI18N
        jtPartida.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        jtPartida.setSelectionColor(new java.awt.Color(175, 204, 125));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        ...
        jtTotalPpto.setBackground(new java.awt.Color(175, 204, 125));
        ...
        // NOI18N
        jtTotalPpto.setFont(new java.awt.Font("Arial", 3, 20));
        ...
        // NOI18N
        jftMonto.setFont(new java.awt.Font("Arial", 3, 18));
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new PartidaEgresoSelect(null, 0).setVisible(true);
            }
        });
    }
    ...
    private static final Logger logger = LogManager.getLogger(PartidaEgresoSelect.class);
}
