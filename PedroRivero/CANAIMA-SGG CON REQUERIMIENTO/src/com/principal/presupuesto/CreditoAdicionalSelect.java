...
public final class CreditoAdicionalSelect extends XJFrameSelect {
     ...
     * @param inidSelIO
     */
    public CreditoAdicionalSelect(JFrame inparent, int inidSelIO) {
    ...
    public void UpdateJTable() {
        ...
        try {
            ...
            final ResultSet rs = ConnPpto.executeQuery("SELECT * FROM " + PptoGlobales.TBL_CREDITO_ADICIONAL + " WHERE ejefis=" + com.principal.capipsistema.Globales.getEjeFisYear() + " ORDER BY fecha ASC");
            while (rs.next()) {
                cont++;
                int id = rs.getInt("id");
    ...
    private void CreditoAdicionalRpt(int inselRow) throws Exception {
        final TblCreditoAdicional reg = (TblCreditoAdicional) tblMaster.getValueAt(inselRow, 0);
        idCreAdi = reg.getId();
        genRpt();
    }
    ...
    private void genRpt() throws Exception {
        ...
        if (pathRpt != null) {
            new Thread() {
                ...
                public void run() {
                    try {
                        JasperViewer.viewReport(JasperFillManager.fillReport(pathRpt, new HashMap<>(param), com.principal.connection.ConnCapip.getInstance().getConnection()), false);
                    } catch (final Exception inex) {
                        JOptionPane.showMessageDialog(null, inex);
                        logger.error(inex);
                    }
    ...
    void initComponents() {
        ...
        jtCant = new javax.swing.JFormattedTextField(Integer.valueOf(0));
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Soporte", "Descripción", "Monto Bs.", "Fecha" }) {
        ...
        jtCant.setBackground(new java.awt.Color(175, 204, 125));
        ...
        jtCant.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jtCant.setDoubleBuffered(true);
        jtCant.setFocusable(false);
        // NOI18N
        jtCant.setFont(new java.awt.Font("Arial", 3, 20));
        ...
        // NOI18N
        jtSoporte.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        jtSoporte.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        ...
        jftMontoCred.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jftMontoCred.setDoubleBuffered(true);
        jftMontoCred.setEnabled(false);
        // NOI18N
        jftMontoCred.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        jftFecha.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jftFecha.setEnabled(false);
        // NOI18N
        jftFecha.setFont(new java.awt.Font("Arial", 3, 18));
    ...
    private static final Logger logger = LogManager.getLogger(CreditoAdicionalSelect.class);
}
