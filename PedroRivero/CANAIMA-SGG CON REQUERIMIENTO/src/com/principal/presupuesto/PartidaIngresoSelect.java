...
public final class PartidaIngresoSelect extends XJFrameSelect {
     ...
     * @param inidSelIO
     */
    public PartidaIngresoSelect(JFrame inparent, int inidSelIO) {
    ...
    public void UpdateJTable() {
        ...
        try {
            final ResultSet rs = ConnPpto.executeQuery("SELECT * FROM " + TBL_PPTO_INGRESO + " WHERE ejefis=" + com.principal.capipsistema.Globales.getEjeFisYear());
            while (rs.next()) {
    ...
    void initComponents() {
        ...
        jftCodigo = new javax.swing.JFormattedTextField(com.principal.presupuesto.PptoGlobales.getCodIngresoMaskFormatter());
    ...
    private static final Logger logger = LogManager.getLogger(PartidaIngresoSelect.class);
}
