...
public final class TraspPartidas extends XJFrame {
    ...
    private void setStartConditions() {
        ...
        try {
            ...
            if (rsNext.next() && (rsNext.getInt(1) > 0)) {
                if (JOptionPane.showConfirmDialog(this, "Existen registros cargados en la Base de Datos" + System.getProperty("line.separator") + " ¿ Desea eliminar estos registros ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
    ...
    void initComponents() {
        ...
        // NOI18N
        btnPptoEgresoOrg.setFont(new java.awt.Font("Arial", 2, 16));
        btnPptoEgresoOrg.setSelected(true);
        ...
        // NOI18N
        btnPptoIngresoOri.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        // NOI18N
        txtMontoTotalOri.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        tblOrigen.setFont(new java.awt.Font("Arial", 3, 15));
        tblOrigen.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { { null, null, null, null, null, null, null }, { null, null, null, null, null, null, null }, { null, null, null, null, null, null, null }, { null, null, null, null, null, null, null } }, new String[] { "Código", "Partida", "Monto Ini. Bs.", "Monto Disp Bs.", "Traspaso Bs.", "RegPpto", "REgTraspDet" }) {

            Class[] types = new Class[] { java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class, java.lang.Object.class };
        ...
        // NOI18N
        btnPptoGastoDest.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        // NOI18N
        jtbPptoIngresoDest.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        // NOI18N
        txtMontoTotalDest.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        tblDestino.setFont(new java.awt.Font("Arial", 3, 15));
        tblDestino.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { { null, null, null, null, null, null, null }, { null, null, null, null, null, null, null }, { null, null, null, null, null, null, null }, { null, null, null, null, null, null, null } }, new String[] { "Código", "Partida", "Monto Ini. Bs.", "Monto Disp. Bs.", "Traspaso Bs.", "RegPpto", "RegTraspDet" }) {
        ...
        // NOI18N
        jtConcepto.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        jtReferencia.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        txtFechaTrasp.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        txtMontoTrasp.setFont(new java.awt.Font("Arial", 3, 16));
        ...
        // NOI18N
        jbConsultar.setFont(new java.awt.Font("Arial", 2, 16));
...
//GEN-FIRST:event_jbGenerarActionPerformed
        ...
        try {
            ...
            final PreparedStatement psTrasp = ConnPpto.conn.prepareStatement(// 1, 2, 3,
                    "INSERT INTO " + PptoGlobales.TBL_TRASP_PARTIDAS
                    + // 4, 5, 6
                    "(id_user, id_session, date_session, "
                    + // 7, 8, 9, 10
                    "ppto_egr_ing, referencia, fecha, " + "monto, concepto, ejefis, ejefismes) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", Statement.RETURN_GENERATED_KEYS);
            ...
            for (int i = 0; i < tblOrigen.getRowCount(); i++) {
                ...
                if (rsPpto.next()) {
                    ...
                    if (regPpto.getMonto().compareTo(regTraspDet.getMonto()) < 0) {
                        throw new Exception("Error registro en presupuesto, con saldo negativo" + System.getProperty("line.separator") + regPpto.getPartida());
                    }
                } else {
...
//GEN-LAST:event_jbGenerarActionPerformed
    ...
    private void jtReferenciaActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jtReferenciaActionPerformed
        jtReferencia.transferFocus();
    }

//GEN-LAST:event_jtReferenciaActionPerformed
    private void jtConceptoActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_jtConceptoActionPerformed
        jbGenerar.requestFocusInWindow();
    }

//GEN-LAST:event_jtConceptoActionPerformed
    private void btnPptoEgresoOrgActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnPptoEgresoOrgActionPerformed
        strTblOri = TBL_PPTO_EGRESO;
...
//GEN-LAST:event_btnPptoEgresoOrgActionPerformed
    private void btnPptoIngresoOriActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnPptoIngresoOriActionPerformed
...
//GEN-LAST:event_btnPptoIngresoOriActionPerformed
    private void btnPptoGastoDestActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_btnPptoGastoDestActionPerformed
        final java.awt.Window me = this;
        java.awt.EventQueue.invokeLater(new Runnable() {
...
//GEN-FIRST:event_jbConsultarActionPerformed
        final java.awt.Window me = this;
        java.awt.EventQueue.invokeLater(new Runnable() {
...
//GEN-LAST:event_jbConsultarActionPerformed
    private void txtFechaTraspActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtFechaTraspActionPerformed
        txtFechaTrasp.transferFocus();
    }

//GEN-LAST:event_txtFechaTraspActionPerformed
    private void txtMontoTraspActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtMontoTraspActionPerformed
        txtMontoTrasp.transferFocus();
    }

//GEN-LAST:event_txtMontoTraspActionPerformed
    private void jtReferenciaKeyTyped(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_jtReferenciaKeyTyped
...
//GEN-LAST:event_jtReferenciaKeyTyped
    private void jtConceptoKeyTyped(java.awt.event.KeyEvent evt) {
//GEN-FIRST:event_jtConceptoKeyTyped
...
//GEN-LAST:event_formWindowGainedFocus
    ...
    private static final Logger logger = LogManager.getLogger(TraspPartidas.class);
}
