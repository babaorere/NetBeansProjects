...
public final class TblCreditoAdicional implements ID<TblCreditoAdicional> {
    ...
    public TblCreditoAdicional(int inid, String insoporte, String indescripcion, BigDecimal inmonto, java.sql.Date infecha, java.sql.Date infechaGen) {
        this.id = inid;
    ...
    private static final Logger logger = LogManager.getLogger(TblCreditoAdicional.class);
}
