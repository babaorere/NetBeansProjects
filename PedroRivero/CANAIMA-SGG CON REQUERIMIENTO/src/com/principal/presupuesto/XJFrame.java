...
public abstract class XJFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form inPadre
     *
     * @param inparent
     */
    public XJFrame(final java.awt.Window inparent) {
        super();
        parent = inparent;
        xjparam = null;
    }
    ...
    protected void ConfigComponents(final Map<String, Object> inparam) {
        ...
        JButton jbReturn = (JButton) inparam.get("jbReturn");
        if (jbReturn != null) {
    ...
    void initComponents() {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 1100, Short.MAX_VALUE));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 650, Short.MAX_VALUE));
        pack();
    }
    ...
    private static final Logger logger = LogManager.getLogger(XJFrame.class);
}
