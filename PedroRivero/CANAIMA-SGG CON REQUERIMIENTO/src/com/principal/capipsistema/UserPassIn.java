...
import com.principal.configuracion.Configuracion;
...
public final class UserPassIn extends javax.swing.JFrame {
    ...
    // Para generar un log de mensajes de error, y otros
    private static final Logger logger = LogManager.getLogger(UserPassIn.class);
    ...
    static {
        ...
        user = "DEBUG";
        try {
            Logger log = LogManager.getLogger("xxxxUserPassIn.class");
        } catch (Exception e) {
            System.out.println("¡No se pudo cargar el archivo log4j2.xml!");
            e.printStackTrace();
            logger.error(e);
        }
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Configuración de Log4j2 cargada correctamente.");
        }

        if (logger.isInfoEnabled()) {
            logger.info("Configuración de Log4j2 cargada correctamente.");
        }

        // Verificar la configuración en tiempo de ejecución
        LoggerContext context = (LoggerContext) LogManager.getContext(false);
        Configuration config = context.getConfiguration();

        // Verificar los apéndices y sus rutas de archivo
        config.getAppenders().forEach((name, appender) -> {
            if (appender instanceof org.apache.logging.log4j.core.appender.FileAppender) {
                String fileName = ((org.apache.logging.log4j.core.appender.FileAppender) appender).getFileName();
                logger.info("Nombre del archivo de registro: " + fileName);
            }
        });

        ////////////////////////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////////////////////////
//         Para debug, en produccion puede ser eliminada
//        logger.info("La aplicacion ha sido iniciada");
//
...
//        logger.error("***   Este es un mensaje de error.   ***");
    ...
    void initComponents() {
        ...
        // NOI18N
        btnEntrar.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        // NOI18N
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Contraseña.png")));
            ...
            if (rs.next()) {
                ...
                if (ejeFisServidor != ejefis) {
                    ...
                    if (aux_user.equals("ADMIN")) {
                        if (JOptionPane.showConfirmDialog(this, "¿ Desea actualizar en el Servidor, el Ejercicio Fiscal: " + ejeFisCliente + " ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                            Configuracion.actGuardarEjeFis(String.valueOf(ejeFisServidor));
                            exit(1);
                        } else {
                            JOptionPane.showMessageDialog(null, "Discrepancia de fechas." + System.getProperty("line.separator") + Globales.CAPIP_CONTACTE_MSJ);
                            exit(1);
                        }
                    } else {
                        JOptionPane.showMessageDialog(null, "Discrepancia de fechas" + System.getProperty("line.separator") + Globales.CAPIP_CONTACTE_MSJ);
...
//GEN-LAST:event_txtPassKeyTyped
    ...
    private static final void actChoice(final String[] args) {
        switch (args.length) {
            case // sin parametros, ejecuta capip Normal
            0:
                actUserPassIn();
                break;
            case 1:
    ...
    private static void actShowHelp() {
        JOptionPane.showMessageDialog(null, "Error" + System.getProperty("line.separator") + "Comando no reconocido");
        JOptionPane.showMessageDialog(null, "Comandos disponibles" + System.getProperty("line.separator") + "-c Modo Configurador" + System.getProperty("line.separator") + "-h Ayuda" + System.getProperty("line.separator") + "-c -pAAAAAAAA Modo Configurador con password <AAAAAAAA>" + System.getProperty("line.separator"));
    }
    ...
    private static void actConfigurador(StringBuilder inaux) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new com.principal.capip_configurador.FrmConfing(inaux).setVisible(true);
            }
        });
    }
