...
public class Globales {
    ...
    private static final Logger logger = LogManager.getLogger(Globales.class);

    public static final OrdPagIdTipo ORD_PAG = OrdPagIdTipo.valueOf(Propiedades.CAPIP_NUM_PAGO);
