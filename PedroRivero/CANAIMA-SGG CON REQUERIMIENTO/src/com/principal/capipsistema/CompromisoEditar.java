...
public final class CompromisoEditar extends javax.swing.JFrame {
    ...
    public void setOwnBehavior() {
        ...
        final int MAXLEN_AE_BENRAZ = Propiedades.getColLen("avance_efectivo", "benef_razonsocial");
        // Crear un DocumentFilter para limitar la longitud del texto
        AbstractDocument documentAnu = (AbstractDocument) txtRazonSocial.getDocument();
        documentAnu.setDocumentFilter(getDocumentFilter(MAXLEN_AE_BENRAZ));
    }
    ...
    void initComponents() {
        ...
        // NOI18N
        btnOtrosCompr.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnGuardar.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnInsertar.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnEliminarUlt.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnConsultar.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        chkISLR.setFont(new java.awt.Font("Arial", 1, 18));
        ...
        // NOI18N
        btnServicio.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        // NOI18N
        btnCompra.setFont(new java.awt.Font("Arial", 3, 18));
        btnCompra.setSelected(true);
        ...
        // NOI18N
        btnBenefNuevo.setFont(new java.awt.Font("Tahoma", 0, 10));
...
//GEN-LAST:event_btnGuardarActionPerformed
    ...
    private boolean valComp(final Map<String, Object> inparam) {
        ...
        // 5.-
        final String benef_razonsocial = Propiedades.setColStrLen("avance_efectivo", "benef_razonsocial", txtRazonSocial.getText().trim().toUpperCase());
    ...
    private void genMaster(final Map<String, Object> inparam) throws Exception {
        ...
        pst.setString(7, Propiedades.setColStrLen(tipo_compr.getTbl(), "benef_razonsocial", (String) inparam.get("benef_razonsocial")));
