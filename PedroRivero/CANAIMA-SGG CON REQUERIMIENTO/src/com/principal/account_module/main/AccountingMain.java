...
import com.principal.accounting_module.accounting.comprobantes;
import com.principal.accounting_module.accounting.editaComprobante;
import com.principal.accounting_module.accounting.libros;
import com.principal.accounting_module.accounting.planCuenta;
...
public final class AccountingMain extends javax.swing.JFrame {
    ...
    public AccountingMain(final java.awt.Window inParent) {
        ...
        initComponents();
        this.setIconImage(new ImageIcon(getClass().getResource("/com/principal/accounting_module/img/lander.png")).getImage());
    ...
    public void comprobantes() {
        ...
        try {
            String sql = "SELECT DISTINCT `mh_auxiliar`.`cta_id` FROM mh_auxiliar Where emp_id='" + etiqCodigo.getText() + "' " + "AND aux_tipoCta='De Movimiento'";
            /*OR aux_tipoCta='De Totales'*/
            ConnAccounting bd = ConnAccounting.getInstance();
            ResultSet result = bd.buscar(sql);
            while (result.next()) {
    ...
    public void renovar() {
        if (JOptionPane.showOptionDialog(this, "Renovar el Periodo Fiscal implica \n " + "Que las cuentas quedaran en 0\n ¿Desea Renovar el Periodo Fiscal?", "Confirmar", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null, new Object[] { "Si", "NO" }, "No") == 0) {
            String sql;
            sql = "UPDATE `mh_empresas` " + "SET `mh_empresas`.`emp_inicioFiscal`=DATE_ADD(`mh_empresas`.`emp_inicioFiscal`,INTERVAL 1 YEAR)," + "`mh_empresas`.`emp_finFiscal`=DATE_ADD(`mh_empresas`.`emp_finFiscal`,INTERVAL 1 YEAR)" + " WHERE `mh_empresas`.`emp_id`='" + etiqCodigo.getText() + "'";
    ...
    public void GenerarBackupMySQL() {
        ...
        //JFileChooser de nombre RealizarBackupMySQL
        ...
        if (resp == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                Process child = runtime.exec("C:\\xampp\\mysql\\bin\\mysqldump  --password= --user=root " + "--databases sistemacontable -R");
    ...
    void initComponents() {
        ...
        // NOI18N
        jLabel6.setFont(new java.awt.Font("Arial", 3, 48));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("de Registros Contables");
        jLabel6.setAutoscrolls(true);
        // NOI18N
        jLabel3.setFont(new java.awt.Font("Arial", 3, 48));
        ...
        // NOI18N
        etiFecha.setFont(new java.awt.Font("Tahoma", 1, 14));
        etiFecha.setText("00/00/0000");
        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        // NOI18N
        btnListar.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        // NOI18N
        btnRegistrar.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        // NOI18N
        btnElegir.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        btnSalir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/principal/accounting_module/img/salir22.png")));
        ...
        // NOI18N
        btnPlanCta.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        // NOI18N
        btnListarPlan.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        // NOI18N
        btnComprobantes.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        // NOI18N
        btnEditaComprb.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        // NOI18N
        btnReportes.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        // NOI18N
        btnRenovar.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        // NOI18N
        btnVolver.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(btnPlanCta, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btnListarPlan, javax.swing.GroupLayout.PREFERRED_SIZE, 167, Short.MAX_VALUE).addComponent(btnComprobantes, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btnEditaComprb, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btnReportes, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btnRenovar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btnVolver, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
        jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addContainerGap().addComponent(btnPlanCta).addGap(7, 7, 7).addComponent(btnListarPlan).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(btnComprobantes).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(btnEditaComprb).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(btnReportes).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(btnRenovar).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(btnVolver).addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
        javax.swing.GroupLayout jPanel2Layout = new javax.swing.GroupLayout(jPanel2);
        jPanel2.setLayout(jPanel2Layout);
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(btnListar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btnRegistrar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btnSalir, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(btnElegir, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
        jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addComponent(btnRegistrar).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(btnListar).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(btnElegir, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(btnSalir, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
        ...
        jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
        jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE));
        mes.setText("jLabel4");
        etiyear.setText("jLabel4");
        // NOI18N
        etiqCodigo.setFont(new java.awt.Font("Tahoma", 1, 24));
        etiqCodigo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etiqCodigo.setText("            Codigo");
        // NOI18N
        etiqNombre.setFont(new java.awt.Font("Tahoma", 1, 24));
        etiqNombre.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etiqNombre.setText("            Nombre");
        // NOI18N
        etiqRif.setFont(new java.awt.Font("Tahoma", 1, 24));
        etiqRif.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etiqRif.setText("            Rif");
        // NOI18N
        etiInicio1.setFont(new java.awt.Font("Tahoma", 1, 24));
        etiInicio1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etiInicio1.setText("Inicio Fiscal: ");
        // NOI18N
        etiInicio.setFont(new java.awt.Font("Tahoma", 1, 24));
        etiInicio.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etiInicio.setText("Inicio");
        // NOI18N
        etiInicio2.setFont(new java.awt.Font("Tahoma", 1, 24));
        etiInicio2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etiInicio2.setText("Cierre Fiscal: ");
        // NOI18N
        etiFin.setFont(new java.awt.Font("Tahoma", 1, 24));
        ...
        panelContabilidadLayout.setHorizontalGroup(panelContabilidadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jPanel3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addGroup(panelContabilidadLayout.createSequentialGroup().addContainerGap().addComponent(mes).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(etiyear).addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addGroup(panelContabilidadLayout.createSequentialGroup().addGroup(panelContabilidadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(panelContabilidadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false).addComponent(etiqRif, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addGroup(panelContabilidadLayout.createSequentialGroup().addComponent(etiqCodigo).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(etiqNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 593, javax.swing.GroupLayout.PREFERRED_SIZE))).addGroup(panelContabilidadLayout.createSequentialGroup().addGroup(panelContabilidadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false).addComponent(etiInicio2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 336, Short.MAX_VALUE).addComponent(etiInicio1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addGroup(panelContabilidadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(etiInicio, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE).addComponent(etiFin, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))).addGap(0, 0, Short.MAX_VALUE)));
        panelContabilidadLayout.setVerticalGroup(panelContabilidadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(panelContabilidadLayout.createSequentialGroup().addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(panelContabilidadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(mes).addComponent(etiyear)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addGroup(panelContabilidadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(etiqCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(etiqNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(etiqRif, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(panelContabilidadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(etiInicio1).addComponent(etiInicio)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(panelContabilidadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(etiInicio2).addComponent(etiFin)).addGap(0, 100, Short.MAX_VALUE)));
        fechaSQL.setText("jLabel4");
        javax.swing.GroupLayout jPanel1Layout = new javax.swing.GroupLayout(jPanel1);
        jPanel1.setLayout(jPanel1Layout);
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(panelContabilidad, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 1001, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap()).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE).addComponent(fechaSQL).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(etiFecha).addGap(22, 22, 22))).addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 1007, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap()))));
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(etiFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(fechaSQL)).addGap(18, 18, 18).addComponent(jLabel3).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jLabel6).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(panelContabilidad, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
        ...
        // NOI18N
        menuEmpresas.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuListar.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuVolver.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuSalir.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuElegir.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuPlanCta.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuListarPlan.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuMovimientos.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuComprobantes.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuEditaComprobante.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuElegir5.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        // NOI18N
        menuElegir6.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 1198, Short.MAX_VALUE));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 521, Short.MAX_VALUE));
        pack();
    }

    // </editor-fold>//GEN-END:initComponents
    private void menuEmpresasActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuEmpresasActionPerformed
    ...
    private void menuSalirActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuSalirActionPerformed
        if (JOptionPane.showOptionDialog(this, "Se recomienda respaldar la base de datos \n " + "\n ¿Desea Respaldar?\n 'Si' para respaldar o 'No para Salir'", "Confirmar", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null, new Object[] { "Si", "No" }, "No") == 0) {
            GenerarBackupMySQL();
            if (this.parent == null) {
                System.exit(0);
            } else {
    ...
    private void menuListarActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuListarActionPerformed
        // TODO add your handling code here:
    ...
    private void menuElegirActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuElegirActionPerformed
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_btnListarActionPerformed
        reportes r = new reportes();
        r.listarEmpresas();
    }
    ...
    private void btnElegirActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_btnElegirActionPerformed
        elegir e = new elegir(this, true);
        e.setVisible(true);
        this.dispose();
    }
    ...
    private void menuPlanCtaActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuPlanCtaActionPerformed
        // TODO add your handling code here:
    }

    //GEN-LAST:event_menuPlanCtaActionPerformed
    private void menuListarPlanActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuListarPlanActionPerformed
    ...
    private void menuComprobantesActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuComprobantesActionPerformed
        comprobantes();
    }

    //GEN-LAST:event_menuComprobantesActionPerformed
    private void menuEditaComprobanteActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuEditaComprobanteActionPerformed
        this.editaComprobante();
    }

    //GEN-LAST:event_menuEditaComprobanteActionPerformed
    private void menuElegir5ActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuElegir5ActionPerformed
        libros();
    }

    //GEN-LAST:event_menuElegir5ActionPerformed
    private void menuElegir6ActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuElegir6ActionPerformed
        this.renovar();
    }

    //GEN-LAST:event_menuElegir6ActionPerformed
    private void menuVolverActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_menuVolverActionPerformed
        this.volver();
    }
    ...
    private void btnPlanCtaActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_btnPlanCtaActionPerformed
        planCuentas();
    }
    ...
    private void btnListarPlanActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_btnListarPlanActionPerformed
        String codigo = this.etiqCodigo.getText();
        reportes r = new reportes();
        r.listarPlanCuenta(codigo);
    }
    ...
    private void btnComprobantesActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_btnComprobantesActionPerformed
        comprobantes();
    }

    //GEN-LAST:event_btnComprobantesActionPerformed
    private void btnEditaComprbActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_btnEditaComprbActionPerformed
        this.editaComprobante();
    }

    //GEN-LAST:event_btnEditaComprbActionPerformed
    private void btnRenovarActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_btnRenovarActionPerformed
        this.renovar();
    }

    //GEN-LAST:event_btnRenovarActionPerformed
    private void btnReportesActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_btnReportesActionPerformed
        libros();
    }
    ...
    private static final Logger logger = LogManager.getLogger(AccountingMain.class);
}
