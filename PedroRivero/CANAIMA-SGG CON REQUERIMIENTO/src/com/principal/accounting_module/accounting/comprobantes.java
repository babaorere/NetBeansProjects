...
public final class comprobantes extends javax.swing.JFrame {
    ...
    private void inicializarTabla() {
        ...
        String[] columnNames = { "Cuenta", "Auxiliar", "Concepto", "Debe", "Haber" };
    ...
    public void ComprNro() {
        ...
        String sql = "SELECT IFNULL(MAX(`mh_comprobante`.`comp_id`),0) AS vv FROM `mh_comprobante` " + "WHERE `mh_comprobante`.`emp_id`='" + empresa.getText() + "' " + "AND `mh_comprobante`.`comp_fecha` BETWEEN '" + years + "/" + mes + "/01' AND '" + years + "/" + mes + "/31'";
    ...
    private String CrearSentencia(DefaultTableModel modelo) {
        ...
        for (int i = 0; i < modelo.getRowCount(); i++) {
            ...
            if (i == (modelo.getRowCount() - 1)) {
                sql += " ('" + codigo + "', '" + cuenta + "','" + auxiliar + "','" + comprb + "'," + "STR_TO_DATE('" + fechaComp + "','%d/%m/%Y'),'" + concepto + "','" + debe + "','" + haber + "',NULL) ";
            } else {
                sql += " ('" + codigo + "','" + cuenta + "','" + auxiliar + "','" + comprb + "'," + "STR_TO_DATE('" + fechaComp + "','%d/%m/%Y'),'" + concepto + "','" + debe + "','" + haber + "',NULL), ";
            }
        }
    ...
    private void RegistrarComprobante() {
        String sql = "";
        sql += "INSERT INTO `mh_comprobante` (`mh_comprobante`.`emp_id`,`mh_comprobante`.`cta_id`,`mh_comprobante`.`aux_id`," + "`mh_comprobante`.`comp_id`, `mh_comprobante`.`comp_fecha`,`mh_comprobante`.`comp_concepto`," + "`mh_comprobante`.`comp_debe`,`mh_comprobante`.`comp_haber`,`mh_comprobante`.`comp_linea`) " + "VALUES" + this.CrearSentencia(dtm);
        try {
    ...
    void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE));
        jPanel3.setBackground(new java.awt.Color(255, 255, 255));
        // NOI18N
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cargar Asiento", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11)));
        // NOI18N
        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14));
        jLabel2.setText("Fecha: ");
        // NOI18N
        cBoxCompMes.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        etiYear.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        txtNumCompr.setFont(new java.awt.Font("Tahoma", 1, 18));
        txtNumCompr.setText("0");
        // NOI18N
        etiCuenta.setFont(new java.awt.Font("Tahoma", 1, 14));
        etiCuenta.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        etiCuenta.setText("NombreCuenta");
        // NOI18N
        etiAux.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        etiqCuenta.setFont(new java.awt.Font("Tahoma", 1, 14));
        etiqCuenta.setText("Cuenta");
        // NOI18N
        cmboCuenta.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        etiqCuenta1.setFont(new java.awt.Font("Tahoma", 1, 14));
        etiqCuenta1.setText("Auxiliar");
        // NOI18N
        cmboAuxiliar.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        cmb_concepto.setFont(new java.awt.Font("Tahoma", 0, 12));
        ...
        // NOI18N
        etiqCuenta2.setFont(new java.awt.Font("Tahoma", 1, 14));
        etiqCuenta2.setText("Concepto");
        // NOI18N
        txtConcepto.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        btn_concepto.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addComponent(etiCuenta, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(etiAux, javax.swing.GroupLayout.PREFERRED_SIZE, 253, javax.swing.GroupLayout.PREFERRED_SIZE).addGap(179, 179, 179)).addGroup(jPanel3Layout.createSequentialGroup().addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(cBoxCompMes, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(etiYear, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)).addGroup(jPanel3Layout.createSequentialGroup().addComponent(etiqCuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(cmboCuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(etiqCuenta1, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(cmboAuxiliar, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))).addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup().addGap(23, 23, 23).addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(txtNumCompr, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap()).addGroup(jPanel3Layout.createSequentialGroup().addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(cmb_concepto, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)))).addGroup(jPanel3Layout.createSequentialGroup().addComponent(etiqCuenta2).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(txtConcepto).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(btn_concepto, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)))));
        jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(cBoxCompMes, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(etiYear, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(txtNumCompr).addComponent(jLabel3)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(etiCuenta).addComponent(etiAux)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(cmboCuenta, javax.swing.GroupLayout.Alignment.TRAILING).addComponent(cmboAuxiliar, javax.swing.GroupLayout.Alignment.TRAILING).addComponent(cmb_concepto, javax.swing.GroupLayout.Alignment.TRAILING).addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(etiqCuenta, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(etiqCuenta1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jButton1))).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(etiqCuenta2, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(txtConcepto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(btn_concepto)).addContainerGap()));
        jPanel4.setBackground(new java.awt.Color(255, 255, 255));
        // NOI18N
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Ingresar Monto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11)));
        etiqCuenta3.setBackground(java.awt.Color.black);
        // NOI18N
        etiqCuenta3.setFont(new java.awt.Font("Tahoma", 1, 14));
        etiqCuenta3.setText("Monto");
        // NOI18N
        txtMonto.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        radioDebe.setFont(new java.awt.Font("Tahoma", 1, 14));
        radioDebe.setText("Debe");
        radioHaber.setBackground(new java.awt.Color(255, 255, 255));
        debeHaber.add(radioHaber);
        // NOI18N
        radioHaber.setFont(new java.awt.Font("Tahoma", 1, 14));
        radioHaber.setText("Haber");
        // NOI18N
        btnAceptar.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        // NOI18N
        conId.setFont(new java.awt.Font("Tahoma", 1, 8));
        conId.setText("conID");
        javax.swing.GroupLayout jPanel4Layout = new javax.swing.GroupLayout(jPanel4);
        jPanel4.setLayout(jPanel4Layout);
        jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addContainerGap(22, Short.MAX_VALUE).addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(etiqCuenta3, javax.swing.GroupLayout.Alignment.TRAILING).addComponent(conId, javax.swing.GroupLayout.Alignment.TRAILING)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(btnAceptar, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE).addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(txtMonto, javax.swing.GroupLayout.Alignment.TRAILING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup().addComponent(radioDebe).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(radioHaber))))));
        jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup().addContainerGap().addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(radioDebe).addComponent(radioHaber)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(etiqCuenta3, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(txtMonto, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(btnAceptar, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(conId)).addContainerGap()));
        jPanel5.setBackground(new java.awt.Color(255, 255, 255));
        // NOI18N
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Comprobante", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11)));
        jScrollPane1.setBackground(new java.awt.Color(255, 255, 255));
        // NOI18N
        tabla.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        jPanel5Layout.setHorizontalGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel5Layout.createSequentialGroup().addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 893, javax.swing.GroupLayout.PREFERRED_SIZE).addGap(0, 0, Short.MAX_VALUE)));
        jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE));
        // NOI18N
        btnCalcular.setFont(new java.awt.Font("Tahoma", 1, 14));
    ...
    private void cmboCuentaActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_cmboCuentaActionPerformed
        cmboAuxiliar.removeAllItems();
        this.LlenarCmboAux();
    }

    //GEN-LAST:event_cmboCuentaActionPerformed
    private void cmboAuxiliarActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_cmboAuxiliarActionPerformed
        String sql = "SELECT * FROM mh_auxiliar Where emp_id='" + empresa.getText() + "' AND cta_id = '" + cmboCuenta.getSelectedItem() + "' " + "AND aux_id='" + cmboAuxiliar.getSelectedItem() + "'";
        ConnAccounting bd = ConnAccounting.getInstance();
        ResultSet rs = bd.buscar(sql);
        try {
            if (rs.next()) {
    ...
    private void cmb_conceptoActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_cmb_conceptoActionPerformed
    ...
    @SuppressWarnings("unchecked")
    private void btn_conceptoActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_btn_conceptoActionPerformed
        if (JOptionPane.showOptionDialog(this, "Desea Guardar este Concepto?", "Confirmar", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, new Object[] { "Si", "NO" }, "No") == 0) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (JOptionPane.showOptionDialog(this, a, "Confirmar", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, new Object[] { "Si", "NO" }, "No") == 0) {
    ...
    private void cBoxCompMesActionPerformed(java.awt.event.ActionEvent evt) {
        //GEN-FIRST:event_cBoxCompMesActionPerformed
        this.ComprNro();
    }

    //GEN-LAST:event_cBoxCompMesActionPerformed
    private void txtConceptoKeyTyped(java.awt.event.KeyEvent evt) {
        //GEN-FIRST:event_txtConceptoKeyTyped
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            if (fila == -1) {
                ...
                int resp = javax.swing.JOptionPane.showConfirmDialog(rootPane, "¿Esta seguro de eliminar este asiento " + (String) modelo.getValueAt(fila, 2) + " ?", "Indique Acción", javax.swing.JOptionPane.YES_NO_OPTION);
                //Elimino
                if (resp == 0) {
    ...
    private static final org.apache.logging.log4j.Logger logger = LogManager.getLogger(comprobantes.class);
}
