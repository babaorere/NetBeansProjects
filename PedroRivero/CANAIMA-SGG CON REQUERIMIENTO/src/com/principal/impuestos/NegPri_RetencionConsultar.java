 ...
 */
public class NegPri_RetencionConsultar extends javax.swing.JFrame {
     ...
     * @param inparent
     */
    public NegPri_RetencionConsultar(java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
    ...
    void initComponents() {
        ...
        setTitle("CONSULTA DE NEGRO PRIMERO");
...
//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ImpuestoRetencion.genNegPriReport(numop, new HashMap<>(101));
        } catch (final Exception inex) {
...
//GEN-LAST:event_btnAceptarActionPerformed
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new NegPri_RetencionConsultar(null).setVisible(true);
            }
        });
    }
    ...
    private static final Logger logger = LogManager.getLogger(NegPri_RetencionConsultar.class);
}
