 ...
 */
public class ImpMun_RetencionConsultar extends javax.swing.JFrame {
     ...
     * @param inparent
     */
    public ImpMun_RetencionConsultar(java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
    ...
    void initComponents() {
        ...
        setTitle("CONSULTA DE IMPUESTO MUNICIPAL");
        ...
        jLabel1.setText("INTRODUZCA  NÚMERO  A CONSULTAR");
        ...
        // NOI18N
        txtNumOrden.setFont(new java.awt.Font("Arial", 3, 18));
    ...
    private void txtNumOrdenActionPerformed(java.awt.event.ActionEvent evt) {
//GEN-FIRST:event_txtNumOrdenActionPerformed
        btnAceptar.doClick();
    }
...
//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ImpuestoRetencion.genImpMunReport(numop, new HashMap<>(101));
        } catch (final Exception inex) {
...
//GEN-LAST:event_btnAceptarActionPerformed
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new ImpMun_RetencionConsultar(null).setVisible(true);
            }
        });
    }
    ...
    private static final Logger logger = LogManager.getLogger(ImpMun_RetencionConsultar.class);
}
