 ...
 */
public class ORet_Consultar extends javax.swing.JFrame {
     ...
     * @param inparent
     */
    public ORet_Consultar(java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
...
//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ImpuestoRetencion.genORetReport(numop, new HashMap<>(101));
        } catch (final Exception inex) {
...
//GEN-LAST:event_btnAceptarActionPerformed
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new ORet_Consultar(null).setVisible(true);
            }
        });
    }
    ...
    private static final Logger logger = LogManager.getLogger(ORet_Consultar.class);
}
