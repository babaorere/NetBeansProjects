 ...
 */
public final class ISLR_Rend extends javax.swing.JFrame {

    private static final SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy/MM/dd");

    private static final int colNum = 0;

    private static final int colISLRNum = 1;
    ...
    private static final int colBaseImponible = 7;

    private static final int colISLRRetenido = 8;
     ...
     * @param inparent
     */
    public ISLR_Rend(final java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
    ...
    private void setCompBehavior() {
        ...
        tblMaster.getColumnModel().getColumn(colISLRNum).setCellRenderer(tcr);
        tcr.setHorizontalAlignment(SwingConstants.CENTER);
    ...
    void MostrarTblMaster() {
        ...
        try {
            ...
            while (rs.next()) {
                IslrRetencionDetModel reg = new IslrRetencionDetModel(rs);
                datos[colNum] = reg.getId_islr_retencion_det();
                datos[colISLRNum] = String.valueOf(reg.getId_islr_retencion());
                ...
                datos[colISLRRetenido] = reg.getIslr_retenido_bs().doubleValue();
                datos[colReg] = reg;
                model.addRow(datos);
            }
    ...
    void calcularIslrRet() {
        ...
        for (int i = 0; i < tblMaster.getRowCount(); i++) {
            ...
            ivaRet += (double) tblMaster.getValueAt(i, colISLRRetenido);
        }
    ...
    void initComponents() {
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "ID", "ISLR NUM", "CAUSADO", "FECHA FACT.", "FACTURA", "CONTRIBUYENTE", "MONTO Bs.", "BASE IMPONIBLE", "RETENIDO BS.", "Reg" }) {

            Class[] types = new Class[] { java.lang.Long.class, java.lang.String.class, java.lang.Long.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class };
        ...
        // NOI18N
        btnProcesar.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        getContentPane().add(btnProcesar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 570, 230, 40));
        // NOI18N
        jLabel5.setFont(new java.awt.Font("Arial", 3, 14));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("MONTO RETENIDO BS.");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 570, 190, 50));
        // NOI18N
        ...
        // NOI18N
        txtConcepto.setFont(new java.awt.Font("Arial", 3, 18));
        ...
        getContentPane().add(btnConsultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 570, 240, 40));
        ...
        setSize(new java.awt.Dimension(1046, 691));
    ...
    private void btnExcel1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            final String fileName = "RptIslrRendicion " + new SimpleDateFormat("yyyy-MM-dd hh-mm-ss").format(Globales.getServerTimeStamp());
    ...
    private void ReporteRendicion() {
        ...
        final InputStream pathRpt = aClass.getResourceAsStream("/reportes/rendicion_islr.jasper");
        if (pathRpt != null) {
            new Thread() {
    ...
    String sqlPeriodo() {
        ...
        try {
            ...
            sql = "SELECT * FROM islr_retencion_det WHERE ejefis >= '" + desde + "' AND ejefis <= '" + hasta + "' AND anulado_sn= '" + strAnulado + "' ORDER BY id_islr_retencion_det ASC";
        } catch (final Exception inex) {
            JOptionPane.showMessageDialog(this, "Error al formatear las fechas" + System.getProperty("line.separator") + inex);
            ejeFisMesDesde = null;
            ejeFisMesHasta = null;
            sql = "SELECT * FROM islr_retencion_det WHERE YEAR(ejefis) = " + Globales.getEjeFisYear() + " ORDER BY id_islr_retencion_det ASC";
            logger.error(inex);
        }
        return sql;
    }
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new ISLR_Rend(null).setVisible(true);
            }
        });
    }
    ...
    private static final Logger logger = LogManager.getLogger(ISLR_Rend.class);
}
