 ...
 */
public class IslrRetencionConsultar extends javax.swing.JFrame {
     ...
     * @param inparent
     */
    public IslrRetencionConsultar(java.awt.Window inparent) {
        super();
        initComponents();
        parent = inparent;
        setOwnBehavior();
    ...
    void initComponents() {
        ...
        setTitle("CONSULTA RETENCIÓN DEL ISLR");
...
//GEN-FIRST:event_btnAceptarActionPerformed
        String sIslrNum = txtNumOrden.getText().trim().toUpperCase();
        if (sIslrNum.isEmpty()) {
            return;
        }
        final Long islrNum;
        try {
            islrNum = Long.parseLong(sIslrNum);
        } catch (final Exception inex) {
        ...
        try {
            ImpuestoRetencion.genIslrReport(islrNum, new HashMap<>(101));
        } catch (final Exception inex) {
...
//GEN-LAST:event_btnAceptarActionPerformed
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new IslrRetencionConsultar(null).setVisible(true);
            }
        });
    }
    ...
    private static final Logger logger = LogManager.getLogger(IslrRetencionConsultar.class);
}
