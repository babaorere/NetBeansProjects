...
import com.principal.presupuesto.XJFrameSelect;
...
public final class RetensionSelect extends XJFrameSelect {
     ...
     * @param inidSelIO
     */
    public RetensionSelect(JFrame inparent, int inidSelIO) {
    ...
    void initComponents() {
        ...
        // NOI18N
        jtable.setFont(new java.awt.Font("Arial", 3, 14));
        jtable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Soporte", "Descripción", "Monto Bs.", "Fecha" }) {
        ...
        // NOI18N
        jbSeleccionar.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        // NOI18N
        jtCantBeneficiarios.setFont(new java.awt.Font("Tahoma", 0, 20));
        ...
        // NOI18N
        jbCancelar.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        // NOI18N
        jtSoporte.setFont(new java.awt.Font("Arial", 3, 14));
        ...
        // NOI18N
        jtDesc.setFont(new java.awt.Font("Arial", 3, 14));
        ...
        // NOI18N
        jftMontoCred.setFont(new java.awt.Font("Tahoma", 0, 30));
        jftMontoCred.setMinimumSize(new java.awt.Dimension(200, 21));
        jftMontoCred.setPreferredSize(new java.awt.Dimension(200, 21));
        jftMontoCred.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        jftMontoCred.setSelectionColor(new java.awt.Color(0, 0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.ipadx = 5;
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new RetensionSelect(null, 0).setVisible(true);
            }
        });
    }
    ...
    private static final Logger logger = LogManager.getLogger(RetensionSelect.class);
}
