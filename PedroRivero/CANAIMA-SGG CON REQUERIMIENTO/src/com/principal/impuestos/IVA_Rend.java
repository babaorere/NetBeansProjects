...
public final class IVA_Rend extends javax.swing.JFrame {
    ...
    void initComponents() {
        ...
        // NOI18N
        jtFiltro.setFont(new java.awt.Font("Tahoma", 0, 14));
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "ID", "IVA NUM", "CAUSADO", "FECHA FACT.", "FACTURA", "CONTRIBUYENTE", "MONTO Bs.", "MONTO IVA BS.", "RETENIDO IVA BS.", "Reg" }) {
        ...
        // NOI18N
        txtConcepto.setFont(new java.awt.Font("Tahoma", 0, 18));
    ...
    private static final Logger logger = LogManager.getLogger(IVA_Rend.class);
}
