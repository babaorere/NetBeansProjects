...
public final class Causado extends javax.swing.JFrame {
    ...
    private void setStartConditions() {
        ...
        if (btnCompra.isSelected()) {
            ...
            // Seleccionar el Presupuesto de compra
            btnCompra.setEnabled(true);
    ...
    void initComponents() {
        ...
        // NOI18N
        btnAnular.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/anular_32x32.png")));
        ...
        // NOI18N
        jLabel10.setFont(new java.awt.Font("Arial", 2, 14));
        ...
        // NOI18N
        tblDetalle.setFont(new java.awt.Font("Arial", 2, 16));
        tblDetalle.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Cant.", "Descripción", "Precio U. Bs.", "Sub. Total Bs.", "Cod. Presup.", "Partida" }) {
        ...
        // NOI18N
        jLabel11.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        // NOI18N
        txtConcepto.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        // NOI18N
        jLabel12.setFont(new java.awt.Font("Arial", 2, 18));
        ...
        // NOI18N
        txtBenefRazonSocial.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        // NOI18N
        txtBenefRifCI.setFont(new java.awt.Font("Arial", 2, 16));
        ...
        // NOI18N
        txtNroCompr.setFont(new java.awt.Font("Tahoma", 0, 36));
        ...
        // NOI18N
        txtNroCausado.setFont(new java.awt.Font("Tahoma", 0, 36));
        ...
        // NOI18N
        txtFecha.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        // NOI18N
        tblMaster.setFont(new java.awt.Font("Arial", 2, 16));
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Sel", "Núm. Compr.", "Beneficiario", "RIF/CI Benef.", "Total(+IVA) Bs.", "IVA Bs.", "Total Grab. Bs.", "Fecha Fact.", "Num. Fact.", "IVA %", "RegCompr" }) {

            Class[] types = new Class[] { java.lang.Boolean.class, java.lang.Long.class, java.lang.String.class, java.lang.Object.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class, java.lang.String.class, java.lang.Double.class, java.lang.Object.class };
        ...
        // NOI18N
        lblOC.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/circled_checkmark_32x32.png")));
...
//GEN-LAST:event_btnGuardarActionPerformed
    ...
    private boolean valCausadoComp(final Map<String, Object> inparam) {
        ...
        final String observacion = setColStrLen("causado", "observacion", auxConcepto.substring(0, min(auxConcepto.length(), 512)));
    ...
    public static void genCausadoMaster(final Map<String, Object> inparam, final JTable intblMaster) throws Exception {
        ...
        final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement(// 1, 2, 3
                "INSERT INTO causado("
                + // 4, 5, 6, 7
                "id_causado, id_user, id_session, "
                + // 8, 9
                "date_session, ejefis, fecha_causado,  tipo_compr, "
                + // 10, 11, 12
                "benef_razonsocial, benef_rif_ci, "
                + // 13, 14
                "observacion, resta_bs, " + "iva_ret_sn, islr_ret_sn) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        // id_causado
        ...
        // ejefis
        pst.setDate(5, Globales.getEjefis());
        ...
        // resta_bs
        pst.setBigDecimal(11, BigDecimal.ZERO);
        // iva_retenido_sn
        pst.setString(12, "N");
        // islr_retenido_sn
        pst.setString(13, "N");
        ...
        if (intblMaster != null) {
            for (int i = 0; i < intblMaster.getRowCount(); i++) {
                if ((Boolean) intblMaster.getValueAt(i, COL_MASTER_SELECT)) {
                    // Solo las seleccionadas
                ...
                if ((Boolean) intblMaster.getValueAt(i, COL_MASTER_SELECT)) {
                    ...
                    while (rs.next()) {
                        ...
                        if (rsAux.next()) {
                            ...
                            final PreparedStatement pst = cn.prepareStatement(// 1, 2, 3, 4
                                    "INSERT INTO causado_det"
                                    + // 5, 6, 7
                                    "(id_causado, id_user, id_session, date_session, " + "subtotal, codpresu, partida) " + "VALUES (?, ?, ?, ?, ?, ?, ?)");
                            pst.setLong(1, id_causado);
                            pst.setLong(2, UserPassIn.getIdUser());
                            pst.setLong(3, UserPassIn.getIdSession());
                            pst.setTimestamp(4, UserPassIn.getDateSession());
     ...
     * @throws Exception
     */
    public CauModel genReport(final long inid, Map<String, Object> inparam) throws Exception {
        ...
        final InputStream pathRpt = getClass().getResourceAsStream("/reportes/causado.jasper");
        if (pathRpt != null) {
            new Thread() {
...
//GEN-LAST:event_btnOtrosComprActionPerformed
    ...
    private void actAnular() {
        if (JOptionPane.showConfirmDialog(this, "La operación de anulación de Causado es irreversible. ¿ Desea continuar ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) != JOptionPane.OK_OPTION) {
            return;
        }
...
//GEN-LAST:event_btnReversarActionPerformed
    ...
    private static final Logger logger = LogManager.getLogger(Causado.class);
}
