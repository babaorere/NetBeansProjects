...
public final class CausadoReport extends XJFrameJTable {
    ...
    void initComponents() {
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Número", "Edo.", "Fecha", "Beneficiario", "RIF/CI", "Monto Bs.", "Resta Bs.", "Reg" }) {

            Class[] types = new Class[] { java.lang.Long.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class };
        ...
        // NOI18N
        lblCant.setFont(new java.awt.Font("Tahoma", 1, 14));
...
//GEN-FIRST:event_btnReportSummaryActionPerformed
        ...
        for (int i = 0; i < tblMaster.getRowCount(); i++) {
            ...
            try {
                final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO cau_rpt_summary(" + "num, fecha, razonsocial, rif, " + "total, fchsession, idsession, iduser) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
...
//GEN-LAST:event_btnResetActionPerformed
    ...
    private static final Logger logger = LogManager.getLogger(CausadoReport.class);
}
