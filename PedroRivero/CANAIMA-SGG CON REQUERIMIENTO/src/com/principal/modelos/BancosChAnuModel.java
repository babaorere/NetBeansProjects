...
public class BancosChAnuModel {
    ...
    public BancosChAnuModel(long inid_ch_anu, String inbanco, String incuenta, String incheque_anu, String incheque_nvo, String inmonto, String inpag_ava, Integer innum_pag_ava, String inmotivo_anu, Date infecha_anu, Integer inejefis, Integer inejefismes, Integer iniduser) {
        this.id_ch_anu = inid_ch_anu;
        this.banco = Propiedades.setColStrLen("bancos_ch_anu", "banco", inbanco);
        ...
        this.motivo_anu = Propiedades.setColStrLen("bancos_ch_anu", "motivo_anu", inmotivo_anu);
    ...
    public BancosChAnuModel(ResultSet inrs) throws Exception {
        this(inrs.getLong("id_ch_anu"), inrs.getString("banco"), inrs.getString("cuenta"), inrs.getString("cheque_anu"), inrs.getString("cheque_nvo"), inrs.getString("monto"), inrs.getString("pag_ava"), inrs.getInt("num_pag_ava"), inrs.getString("motivo_anu"), inrs.getDate("fecha_anu"), inrs.getInt("ejefis"), inrs.getInt("ejefismes"), inrs.getInt("iduser"));
    }
    ...
    private static final Logger logger = LogManager.getLogger(BancosChAnuModel.class);
}
