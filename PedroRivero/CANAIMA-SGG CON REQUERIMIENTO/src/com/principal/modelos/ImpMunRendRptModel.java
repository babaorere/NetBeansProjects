 ...
 */
public final class ImpMunRendRptModel {
     ...
     * @param inrif_ci
     */
    public ImpMunRendRptModel(final java.util.Date infechaop, final String inanulado_sn, final long innumop, final String innumfact, final String inrif_ci, final String incontribuyente, final BigDecimal inmtfactura, final BigDecimal inbase_imponible, final BigDecimal iniretenido) {
        fechaop = infechaop;
    ...
    private static final Logger logger = LogManager.getLogger(ImpMunRendRptModel.class);
}
