...
public class LibroBancoRptModel {
    ...
    public LibroBancoRptModel(final long inasiento, final String infecha, final String insoporte, final String indesc, final String intipo, final BigDecimal indebe, final BigDecimal inhaber, final String inconciliado) {
    ...
    private static final Logger logger = LogManager.getLogger(LibroBancoRptModel.class);
}
