 ...
 */
public class AvaEfeModel implements PagAvaInterface {
    ...
    public AvaEfeModel(final ResultSet inrs) throws Exception {
        id = inrs.getLong("id");
        ...
        a_pagar_bs = inrs.getBigDecimal("a_pagar_bs");
     ...
     * @return the id
     */
    public long getId_avance_efectivo() {
        return id;
    }
    ...
    private static final Logger logger = LogManager.getLogger(AvaEfeModel.class);
}
