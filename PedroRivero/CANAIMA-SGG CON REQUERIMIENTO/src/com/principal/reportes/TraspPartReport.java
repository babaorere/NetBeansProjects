...
import com.principal.presupuesto.TblTrasp;
import com.principal.presupuesto.TraspPartidasSelect;
...
public final class TraspPartReport extends XJFrameJTable {
    ...
    void initComponents() {
        ...
        // NOI18N
        jtFiltro.setFont(new java.awt.Font("Arial", 3, 15));
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Generada", "Referencia", "Fecha", "Monto Bs.", "Concepto", "Reg" }) {
            ...
            Class[] types = new Class[] { java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.Double.class, java.lang.String.class, java.lang.String.class };
        ...
        for (int i = 0; i < tblMaster.getRowCount(); i++) {
            ...
            try {
                final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement(// 1, 2, 3,
                        "INSERT INTO trasp_part_rpt_summary "
                        + // 4, 5,
                        "(id_user, id_session, date_session, "
                        + // 6, 7, 8
                        "ppto_egr_ing, referencia, " + "fecha, monto, concepto) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
...
//GEN-LAST:event_txtEjeFisFocusLost
    ...
    private static final Logger logger = LogManager.getLogger(TraspPartReport.class);
}
