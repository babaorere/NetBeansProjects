...
public final class CompromisoReport extends XJFrameJTable {
     ...
     * @param inparent
     */
    public CompromisoReport(final java.awt.Window inparent) {
        super(inparent);
        initComponents();
        setOwnBehavior();
        setCompBehavior();
    ...
    void initComponents() {
        ...
        txtMonto = com.principal.textfield_decimal.DecimalTextField.getTextField();
        ...
        tbtnCompra.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        tbtnServicio.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        tbtnOtros.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        // NOI18N
        cbxEstado.setFont(new java.awt.Font("Tahoma", 2, 16));
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {}, new String[] { "Número", "Edo.", "Fecha", "Beneficiario", "RIF/CI", "Monto Bs.", "RegCompr" }) {

            Class[] types = new Class[] { java.lang.Long.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Object.class };
...
//GEN-FIRST:event_btnReportSummaryActionPerformed
        ...
        try {
            ConnCapip.getInstance().getConnection().prepareStatement("DELETE FROM compr_rpt_summary WHERE fchsession <= '" + fchDelete + "' OR iduser=" + UserPassIn.getIdUser() + " AND idsession=" + UserPassIn.getIdSession()).executeUpdate();
        } catch (final Exception inex) {
            JOptionPane.showMessageDialog(null, inex);
            logger.error(inex);
            return;
        ...
        for (int i = 0; i < tblMaster.getRowCount(); i++) {
            ...
            try {
                final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO compr_rpt_summary(" + "num, edo, fecha, razonsocial, rif, total, fchsession, " + "idsession, iduser) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
//GEN-LAST:event_btnResetActionPerformed
    private void cbxFilterItemStateChanged(java.awt.event.ItemEvent evt) {
//GEN-FIRST:event_cbxFilterItemStateChanged
...
//GEN-LAST:event_cbxEstadoItemStateChanged
    ...
    private void comprRpt(int inselRow) {
        final ComprModel reg = (ComprModel) tblMaster.getValueAt(inselRow, colRegCompr);
        final Map<String, Object> param = new HashMap<>(101);
     ...
     */
    @SuppressWarnings("unchecked")
    public void reportSummary(final BigDecimal intot) {
        if (tblMaster.getRowCount() <= 0) {
    ...
    private static final Logger logger = LogManager.getLogger(CompromisoReport.class);
}
