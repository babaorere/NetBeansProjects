...
public final class PagoDirectoNormal extends javax.swing.JFrame implements CuentaUpdatable {
     ...
     * @param _parent
     */
    public PagoDirectoNormal(final java.awt.Window _parent) {
        super();
        initComponents();
...
//            JOptionPane.showMessageDialog(null, "Error al formatear los totales" + System.getProperty("line.separator") + _ex);
    ...
    private void btnIVAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIVAActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al trata de verificar la disponibilidad del IVA" + System.getProperty("line.separator") + _ex);
            txtCant.setText("0,00");
            txtDesc.setText("0,00");
            txtPUnitario.setText("0,00");
            txtSubTotal.setText("0,00");
    ...
    private void actGuardar() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de generar el Reporte de Compromiso" + System.getProperty("line.separator") + _ex);
        }

        try {
            Causado.genReport((long) param.get("id_causado"), param);
        } catch (final Exception _ex) {
            JOptionPane.showMessageDialog(this, "Error al tratar de generar el Reporte de Causado" + System.getProperty("line.separator") + _ex);
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de generar el Reporte de I.V.A." + System.getProperty("line.separator") + _ex);
        }
    ...
    private void genIvaDetail(final Map<String, Object> _param) throws Exception {
        ...
        final PreparedStatement pstCau = Conn.getConnection().prepareStatement("UPDATE causado SET resta_bs= resta_bs - ?, iva_ret_sn= 'S' WHERE id_causado= ?");
     ...
     *
     */
    private void IvaRetencionSN(final Map<String, Object> _param, final String _sn) {
        try {
            final long id_causado = (long) _param.get("id_causado");

            final PreparedStatement pstCau = Conn.getConnection().prepareStatement("UPDATE causado SET iva_ret_sn= ? WHERE id_causado= ?");
            pstCau.setString(1, _sn);
            pstCau.setLong(2, id_causado);
            if (pstCau.executeUpdate() != 1) {
                throw new Exception("Error sl actualizar el impuesto Retenido");
            }
        } catch (Exception _ex) {
            JOptionPane.showMessageDialog(this, "Error al tratar de actualizar el iva_ret_sn" + System.getProperty("line.separator") + _ex);
        }
    ...
    private void genIslrDetail(final Map<String, Object> _param) throws Exception {
        ...
        final PreparedStatement pstCau = Conn.getConnection().prepareStatement("UPDATE causado SET resta_bs= resta_bs - ?, islr_ret_sn= 'S' WHERE id_causado= ?");
     ...
     *
     */
    private void IslrRetencionSN(final Map<String, Object> _param, final String _sn) {
        try {
            final long id_causado = (long) _param.get("id_causado");

            final PreparedStatement pstCau = Conn.getConnection().prepareStatement("UPDATE causado SET islr_ret_sn= ? WHERE id_causado= ?");
            pstCau.setString(1, _sn);
            pstCau.setLong(2, id_causado);
            if (pstCau.executeUpdate() != 1) {
                throw new Exception("Error sl actualizar el impuesto Retenido");
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de actualizar el islr_ret_sn" + System.getProperty("line.separator") + _ex);
        }
    }
     ...
     *
     */
    private void OtrasRetencionSN(final Map<String, Object> _param, final String _sn) {
        try {
            final long id_causado = (long) _param.get("id_causado");

            final PreparedStatement pstCau = Conn.getConnection().prepareStatement("UPDATE causado SET oret_ret_sn= ? WHERE id_causado= ?");
            pstCau.setString(1, _sn);
            pstCau.setLong(2, id_causado);
            if (pstCau.executeUpdate() != 1) {
                throw new Exception("Error sl actualizar el impuesto Retenido");
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de actualizar el oret_ret_sn" + System.getProperty("line.separator") + _ex);
        }
    }
