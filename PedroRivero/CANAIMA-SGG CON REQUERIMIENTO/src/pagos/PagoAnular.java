...
public class PagoAnular extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public PagoAnular(final java.awt.Window _parent) {
        super();
        initComponents();
                            ...
                            try (final ResultSet rsCauPag = pstCauPag.executeQuery()) {
                                while (rsCauPag.next()) {
                                    ...
                                    if (regCau != null) {
                                        ...
                                        try (final PreparedStatement pstCompr = Conn.getConnection().prepareStatement("SELECT * FROM compr_otros WHERE id_causado= ?")) {
     ...
     * @param _id_compr
     */
    private void actAnularCompr(final long _id_compr, final TipoCompr _tipoCompr, final boolean genReporte) throws Exception {

        if ((_id_compr <= 0) || (_tipoCompr == null)) {
            return;
        }
        ...
        try {
            ...
            // Verificar la existencia de la orden
            final ResultSet rsCompr = Conn.executeQuery("SELECT * FROM " + _tipoCompr.getTbl() + " WHERE id_compr= " + _id_compr);
            if (rsCompr.next()) {
                ...
                param.put("tipo_compr", _tipoCompr);
                ...
                try {
                    ...
                    throw new Exception("Error al generar el reporte" + System.getProperty("line.separator") + _ex);
                }

                final ResultSet rsComprDet = Conn.executeQuery("SELECT * FROM compr_det WHERE id_compr= " + _id_compr + " AND tipo_compr= 'CO'");
                ...
                final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE " + _tipoCompr.getTbl() + " SET anulado_sn= 'S' WHERE id_compr= " + _id_compr);
