...
public class CompromisoAnular extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public CompromisoAnular(final java.awt.Window _parent) {
        super();
        initComponents();
            ...
            if (rsCompr.next()) {
                ...
                if (JOptionPane.showConfirmDialog(this, "Esta operación es irreversible. Desea eliminar el registro ?",
                    ...
                    try {
                        ...
                        final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE " + tipo_compr.getTbl() + " SET anulado_sn= 'S' WHERE id_compr= " + id_compr);
