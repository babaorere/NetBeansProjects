...
public final class PptoEli extends XJFrameSelect {
     ...
     * @param _tabla
     */
    public PptoEli(java.awt.Window _parent, final String _tabla) {
        super(_parent, 0);
        tabla = _tabla;
    ...
    public void UpdateJTable() {
        ...
        try {
            ...
            final ResultSet rs = Conn.executeQuery("SELECT * FROM " + tabla + " WHERE ejefis=" + Globales.getEjeFisYear() + anulado_sn + " ORDER BY " + orden[cmbOrden.getSelectedIndex()] + " ASC");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        chkAllReg.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        chkAllReg.setSelected(true);
        ...
        jtable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Anu.", "Código", "Partida", "Monto Bs.", "Reg"
            }
        ) {
        ...
        btnApply.setFont(new java.awt.Font("Arial", 2, 16)); // NOI18N
    ...
    private void chkAllRegItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkAllRegItemStateChanged
        UpdateJTable();
