...
// dbpool-7.0.jar, substance-4.3.jaradmin
/**
 * Constructor de DbConnection
 */
public class Conn {

    //private static final String server = "192.168.88.41";
    //private static final String bd = "usuario5";
    //private static final String login = "canaimasgg";
    //private static final String password = "@canaimasgg#";
    //private static final String url = "jdbc:mysql://" + server + ":3306/" + bd;
    private static final String DRIVER = "com.mysql.cj.jdbc.Driver";
    private static final String server = "localhost";
    private static final String bd = "capip_2023";
