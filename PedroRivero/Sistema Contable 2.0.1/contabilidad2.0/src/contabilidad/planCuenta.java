...
//            JOptionPane.showMessageDialog(null, "El codigo de la Cuenta ya Existe");
    ...
    public void Insert2() {
        ...
        if (bd.existeDato2("mh_auxiliar", "emp_id", "cta_id", emp, ctaID, 1)) {
            ...
            String sql = "INSERT INTO mh_auxiliar (emp_id,cta_id ,aux_nombreCta,aux_tipoCta,aux_condicion,aux_id,aux_nombreAux)"
                    + "VALUES ('" + emp + "','" + ctaID + "','" + ctaNomb + "','" + tipo + "','" + cond + "','" + auxID + "','" + auxNomb + "')";
            bd.ejecutar(sql);
            JOptionPane.showOptionDialog(this, "Cuenta Registrada \n Satisfactoriamente", "Ingreso Exitoso",
    ...
    public void inicializarCuentas() {
        ...
        if (condicion.equals("No") && tipo.equals("De Movimiento")) {
            ...
            sql += "INSERT INTO `mh_comprobante` (`mh_comprobante`.`emp_id`,`mh_comprobante`.`cta_id`,`mh_comprobante`.`aux_id`,"
                    ...
                    + "VALUES('" + emp + "','" + cuenta + "','','" + num + "',STR_TO_DATE('" + fecha + "','%d/%m/%Y'),'Comprobante Inicial',"
    ...
    public void inicializarAuxiliar() {
        ...
        if (condicion.equals("Si") && tipo.equals("De Movimiento")) {
            ...
            sql += "INSERT INTO `mh_comprobante` (`mh_comprobante`.`emp_id`,`mh_comprobante`.`cta_id`,`mh_comprobante`.`aux_id`,"
                    + "`mh_comprobante`.`comp_id`, `mh_comprobante`.`comp_fecha`,`mh_comprobante`.`comp_concepto`,"
                    + "`mh_comprobante`.`comp_debe`,`mh_comprobante`.`comp_haber`,`mh_comprobante`.`comp_linea`) "
                    + "VALUES('" + emp + "','" + cuenta + "','" + auxiliar + "','" + num + "',STR_TO_DATE('" + fecha + "','%d/%m/%Y'),'Comprobante Inicial',"
                    + "'" + cantidad + "','" + cantidad + "',NULL)";
            bd.ejecutar(sql);
    ...
    //Metodo para Ingresar los datos del Formulario Cuentas en la BaseDatos
    ...
    //Metodo para Consultar los datos de la BaseDatos para el Formulario Cuentas
    public void BuscarCuenta() {
        ...
        try {
            if (resul.next()) {
                ...
                JOptionPane.showOptionDialog(this, "Cuenta No Asociada\n Por Favor Ingrese los Datos", "Error",
                        JOptionPane.ERROR_MESSAGE, JOptionPane.INFORMATION_MESSAGE, null, new Object[]{"Aceptar"}, "Aceptar");
                txtNombre.setText("");
                cmbTipo.setSelectedItem("Seleccione");
                cmbCondicion.setSelectedItem("Seleccione");
                this.DeshabilitarAuxiliar();
    ...
    public void ModificarCuenta() {
        if (JOptionPane.showOptionDialog(this, "Desea Modificar estos Datos?", "Confirmar",
                JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null, new Object[]{"Si", "NO"}, "No") == 0) {
            String sql;
            ...
            System.out.println(sql); //muestra si la instruccion sql esta bien contruida
            BaseDatos bd = new BaseDatos();
            bd.ejecutar(sql);
        } else {
    ...
    //Metodo para Eliminar una Cuenta de la BaseDatos
    ...
    //Metodo para Modificar la Tabla Auxiliares en la BaseDatos
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Crear cuentas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        txtCuenta.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        cmbCondicion.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        btnIngresarCuenta.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(cmbCondicion, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(cmbTipo, javax.swing.GroupLayout.Alignment.LEADING, 0, 187, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(btnIngresarCuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cmbTipo, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
                    .addComponent(jLabel4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(16, 16, 16)
                        .addComponent(cmbCondicion, javax.swing.GroupLayout.DEFAULT_SIZE, 24, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnIngresarCuenta, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jLabel5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );

        jPanel4.setBackground(new java.awt.Color(255, 255, 255));
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Accion", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N

        btnEditarCuenta.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        btnEliminarCuenta.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(btnNuevo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnEditarCuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnEliminarCuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Asignar auxiliar", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        cmbListaAux.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        txtCodAux.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        txtNomAux.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        btnIngresarAux.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        btnNuevoAux.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btnNuevoAux, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel5Layout.createSequentialGroup()
                                        .addComponent(txtCodAux, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(10, 10, 10)
                                        .addComponent(jLabel9)))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtNomAux)
                            .addComponent(cmbListaAux, 0, 235, Short.MAX_VALUE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(btnIngresarAux, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(cmbListaAux)
                        .addGap(2, 2, 2)))
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtCodAux, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtNomAux, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnIngresarAux, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnNuevoAux, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );

        jPanel6.setBackground(new java.awt.Color(255, 255, 255));
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Accion", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N

        btnModificarAux.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        btnEliminarAux.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addComponent(btnEliminarAux, javax.swing.GroupLayout.DEFAULT_SIZE, 97, Short.MAX_VALUE)
            .addComponent(btnModificarAux, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        jPanel6Layout.setVerticalGroup(
            jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnModificarAux, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(btnEliminarAux, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jPanel5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 138, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnModificarAuxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarAuxActionPerformed
        this.ModificarAuxiliar();
        this.txtCodAux.requestFocus();
    }//GEN-LAST:event_btnModificarAuxActionPerformed

    private void cmbListaAuxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbListaAuxActionPerformed
        this.BuscarAuxiliar();
    ...
    private void btnIngresarAuxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarAuxActionPerformed
    ...
    private void btnEliminarAuxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarAuxActionPerformed
        this.EliminarAuxiliar();
        this.txtCodAux.requestFocus();
        this.LlenarComboAuxilar();
    }//GEN-LAST:event_btnEliminarAuxActionPerformed

    private void txtNomAuxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNomAuxActionPerformed
        String msj = this.valdaAux();
        if (msj.equals("")) {
            this.InsertAux();
            this.inicializarAuxiliar();
    ...
    private void txtCodAuxKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodAuxKeyTyped
        String txtString = String.valueOf(evt.getKeyChar());
        if (!(txtString.matches("[0-9]"))) {
            evt.consume();
            getToolkit().beep();
    ...
    private void txtNomAuxKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNomAuxKeyTyped
        String txtString = String.valueOf(evt.getKeyChar());
        if (!(txtString.matches("[ ,A-Z]"))) {
            evt.consume();
            getToolkit().beep();
    ...
    private void btnNuevoAuxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoAuxActionPerformed
        this.NuevoAuxiliar();
        this.txtCodAux.requestFocus();
