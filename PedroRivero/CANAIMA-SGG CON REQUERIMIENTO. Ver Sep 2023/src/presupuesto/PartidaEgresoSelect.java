...
public final class PartidaEgresoSelect extends XJFrameSelect {
    ...
    public void UpdateJTable() {
        ...
        try {
            final ResultSet rs = ConnPpto.executeQuery("SELECT * FROM " + TBL_PPTO_EGRESO + " WHERE ejefis= " + capipsistema.Globales.getEjeFisYear());
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jftCodigo = new javax.swing.JFormattedTextField(presupuesto.PptoGlobales.getCodEgresoMaskFormatter());
        ...
        jtable.setFont(new java.awt.Font("Arial", 3, 15)); // NOI18N
        ...
        jtPartida.setFont(new java.awt.Font("Arial", 3, 16)); // NOI18N
        ...
        jtTotalPpto.setFont(new java.awt.Font("Arial", 3, 20)); // NOI18N
        ...
        jftCodigo.setFont(new java.awt.Font("Arial", 3, 16)); // NOI18N
        ...
        jftMonto.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
