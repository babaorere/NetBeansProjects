...
public final class FondoAvanceSinImp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtIvaRetenido.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        txtISLR.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        jPanel5.add(txtISLR);
        ...
        txtMontoRet.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        tbtnCero.setFont(new java.awt.Font("Arial", 2, 14)); // NOI18N
        ...
        tbtn75.setFont(new java.awt.Font("Arial", 2, 14)); // NOI18N
        tbtn75.setText("75%");
        ...
        tbtn100.setFont(new java.awt.Font("Arial", 2, 14)); // NOI18N
        tbtn100.setText("100%");
        ...
        txtMontoTotal.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        txtIVA_Aplicado.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.ipadx = 176;
        ...
        txtRetenciones.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.ipadx = 176;
        ...
        txtPagoNum.setFont(new java.awt.Font("Arial", 3, 32)); // NOI18N
        ...
        btnEditarCheque.setFont(new java.awt.Font("Arial", 2, 16)); // NOI18N
        ...
        btnGuardar1.setFont(new java.awt.Font("Arial", 2, 16)); // NOI18N
        ...
        tblBenef.setFont(new java.awt.Font("Arial", 3, 15)); // NOI18N
    ...
    private ParamRptPagAva pagoMasterGenerar() throws Exception {
        ...
        final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO avance_efectivo"
        ...
        final PreparedStatement pst2 = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO bancos_operaciones("
...
//                        JasperViewer.viewReport(JasperFillManager.fillReport((JasperReport) JRLoader.loadObject(pathRpt), new HashMap<>(param), cn), false);
                        ...
                        if ( inexport) {
                            JasperExportManager.exportReportToPdfFile(jasperPrint, CapipPropiedades.CAPIP_DIR_LOCAL_ORDENPAGO + "/" + inparam.getId_orden_pago() + "_avance.pdf");
                        }
    ...
    public static void rptChAva(long inid_orden_pago, ParamRptPagAva inparamAva) throws Exception {
        ...
        final ChequeModel cheque = new ChequeModel(Format.toStr(reg.getA_pagar_bs()), reg.getBenef_razonsocial(), reg.getBenef_rif_ci(), inparamAva.getEnLetras_1(), inparamAva.getEnLetras_2(), CapipPropiedades.CAPIP_CLIENTE_DOMICILIO_FISCAL, new java.util.Date(reg.getFecha_pago().getTime()), reg.getEndosable_sn().equals("S") ? "" : "NO ENDOSABLE");
        list.add(cheque);
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        JasperExportManager.exportReportToPdfFile(jasperPrint, CapipPropiedades.CAPIP_DIR_LOCAL_ORDENPAGO + "/" + inid_orden_pago + "-CH-AvaEfe.pdf");
                    } catch (final Exception inex) {
                        JOptionPane.showMessageDialog(null, inex);
                    }
                }
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        JasperExportManager.exportReportToPdfFile(jasperPrint, CapipPropiedades.CAPIP_DIR_LOCAL_ORDENPAGO + "/" + inid_orden_pago + "_asiento_ch.pdf");
                    } catch (final Exception inex) {
                        JOptionPane.showMessageDialog(null, inex);
                    }
                }
