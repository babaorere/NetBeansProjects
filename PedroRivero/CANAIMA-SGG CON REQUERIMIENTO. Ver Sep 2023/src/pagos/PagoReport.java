...
public final class PagoReport extends XJFrameJTable {
    ...
    private void initComponents() {
        ...
        txtAPagar = textfield_decimal.DecimalTextField.getTextField();
        ...
        txtFiltro.setFont(new java.awt.Font("Arial", 3, 16)); // NOI18N
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cuenta", "Edo.", "ID B.D.", "Núm. x Pago", "Núm. x Cuenta", "Fecha", "Beneficiario", "RIF/CI", "Monto Bs.", "Pagado Bs.", "Resta Bs.", "Reg"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Object.class, java.lang.Long.class, java.lang.Long.class, java.lang.Long.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class
            };
        ...
        txtAPagar.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
    ...
    private void btnReportSummaryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReportSummaryActionPerformed
        ...
        for (int i = 0; i < tblMaster.getRowCount(); i++) {
            ...
            try {
                final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO ordenpago_rpt_summary"
                        + "(num, anu, fecha, razonsocial, rif, total, "
