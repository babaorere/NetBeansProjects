...
//                    
    ...
    public static void setAPagarCau(final long inid_causado, final BigDecimal inapagar_bs) throws Exception {
        final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE causado "
    ...
    public static void setAnularPagCau(final long inid_causado, final BigDecimal inanular_bs) throws Exception {
        ...
        final ResultSet rsCauPag = ConnCapip.getInstance().executeQuery("SELECT COUNT(id_causado) FROM causado_orden_pago "
                + "WHERE id_causado= " + inid_causado + " AND anulado_sn= 'N'");
        if (rsCauPag.next()) {
...
//        btnGuardar.setEnabled(false);
    ...
    public static void rptOrdPag(final long inid, final String intitulo, final boolean inexport) throws Exception {
        ...
        final ResultSet rs = ConnCapip.getInstance().executeQuery("SELECT codpresu, partida, sum(subtotal) FROM causado_det "
                + "WHERE id_causado = "
                + "ANY (SELECT id_causado FROM causado_orden_pago WHERE id_orden_pago= " + inid + ") "
                + "GROUP BY codpresu");
                ...
                new Thread() {
                    ...
                    public void run() {
                        try {
                            ...
                            if ( inexport) {
                                JasperExportManager.exportReportToPdfFile(jasperPrint, CapipPropiedades.CAPIP_DIR_LOCAL_ORDENPAGO + "/" + inid + "_orden_pago.pdf");
                            }
                        } catch (final Exception inex) {
                            JOptionPane.showMessageDialog(null, inex);
                        }
    ...
    public static void rptOrdPagAvaImputacion(final long inid, final String intitulo, final boolean inexport) throws Exception {
        ...
        final ResultSet rs = ConnCapip.getInstance().executeQuery("SELECT codpresu, partida, sum(subtotal) FROM causado_det "
                + "WHERE id_causado = "
                + "ANY (SELECT causado_avance_efectivo_nn.id_causado FROM causado_avance_efectivo_nn WHERE id_avance_efectivo= " + inid + ") "
                + "GROUP BY codpresu");
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        if ( inexport) {
                            JasperExportManager.exportReportToPdfFile(jasperPrint, CapipPropiedades.CAPIP_DIR_LOCAL_ORDENPAGO + "/" + inid + ".pdf");
                        }
                    } catch (final Exception inex) {
                        JOptionPane.showMessageDialog(null, inex);
                    }
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        if ( inexport) {
                            JasperExportManager.exportReportToPdfFile(jasperPrint, CapipPropiedades.CAPIP_DIR_LOCAL_ORDENPAGO + "/" + inid + "-CH.pdf");
                        }
                    } catch (final Exception inex) {
                        JOptionPane.showMessageDialog(null, inex);
                    }
                ...
                new Thread() {
                    ...
                    public void run() {
                        try {
                            ...
                            JasperExportManager.exportReportToPdfFile(jasperPrint, CapipPropiedades.CAPIP_DIR_LOCAL_ORDENPAGO + "/" + inid + "_asiento_ch.pdf");
                        } catch (final Exception inex) {
                            JOptionPane.showMessageDialog(null, inex);
                        }
                    }
    ...
    private void initComponents() {
        ...
        txaComprFact.setFont(new java.awt.Font("Arial", 1, 13)); // NOI18N
        ...
        btnOrdenDirecta.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        btnAvanceEfectivo.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        txaConceptoCau.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        btnAdd.setFont(new java.awt.Font("Arial", 2, 14)); // NOI18N
        ...
        btnClear.setFont(new java.awt.Font("Arial", 2, 14)); // NOI18N
        ...
        txaConceptoOrden.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        btnEditarUltCheque.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        txtConsultar.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        btnEditarUltCheque1.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        btnReImprimirCh.setFont(new java.awt.Font("Arial", 2, 14)); // NOI18N
    ...
    public static void genPagoMaster(Map<String, Object> inparam, final boolean inisByCheck) throws Exception {
        ...
        final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO orden_pago "
        ...
        pst.setString(9, (String) inparam.get("benef_rif_ci")); // rifcli
        pst.setDate(10, (Date) inparam.get("fecha_hoy")); // fecha
        pst.setString(11, (String) inparam.get("observacion")); // observacion
        pst.setString(12, (String) inparam.get("banco")); // banco
        pst.setString(13, cuenta); // cuenta
        pst.setString(14, (String) inparam.get("cheque")); // cheque
        pst.setDate(15, (Date) inparam.get("fecha_cheque")); // fecha_cheque
        pst.setString(16, (String) inparam.get("endosable_sn")); // cheque
        ...
        if (!cuenta.isEmpty()) {
            ...
            pst2.setString(3, "OP" + "-" + id + " - " + inparam.get("benef_razonsocial"));
            pst2.setString(4, Format.toStr((java.sql.Date) inparam.get("fecha_cheque")));
            pst2.setString(5, inisByCheck ? "CH" : "ND"); // tipo_operacion
            pst2.setString(6, (String) inparam.get("cheque"));
            pst2.setString(7, inisByCheck ? "EN TRANSITO" : ""); // conciliado
            ...
            pst2.setLong(11, ModelMapNextOp.getNext(Globales.getEjeFisYear(), cuenta + "-" + ( inisByCheck ? "CH" : "ND"))); // cuenta_numop_tipo
    ...
    public static Map<String, Object> genParamRptPag(final long inid_orden_pago, final String intitulo) throws Exception {
        ...
        if (rsPag.next()) {
            ...
            final ResultSet rsCauPag = ConnCapip.getInstance().executeQuery("SELECT * FROM causado_orden_pago "
                    + "WHERE id_orden_pago= " + inid_orden_pago + " AND anulado_sn= 'N'");
            while (rsCauPag.next()) {
        ...
        param.put("titulo", intitulo); // "ORDEN DE PAGO"); 
