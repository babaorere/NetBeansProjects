...
//            JOptionPane.showMessageDialog(null, "Error al formatear los totales" + System.getProperty("line.separator") + inex);
    ...
    private void initComponents() {
        ...
        jLabel25.setBounds(10, 155, 110, 15);
    ...
    private void actGuardar() {
        ...
        try {
            final PreparedStatement pstCheck = ConnCapip.getInstance().getConnection().prepareStatement("SELECT * FROM bancos_operaciones "
    ...
    private void genPagoDetail(Map<String, Object> inparam) throws Exception {
        ...
        if (regCau.getResta_bs().compareTo(BigDecimal.ZERO) > 0.00d) {
            ...
            final PreparedStatement pstCauPagHist = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO causado_orden_pago"
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        final boolean salir;
        if (tblItem.getRowCount() > 0) {
            salir = JOptionPane.showConfirmDialog(this, "¿Hay registros pendientes . ¿ Seguro desea Salir ?",
    ...
    private void cmbIslrPorcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbIslrPorcActionPerformed
