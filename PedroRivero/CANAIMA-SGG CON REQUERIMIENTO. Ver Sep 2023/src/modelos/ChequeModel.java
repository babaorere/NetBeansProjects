...
public final class ChequeModel {
    ...
    public ChequeModel(final String inmontoPagar, final String inbenef_razonsocial, final String inbenef_rif_ci,
        final String inNumLiteral_1, final String inNumLiteral_2, final String inciudad, final java.util.Date infecha, final String inendosable) {
