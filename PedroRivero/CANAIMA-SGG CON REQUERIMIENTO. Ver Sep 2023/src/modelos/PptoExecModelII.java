...
public final class PptoExecModelII {
    ...
    public PptoExecModelII(final PptoModel inppto, final BigDecimal ininicial, final BigDecimal inmodif_ppto,
            final BigDecimal inmodif_ppto_parcial, final BigDecimal inppto_modif, final BigDecimal incompr,
            final BigDecimal incau, final BigDecimal inpag, final BigDecimal indeuda,
            final BigDecimal insaldo_final) {
