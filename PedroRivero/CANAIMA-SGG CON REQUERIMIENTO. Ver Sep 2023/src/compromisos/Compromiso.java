...
//        lblOC.setIcon(checkIcon);
    ...
    public static void genMaster(final Map<String, Object> inparam, final JTable intblItem, BigDecimal inIVA_DEC_VALUE) throws Exception {
        ...
        try (final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO " + ((TipoCompr) inparam.get("tipo_compr")).getTbl()
            ...
            pst.setBigDecimal(17, inIVA_DEC_VALUE.movePointRight(2)); // iva_porc_aplic

            pst.setBigDecimal(18, BigDecimal.ZERO); // iva_porc_ret
            pst.setBigDecimal(19, (BigDecimal) inparam.get("islr_grav_bs")); // islr_grav_bs
    ...
    public static void genDetail(final Map<String, Object> inparam, JTable intblItem) throws Exception {
        ...
        for (int i = 0; i < intblItem.getRowCount(); i++) {
            ...
            final String descPro = (String) intblItem.getValueAt(i, COL_ITEM_DESC);
            ...
            try (final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO compr_det"
    ...
    public static void anuDetail(final long inid_compr, final TipoCompr intipo_compr) throws Exception {
        ...
        final ResultSet rsComprDet = ConnCapip.getInstance().executeQuery("SELECT * FROM compr_det "
                + "WHERE id_compr= " + inid_compr + " AND tipo_compr= '" + intipo_compr.name() + "'");
