...
public final class CompromisoEditar extends javax.swing.JFrame {
    ...
    public static void setTxtCantBehavior(final JFormattedTextField intxtCant, final JFormattedTextField intxtPUnitario, final JTextField intxtSubTotal) {
        ...
        intxtCant.getDocument().addDocumentListener(
    ...
    public static void setTxtPUnitarioBehavior(final JFormattedTextField intxtCant, final JFormattedTextField intxtPUnitario, final JTextField intxtSubTotal) {
        // Para que cada vez que se modifique el campo se actualice el subtotal
        intxtPUnitario.getDocument().addDocumentListener(
            new DocumentListener() {
                @Override
                public void changedUpdate(DocumentEvent e) {
                    newSubTotal( intxtCant, intxtPUnitario, intxtSubTotal);
    ...
    private void initComponents() {
        ...
        btnEliminarUlt.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        cmbIva.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        txtTotalBs.setFont(new java.awt.Font("Arial", 3, 32)); // NOI18N
        ...
        btnBenefNuevo.setFont(new java.awt.Font("Arial", 3, 16)); // NOI18N
    ...
    private void genMaster(final Map<String, Object> inparam) throws Exception {
        ...
        final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE " + tipo_compr.getTbl() + " "
        ...
        pst.setBigDecimal(16, (BigDecimal) inparam.get("iva_porc")); // iva_porc_aplic

        pst.setBigDecimal(17, BigDecimal.ZERO); // iva_porc_ret
        pst.setBigDecimal(18, (BigDecimal) inparam.get("islr_grav_bs")); // islr_grav_bs
    ...
    private void genDetail() throws Exception {
        ...
        for (ComprDetModel regDet : listComprDet) {
            final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("DELETE FROM compr_det "
                + "WHERE id_compr_det = ?");
        ...
        for (int i = 0; i < tblItem.getRowCount(); i++) {
            ...
            final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO compr_det"
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        if ( inexport) {
                            JasperExportManager.exportReportToPdfFile(jasperPrint, CapipPropiedades.CAPIP_DIR_LOCAL_COMPROMISO + "/" + inid + ".pdf");
                        }
...
//        }
    ...
    private void txtFechaComprActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtFechaComprActionPerformed
        // TODO add your handling code here:
            ...
            if (rsCompr.next()) {
                ...
                if (JOptionPane.showConfirmDialog(this, "Esta operación es irreversible. Desea eliminar el registro ?",
                    ...
                    try {
                        ...
                        final ResultSet rsComprDet = ConnCapip.getInstance().executeQuery("SELECT * FROM compr_det WHERE id_compr= " + regCompr.getId_compromiso()
