...
public final class RegistroBenef extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtRazonS.setFont(new java.awt.Font("Arial", 2, 16)); // NOI18N
        ...
        txtRifCI.setFont(new java.awt.Font("Arial", 2, 16)); // NOI18N
        ...
        txtDomicilio.setFont(new java.awt.Font("Arial", 2, 16)); // NOI18N
        ...
        txtTelfs.setFont(new java.awt.Font("Arial", 2, 16)); // NOI18N
        ...
        btnNuevoBenef.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        btnModificar.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        btnGuardarBeneficiario.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
        ...
        btnCancelarBeneficiario.setFont(new java.awt.Font("Arial", 2, 18)); // NOI18N
    ...
    private void btnGuardarBeneficiarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarBeneficiarioActionPerformed
        ...
        if (edoReg == EstadoReg.NUEVO) {
            ...
            try {
                final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO beneficiario"
            ...
            try {
                ...
                PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE beneficiario "
                ...
                // ava_efe_rpt_summary
                // razonsocial, rif
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE ava_efe_rpt_summary "
                ...
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE avance_efectivo "
                ...
                // cau_rpt_summary
                // razonsocial, rif
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE cau_rpt_summary "
                    + "SET razonsocial= ?, rif= ? " // 1, 2
                    + "WHERE rif= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // causado
                // benef_razonsocial, benef_rif_ci
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE causado "
                    + "SET benef_razonsocial= ?, benef_rif_ci= ? " // 1, 2
                    + "WHERE benef_rif_ci= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // compr_compra
                // benef_razonsocial, benef_rif_ci
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE compr_compra "
                    + "SET benef_razonsocial= ?, benef_rif_ci= ? " // 1, 2
                    + "WHERE benef_rif_ci= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // compr_otros
                // benef_razonsocial, benef_rif_ci
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE compr_otros "
                    + "SET benef_razonsocial= ?, benef_rif_ci= ? " // 1, 2
                    + "WHERE benef_rif_ci= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // compr_rpt_summary
                // razonsocial, rif
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE compr_rpt_summary "
                    + "SET razonsocial= ?, rif= ? " // 1, 2
                    + "WHERE rif= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // compr_servicio
                // benef_razonsocial, benef_rif_ci
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE compr_servicio "
                    + "SET benef_razonsocial= ?, benef_rif_ci= ? " // 1, 2
                    + "WHERE benef_rif_ci= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // islr_retencion
                // benef_razonsocial, benef_rif_ci
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE islr_retencion "
                    + "SET benef_razonsocial= ?, benef_rif_ci= ? " // 1, 2
                    + "WHERE benef_rif_ci= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // islr_retencion_det
                // benef_razonsocial, benef_rif_ci
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE islr_retencion_det "
                    + "SET benef_razonsocial= ?, benef_rif_ci= ? " // 1, 2
                    + "WHERE benef_rif_ci= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // iva_retencion
                // benef_razonsocial, benef_rif_ci
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE iva_retencion "
                    + "SET benef_razonsocial= ?, benef_rif_ci= ? " // 1, 2
                    + "WHERE benef_rif_ci= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // iva_retencion_det
                // benef_razonsocial, benef_rif_ci
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE iva_retencion_det "
                    + "SET benef_razonsocial= ?, benef_rif_ci= ? " // 1, 2
                    + "WHERE benef_rif_ci= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // orden_pago
                // benef_razonsocial, benef_rif_ci
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE orden_pago "
                    + "SET benef_razonsocial= ?, benef_rif_ci= ? " // 1, 2
                    + "WHERE benef_rif_ci= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
                ...
                // razonsocial, rif
                pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE ordenpago_rpt_summary "
                    + "SET razonsocial= ?, rif= ? " // 1, 2
                    + "WHERE rif= ?"); // 3
                pst.setString(1, razonSocial);
                pst.setString(2, rif_ci);
