...
public class DlgUnidadTributariaAplic extends javax.swing.JDialog {
    ...
    private boolean actSaveNew(final Map<String, Object> inparam) {
        ...
        try {
            final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO unidad_tributaria_aplic"
    ...
    private boolean actSaveOld(final Map<String, Object> inparam) {
        ...
        try {
            final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("UPDATE unidad_tributaria_aplic "
