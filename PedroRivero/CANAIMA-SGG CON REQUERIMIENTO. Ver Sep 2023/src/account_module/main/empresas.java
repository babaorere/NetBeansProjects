...
//        String inicio = dia + "/" + mes + "/" + year.getYear();
        ...
        String sql;
        sql = "INSERT INTO `mh_empresas` (`emp_id`, `emp_nombre`, `emp_rif`, "
                + "`emp_inicioFiscal`, `emp_finFiscal`, `emp_fecha`)VALUES (";
        sql = sql + "'" + txtCodigo.getText() + "','" + txtNombre.getText() + "','" + txtRif.getText() + "',";
        sql = sql + "'" + inicio + "','" + fin + "',"
                + "STR_TO_DATE('" + rrr.getText() + "','%d/%m/%Y'));";
    ...
    public void buscar() {
        ...
        String sql = "SELECT emp_id,emp_nombre,emp_rif,"
                + "MONTH(emp_inicioFiscal),YEAR(emp_inicioFiscal),MONTH(emp_finFiscal),"
                + "YEAR(emp_finFiscal)"
                + " FROM mh_empresas WHERE emp_id='" + cod + "'";
    ...
    public void Modificar() {
        ...
        if (JOptionPane.showOptionDialog(this, "Desea Modificar estos Datos?", "Confirmar",
            ...
            sql += "emp_inicioFiscal='" + inicio + "'";//La ultima linea no lleva la coma +" '";
    ...
    public void Eliminar() {
        if (JOptionPane.showOptionDialog(this, "Desea Eliminar estos Datos?", "Confirmar",
    ...
    private void initComponents() {
        ...
        cBoxInicio.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        cBoxCierre.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        txtYearEnd.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(cBoxCierre, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                .addComponent(jLabel4)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 6, Short.MAX_VALUE)
                                .addComponent(cBoxInicio, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(txtYearEnd, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cBoxCierre, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
