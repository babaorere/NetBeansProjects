...
public final class BancosChequePagoCambiar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNumAnt.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
    ...
    private void actGuardar() {
        ...
        try {
            ...
            if (rsPag.next()) {
                ...
                final PreparedStatement pst = ConnCapip.getInstance().getConnection().prepareStatement("INSERT INTO bancos_ch_anu"
                        + "(banco, cuenta, cheque_anu, cheque_nvo, monto, pag_ava, num_pag_ava, "
                        + "motivo_anu, fecha_anu, ejefis, ejefismes, iduser) "
                        + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                pst.setString(1, regPag.getBanco());
                pst.setString(2, regPag.getCuenta());
                pst.setString(3, sNumAnt);
                pst.setString(4, sNumNuevo);
                pst.setString(5, Format.toStr(regPag.getA_pagar_bs()));
                pst.setString(6, "P"); // pag_ava
                pst.setLong(7, regPag.getId()); // num_pag_ava
