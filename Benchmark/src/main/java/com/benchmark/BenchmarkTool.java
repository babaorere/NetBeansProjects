...
public interface BenchmarkTool {
    ...
    /**
     * Generates an array of integers where half the data is 0s, half the remainder is 1s, <br>
     * half the reminder is 2s, half the reminder is 3s, and so forth. <br>
     *
     * @param size number of elements in the array.
     * @return generated test set.
     */
    ...
    /**
     * Generates an array of integers where half the data is 0s, and half random int values. <br>
    ...
    /**
     * Computes an empirical b value for insertion sort by running it on a pair of inputs and using the doubling formula.
     *
    ...
    /**
     * Computes an empirical b value for shellsort sort by running it on a pair of inputs and using the doubling formula.
     *
     * @param small small test data array
     * @param large large test data array. twice the same of small array.
     *
    ...
    /**
     * Runs the two sorting algorithms on the three types of test data to produce six different b values. B values are displayed to the user.
     *
