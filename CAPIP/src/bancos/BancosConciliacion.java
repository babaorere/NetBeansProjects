...
public final class BancosConciliacion extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public BancosConciliacion(final java.awt.Window _parent) {
    ...
    String sqlAuxBancosDet(final String _cuenta) {
        ...
        if (btnAno.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnEne.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 01 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnFeb.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 02 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnMar.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 03 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnAbr.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 04 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnMay.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 05 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnJun.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 06 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnJul.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 07 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnAgo.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 08 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnSep.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 09 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnOct.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 10 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnNov.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 11 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else if (btnDic.isSelected()) {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(MONTH FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) = 12 AND EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        } else {
            sql = "SELECT * FROM bancos_operaciones WHERE EXTRACT(YEAR FROM (STR_TO_DATE(fecha,'%d/%m/%Y'))) ='" + ejeFis + "' and cuenta='" + _cuenta + "' AND (tipo_operacion='CH' OR tipo_operacion='FA') ORDER BY id DESC";
        }
    ...
    void mostrarTblAuxBco(String _cuenta) {
    ...
    void cambiarEstado(Integer id, String sta) {
        try {
            final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE bancos_operaciones SET conciliado='" + sta + "' WHERE id = '" + id + "' AND anulado_sn= 'N'");
    ...
    public void ver_orden(final String _banco, final String _cuenta, final Long _mesIni, final Long _mesFin,
        final long _ejeFis, final String _total, final String _NumLiteral) {
        try {
            final Map<String, Object> param = new HashMap<>(101);
            param.clear();
            param.put("banco", _banco);
            param.put("cuenta", _cuenta);
            param.put("mesini", _mesIni);
            param.put("mesfin", _mesFin);
            param.put("ejefis", _ejeFis);
    ...
    private void initComponents() {
        ...
        cbxCuentas.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        ...
        btnConciliar.setBackground(new java.awt.Color(153, 153, 0));
        btnConciliar.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        btnConciliar.setText("CONCILIAR");
        btnConciliar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        btnReporte.setBackground(new java.awt.Color(153, 153, 0));
        btnReporte.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        btnReporte.setText("REPORTE");
        btnReporte.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
