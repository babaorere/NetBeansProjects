...
import modelos.ImpMunRendRptModel;
...
public final class ImpMun_Rend extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public ImpMun_Rend(final java.awt.Window _parent) {
        super();
        initComponents();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1060, 625));
        setResizable(false);
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "ANU", "IMP. MUN. NUM.", "CAUSADO", "FECHA FACT.", "FACTURA", "CONTRIBUYENTE", "MONTO Bs.", "BASE IMPONIBLE", "RETENIDO BS.", "Reg"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Long.class, java.lang.Object.class, java.lang.Long.class, java.lang.Long.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class
            };
        ...
        txtRet.setBackground(new java.awt.Color(204, 102, 0));
        txtRet.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtRet.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtRet.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
...
//        dispose();
    ...
    private void ReporteRendicion() {
        ...
        for (int i = 0; i < tblMaster.getRowCount(); i++) {
            ...
            list.add(new ImpMunRendRptModel(new java.util.Date(reg.getEjefis().getTime()), reg.getAnulado_sn().equals("S") ? "S" : "",
                reg.getId_imp_mun(), reg.getNum_fact(), reg.getBenef_rif_ci(), reg.getBenef_razonsocial(),
