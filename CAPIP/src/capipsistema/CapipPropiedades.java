...
public final class CapipPropiedades {
    ...
    public static final String CAPIP_PATH = "C:/CAPIP_SISTEMAS";
    public static final String CAPIP_PROPERTIES = CAPIP_PATH + "/CAPIPSISTEMAS.PROPERTIES";

    public static final boolean SO_WIN;
    public static final String CAPIP_SISTEMAS = "CAPIP SISTEMAS";
    ...
    static {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al tratar de ubicar el archivo de Propiedades"
                + System.getProperty("line.separator") + Globales.CAPIP_CONTACTE_MSJ
                + System.getProperty("line.separator") + _ex);
            exit(1);
        }
...
//            }
        ...
        String func_1 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'FUNC_1'")) {
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar " + System.getProperty("line.separator") + _ex);
        }

        String func_2 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'FUNC_2'")) {
            if (rs.next()) {
        ...
        String func_3 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'FUNC_3'")) {
            if (rs.next()) {
        ...
        String func_4 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'FUNC_4'")) {
            if (rs.next()) {
        ...
        String func_5 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'FUNC_5'")) {
            if (rs.next()) {
        ...
        String func_6 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'FUNC_6'")) {
            if (rs.next()) {
        ...
        String func_7 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'FUNC_7'")) {
            if (rs.next()) {
        ...
        String func_8 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'FUNC_8'")) {
            if (rs.next()) {
        ...
        String desc_1 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'DESC_1'")) {
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al caargar la DESC_1" + System.getProperty("line.separator") + _ex);
        }

        String desc_2 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'DESC_2'")) {
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al caargar la DESC_2" + System.getProperty("line.separator") + _ex);
        }

        String desc_3 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'DESC_3'")) {
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al caargar la DESC_3" + System.getProperty("line.separator") + _ex);
        }

        String desc_4 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'DESC_4'")) {
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar la DESC_4" + System.getProperty("line.separator") + _ex);
        }

        String desc_5 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'DESC_5'")) {
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar la DESC_5" + System.getProperty("line.separator") + _ex);
        }

        String desc_6 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'DESC_6'")) {
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar la DESC_6" + System.getProperty("line.separator") + _ex);
        }

        String desc_7 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'DESC_7'")) {
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar la DESC_7" + System.getProperty("line.separator") + _ex);
        }

        String desc_8 = "";
        try (ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'DESC_8'")) {
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar la DESC_8" + System.getProperty("line.separator") + _ex);
        }
     ...
     * @return
     */
    private static String decrypt(final String _strToDecrypt) {
        try {
            Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5PADDING");
            cipher.init(Cipher.DECRYPT_MODE, new SecretKeySpec(Arrays.copyOf("1234".getBytes(), 16), "AES"));
    ...
    public static java.sql.Timestamp getServerTimeStamp() {
        try {
            ...
            final ResultSet rs = Conn.getConnection().prepareStatement("SELECT NOW()").executeQuery();
            if (rs.next()) {
                return rs.getTimestamp(1);
            }
        } catch (final Exception _ex) {
            JOptionPane.showMessageDialog(null, "Error al recuperar la fecha del Servidor: " + System.getProperty("line.separator") + _ex);
            exit(1);
        }
