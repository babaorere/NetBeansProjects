...
//    public static final OrdPagIdTipo ORD_PAG_ID_TIPO = OrdPagIdTipo.RELATIVO;
    ...
    public static final String CAPIP_CONTACTE_MSJ = "Contacte a su proveedor de CAPIP SISTEMAS: capipsistemas@gmail.com, baba.orere@gmail.com";
    ...
    // Rio Chico    
    // public static final String PART_IVA_COD = "11.01.00.51.403.18.01.00";
    //
    // Diego Ibarra
    ...
    public static DefaultTableCellRenderer getIntCellRenderer() {
        DefaultTableCellRenderer rendererInt = new DefaultTableCellRenderer() {
            ...
            public void setValue(Object value) {
                try {
                    setText(Globales.intFormat.format((value == null) ? new Integer(0) : value));
                } catch (final Exception _ex) {
                    setText("error");
                }
            }
     ...
     * @return
     */
    public static BigDecimal getIvaPorcValue(long _id_iva_aplicado) {
        try {
            final ResultSet rs = Conn.executeQuery("SELECT * FROM iva_aplicado WHERE id_iva_aplicado= " + _id_iva_aplicado);
            if (rs.next()) {
     ...
     * @return
     */
    public static BigDecimal getIvaDecValue(long _id_iva_aplicado) {
        return getIvaPorcValue(_id_iva_aplicado).movePointLeft(2);
    }
    ...
    public static java.sql.Date getEjefis() {
        final long ejefis;
        try {
            final ResultSet rs = Conn.executeQuery("SELECT * FROM global WHERE nombre= 'ejercicio_fiscal'");
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(null, "Error al recuperar el Ejercicio Fiscal: " + System.getProperty("line.separator") + _ex);
            exit(1);
            return null;
        }
