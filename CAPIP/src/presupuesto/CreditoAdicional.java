...
//                txtMontoPartida.requestFocusInWindow();
    ...
    private void initComponents() {
        ...
        txtSoporte.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        txtMontoCred.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtMontoCred.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        txtMontoCred.setDoubleBuffered(true);
        txtMontoCred.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        txtFechaCred.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        txtFechaCred.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        txtTotalAcumPartidas.setBackground(new java.awt.Color(204, 102, 0));
        ...
        txtTotalAcumPartidas.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        txtTotalAcumPartidas.setDoubleBuffered(true);
        txtTotalAcumPartidas.setEnabled(false);
        txtTotalAcumPartidas.setFocusable(false);
        txtTotalAcumPartidas.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        txtMontoPartida.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        txtMontoPartida.setEnabled(false);
        txtMontoPartida.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        jbConsultarC.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
