...
public final class PagoDirectoSinImpSinReg extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public PagoDirectoSinImpSinReg(final java.awt.Window _parent) {
        super();
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnIVA, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 630, 60, 40));
        ...
        getContentPane().add(chkISLR, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 630, 120, 40));
        ...
        getContentPane().add(cmbIva, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 670, 160, 30));
    ...
    private void pagoGuardar(final Map<String, Object> _param) throws Exception {
        ...
        PagoOrden.genPagoMaster(_param, false);
