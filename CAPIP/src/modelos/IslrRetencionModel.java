...
public final class IslrRetencionModel {
     ...
     * @throws Exception
     */
    public IslrRetencionModel(final ResultSet _rs) throws Exception {
    ...
    public static IslrRetencionModel getxID(final long id) throws Exception {
        ...
        final ResultSet rs = Conn.executeQuery("SELECT * FROM islr_retencion WHERE id_islr_retencion= " + id);
