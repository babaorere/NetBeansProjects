...
public final class Causado extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public Causado(final java.awt.Window _parent) {
    ...
    private void UpdateTblCompr() {
        ...
        try {
            final ResultSet rs = Conn.executeQuery("SELECT * FROM " + tbl + " WHERE id_causado= 0 and YEAR(ejefis)= " + Globales.getEjeFisYear() + " AND anulado_sn= 'N' ORDER BY id_compr ASC");
            while (rs.next()) {
     ...
     * @param _id_compr
     */
    void mostrarDetalle(final long _id_compr) {
        ...
        String sql = "SELECT * FROM compr_det WHERE id_compr='" + _id_compr + "' AND tipo_compr= ";
        if (btnCompra.isSelected()) {
            sql = sql + "'OC'";
        } else if (btnServicio.isSelected()) {
            sql = sql + "'OS'";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 10, 880, -1));
        ...
        btnOtrosCompr.setBackground(new java.awt.Color(255, 153, 153));
        ...
        btnReversar.setBackground(new java.awt.Color(153, 153, 0));
        btnReversar.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        btnReversar.setText("ANULAR");
        btnReversar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        tblDetalle.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(255, 0, 0)));
        tblDetalle.setFont(new java.awt.Font("Arial", 2, 14)); // NOI18N
        ...
        txtBenefRazonSocial.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        txtBenefRazonSocial.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        txtBenefRazonSocial.setAutoscrolls(false);
        txtBenefRazonSocial.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtBenefRazonSocial.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        ...
        txtBenefRifCI.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        txtBenefRifCI.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        txtBenefRifCI.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtBenefRifCI.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        ...
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 30, -1, 20));

        txtNroCompr.setEditable(false);
        txtNroCompr.setBackground(new java.awt.Color(204, 153, 0));
        txtNroCompr.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtNroCompr.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtNroCompr.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        txtNroCompr.setEnabled(false);
        txtNroCompr.setFont(new java.awt.Font("Arial", 3, 36)); // NOI18N
        jPanel2.add(txtNroCompr, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 20, 100, 40));

        txtNroCausado.setEditable(false);
        txtNroCausado.setBackground(new java.awt.Color(204, 153, 0));
        txtNroCausado.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtNroCausado.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtNroCausado.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        txtNroCausado.setEnabled(false);
        txtNroCausado.setFont(new java.awt.Font("Arial", 3, 36)); // NOI18N
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 110, 680, 70));
     ...
     * @return
     */
    private boolean valCausadoComp(final Map<String, Object> _param) {
        ...
        _param.put("iva_porc_aplic", Format.toBigDec(diva_porc_aplic));
    ...
    private void actGuardar() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error. Al insertar el registro" + System.getProperty("line.separator") + _ex);
            return;
        }
     ...
     */
    public static void genCausadoMaster(final Map<String, Object> _param, final JTable _tblMaster) throws Exception {

        final long id_causado = (long) _param.get("id_causado");

        final java.sql.Date fecha_causado = (java.sql.Date) _param.get("fecha_causado");

        final TipoCompr tipo_compr = (TipoCompr) _param.get("tipo_compr");

        final PreparedStatement pst = Conn.getConnection().prepareStatement("INSERT INTO causado("
        ...
        final Connection cn = Conn.getConnection();
        if (_tblMaster != null) {
            for (int i = 0; i < _tblMaster.getRowCount(); i++) {
                if ((Boolean) _tblMaster.getValueAt(i, COL_MASTER_SELECT)) { // Solo las seleccionadas
                    if (cn.prepareStatement("UPDATE " + tipo_compr.getTbl() + " SET id_causado= " + id_causado + " WHERE id_compr = " + (Long) _tblMaster.getValueAt(i, COL_MASTER_ID_COMPR)).executeUpdate() != 1) {
                        throw new Exception("Error al actualizar el causado");
                    }
                }
            }
        } else {
            if (cn.prepareStatement("UPDATE " + tipo_compr.getTbl() + " SET id_causado= " + id_causado + " WHERE id_compr= " + (long) _param.get("id_compr")).executeUpdate() != 1) {
                throw new Exception("Error al actualizar el causado");
            }
        }
    }
     ...
     * @throws java.lang.Exception
     */
    public static void genCausadoDetail(final Map<String, Object> _param, final JTable _tblMaster) throws Exception {
        ...
        if (_tblMaster != null) {
            for (int i = 0; i < _tblMaster.getRowCount(); i++) {
                if ((Boolean) _tblMaster.getValueAt(i, COL_MASTER_SELECT)) { // Solo las seleccionadas
                    final ComprModel regCompr = (ComprModel) _tblMaster.getValueAt(i, COL_MASTER_REG_COMPR);
                    ...
                    while (rs.next()) {
                        ...
                        if (rsAux.next()) {
                            final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE causado_det SET subtotal= subtotal + ? WHERE id_causado= ? AND codpresu= ?");
            ...
            final ComprModel regCompr = ComprModel.getxID((long) _param.get("id_compr"), (TipoCompr) _param.get("tipo_compr"));
            final long id_compr = regCompr.getId_compromiso();
        ...
        final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE causado SET resta_bs= ? WHERE id_causado= ?");
        ...
        final PreparedStatement pstIva = Conn.getConnection().prepareStatement("SELECT ROUND(SUM(iva_grav_bs * iva_porc_aplic / 100.00), 2) FROM " + regCau.getTipo_compr().getTbl() + " WHERE id_causado= ?");
        ...
        final PreparedStatement pstIslr = Conn.getConnection().prepareStatement("SELECT SUM(islr_grav_bs) FROM " + regCau.getTipo_compr().getTbl() + " WHERE id_causado= ?");
     ...
     * @throws Exception
     */
    public static CauModel genReport(final long _id, Map<String, Object> _param) throws Exception {

        final CauModel reg = CauModel.getxID(_id);
        if (reg == null) {
            return null;
        }
        ...
        final ResultSet rs = Conn.executeQuery("SELECT * FROM " + reg.getTipo_compr().getTbl() + " WHERE id_causado= " + reg.getId_causado());
        while (rs.next()) {
    ...
    private void actAnular() {
        ...
        try {
            ...
            ResultSet rsOrd = Conn.getConnection().prepareStatement("SELECT * FROM causado WHERE id_causado= " + id_causado).executeQuery();
            ...
            if (rsOrd.next()) {
                ...
                if (is_iva_retenido.equals("S")) {
                    ...
                    ResultSet rsIvaBs = Conn.getConnection().prepareStatement("SELECT SUM(iva_grav_bs) FROM " + regCau.getTipo_compr().getTbl() + " WHERE id_causado= " + id_causado).executeQuery();
                    if (rsIvaBs.next()) {
                ...
                if (is_islr_retenido.equals("S")) {
                    ...
                    // Verificar si la orden tiene gravable > 0
                    ResultSet rsIslrBs = Conn.getConnection().prepareStatement("SELECT SUM(islr_grav_bs) FROM " + regCau.getTipo_compr().getTbl() + " WHERE id_causado= " + id_causado).executeQuery();
                    if (rsIslrBs.next()) {
                ...
                if (is_imp_mun_retenido.equals("S")) {
                    ...
                    // Verificar si la orden tiene gravable > 0
                    ResultSet rsImpMun = Conn.getConnection().prepareStatement("SELECT SUM(imp_mun_grav_bs) FROM " + regCau.getTipo_compr().getTbl() + " WHERE id_causado= " + id_causado).executeQuery();
                    if (rsImpMun.next()) {
                ...
                if (is_neg_pri_retenido.equals("S")) {
                    ...
                    // Verificar si la orden tiene gravable > 0
                    ResultSet rsNegPri = Conn.getConnection().prepareStatement("SELECT SUM(neg_pri_grav_bs) FROM " + regCau.getTipo_compr().getTbl() + " WHERE id_causado= " + id_causado).executeQuery();
                    if (rsNegPri.next()) {
                ...
                if (is_oret_retenido.equals("S")) {
                    ...
                    // Verificar si la orden tiene gravable > 0
                    ResultSet rsORet = Conn.getConnection().prepareStatement("SELECT SUM(oret_grav_bs) FROM " + regCau.getTipo_compr().getTbl() + " WHERE id_causado= " + id_causado).executeQuery();
                    if (rsORet.next()) {
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de recuperar la orden" + System.getProperty("line.separator") + _ex);
            return;
        }
        ...
        if (JOptionPane.showConfirmDialog(this, "¿Seguro desea Anular la Orden #" + id_causado + " ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
            try {
                ...
                if (Conn.getConnection().prepareStatement("UPDATE causado SET anulado_sn= 'S' WHERE id_causado= " + id_causado).executeUpdate() != 1) {
                    throw new Exception("Error al tratar de eliminar el Causado");
                }

//                if (Conn.getConnection().prepareStatement("DELETE FROM causado_det WHERE id_causado=" + id_causado).executeUpdate() <= 0) {
//                    throw new Exception("Error al tratar de eliminar el Causado");
//                }
                if (Conn.getConnection().prepareStatement("UPDATE " + tipo_compr.getTbl() + " SET id_causado= 0 WHERE id_causado = " + id_causado).executeUpdate() <= 0) {
                    throw new Exception("Error al tratar de eliminar el Causado");
                }
