...
public final class Configuracion extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public Configuracion(java.awt.Window _parent) {
        super();
        initComponents();
    ...
    private void initComponents() {
        ...
        btnCambiarIVA.setBackground(new java.awt.Color(153, 153, 0));
        btnCambiarIVA.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        btnCambiarIVA.setText("Cambiar");
        btnCambiarIVA.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        btnCambiarIVA.setBounds(40, 100, 120, 40);
        ...
        jPanel2.add(cmbIva);
        cmbIva.setBounds(10, 50, 230, 30);

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 520, 250, 150));
        ...
        txtEjeFis.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        ...
        txtEjeFis.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        ...
        txtEjeFis.setBounds(80, 40, 120, 40);

        btnGuardarEjercicioF.setBackground(new java.awt.Color(153, 153, 0));
        btnGuardarEjercicioF.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        btnGuardarEjercicioF.setText("Guardar");
        btnGuardarEjercicioF.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        btnGuardarEjercicioF.setBounds(70, 100, 140, 40);

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 520, 270, 150));
        ...
        txtUser.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        ...
        txtPass.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        txtPass.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtPass.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        ...
        btnGuardarUsuario.setBackground(new java.awt.Color(153, 153, 0));
        btnGuardarUsuario.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        btnGuardarUsuario.setText("Guardar");
        btnGuardarUsuario.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        txtNombre.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        ...
        btnCargar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        chkActivo.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        chkActivo.setText("Activo");
        jPanel4.add(chkActivo);
        chkActivo.setBounds(110, 160, 65, 25);
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 70, 310, 400));
        ...
        getContentPane().add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 40, -1, -1));
        ...
        jLabel11.setBounds(4, 10, 260, 17);

        txtUnidadT.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        ...
        txtUnidadT.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        txtUnidadT.setEnabled(false);
        jPanel5.add(txtUnidadT);
        txtUnidadT.setBounds(80, 40, 120, 40);

        btnCambiarUT.setBackground(new java.awt.Color(153, 153, 0));
        btnCambiarUT.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        btnCambiarUT.setText("Cambiar");
        btnCambiarUT.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        btnCambiarUT.setBounds(80, 100, 120, 40);

        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 520, 270, 150));

        btnSalir.setBackground(new java.awt.Color(153, 153, 0));
        btnSalir.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        ...
        getContentPane().add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 680, 240, 50));

        btnRespaldo.setBackground(new java.awt.Color(153, 153, 0));
        btnRespaldo.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        btnRespaldo.setText("RESPALDO. B.D.");
        btnRespaldo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        getContentPane().add(btnRespaldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 680, 220, 50));

        btnFirma.setBackground(new java.awt.Color(153, 153, 0));
        btnFirma.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        btnFirma.setText("FIRMAS");
        btnFirma.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        getContentPane().add(btnFirma, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 680, 140, 50));
        ...
        btnReConversion.setBackground(new java.awt.Color(153, 153, 0));
        btnReConversion.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        btnReConversion.setText("Reconversión");
        btnReConversion.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        getContentPane().add(btnReConversion, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 680, 180, 50));
    ...
    private void btnGuardarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarUsuarioActionPerformed
        ...
        if (regUsuario == null) {
            try {
                ...
                final PreparedStatement pst = Conn.getConnection().prepareStatement("INSERT INTO usuario(user, pass, nombre, ppto, banco, compr, cau, imp, pago, cfg, rpt, active) "
                        + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            ...
            try {
                ...
                final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE usuario set nombre= ?, active= ? WHERE id_user= ?");
    ...
    private void btnGuardarEjercicioFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarEjercicioFActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de actualizar el Ejercicio Fiscal" + System.getProperty("line.separator") + _ex);
     ...
     * @throws Exception
     */
    public static void actGuardarEjeFis(final String _sEjeFis) throws Exception {

        if ((_sEjeFis == null) || _sEjeFis.isEmpty()) {
            throw new Exception("Ejercicio Fiscal inválido");
        }

        final long iEjeFis;
        try {
            iEjeFis = Integer.parseInt(_sEjeFis);
        } catch (final Exception _ex) {
            throw new Exception("Ejercicio Fiscal inválido");
        }
        ...
        try {
            ...
            Conn.getConnection().prepareStatement("UPDATE global SET valor= '" + _sEjeFis + "' WHERE nombre = 'ejercicio_fiscal'").executeUpdate();

            // Para cada uno de los Bancos, se debe actualizar su respectivo saldo anual.
            final ResultSet rs = Conn.executeQuery("SELECT * FROM bancos");
            while (rs.next()) {
                ...
                final ResultSet rsAnt = Conn.executeQuery("SELECT * FROM banco_saldo_anual WHERE id_banco= " + id_banco + " AND YEAR(ejefis) = " + ejeFisAnt);
                if (rsAnt.next()) {
                ...
                final PreparedStatement pstDelete = Conn.getConnection().prepareStatement("DELETE FROM banco_saldo_anual WHERE id_banco= ? AND YEAR(ejefis) = ?");
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Error al tratar de anular la operación" + System.getProperty("line.separator") + _ex2);
                exit(1);
            }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            final ResultSet rs = Conn.executeQuery("SELECT * FROM compr_compra WHERE benef_rif_ci= '" + rif_ci + "'");
            if (rs.next()) {
        ...
        // Verificar que existe un compromiso
        try {
            final ResultSet rs = Conn.executeQuery("SELECT * FROM compr_servicio WHERE benef_rif_ci= '" + rif_ci + "'");
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "No es Posible eliminar, ya existe al menos un compromiso en curso");
                return;
            }
        ...
        // Verificar que existe un compromiso
        try {
            final ResultSet rs = Conn.executeQuery("SELECT * FROM compr_otros WHERE benef_rif_ci= '" + rif_ci + "'");
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "No es Posible eliminar, ya existe al menos un compromiso en curso");
                return;
            }
        ...
        if (JOptionPane.showConfirmDialog(this, "¿ Esta seguro de Eliminar el Beneficiario ?",
            ...
            try {
                if (Conn.getConnection().prepareStatement("DELETE FROM beneficiario WHERE rif_ci='" + rif_ci + "'").executeUpdate() != 1) {
                    throw new Exception("Cantidad inválida");
                }
            } catch (final Exception _ex) {
                JOptionPane.showMessageDialog(null, "Error al tratar de Eliminar: " + System.getProperty("line.separator") + _ex);
            }
        }
    ...
    private void btnRespaldoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespaldoActionPerformed
        ...
        try {
            ...
            final File f = new File(path + "mysqldump.exe");
            ...
            if (f.exists()) {
                ...
                Process child = runtime.exec(path
                        ...
                        + "--host=localhost " // + "--host=capipsistema "
                        + "--port=3306 " // + "--port=3307 "
                        + "--user=root " // + "--user=capipsistema "
                        + "--password=1234 " // + "--password=407111787 "
                        + "--databases capip -R");
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de realizar el respaldo de la B.D." + System.getProperty("line.separator") + _ex);
        } finally {
            lblAdelanto.setText("");
...
//        Compromiso.cargarComboIva(cmbIva);
    ...
    private void MostrarUT() {
        try {
            final ResultSet rs = Conn.executeQuery("SELECT * FROM unidad_tributaria_aplic WHERE fecha_vigencia <= CURDATE() ORDER BY fecha_vigencia DESC");
            if (rs.next()) {
            ...
            JOptionPane.showMessageDialog(this, "Error. No es posible obtener el valor de la U.T." + System.getProperty("line.separator") + _ex);
    ...
    private void actCargar() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de recuperar el Usuario" + System.getProperty("line.separator") + _ex);
            java.awt.EventQueue.invokeLater(txtUser::requestFocusInWindow);
            regUsuario = null;
        }
        ...
        if (UserPassIn.getIdUser() > 0) {
            ...
            if (im != null) {
                ...
                JOptionPane.showMessageDialog(this, "Esta Operación es IRREVERSIBLE, "
                        ...
                        "Reconversión Monetaria 2018 I", JOptionPane.WARNING_MESSAGE, im);

            } else {
                JOptionPane.showMessageDialog(this, "Esta Operación es IRREVERSIBLE, "
                        + System.getProperty("line.separator") + "cualquier arrepentimiento generara un costo equivalente a 100$ Americanos (USD), "
                        + System.getProperty("line.separator") + "totalmente imputable al Cliente.",
                        "Reconversión Monetaria 2018 I", JOptionPane.WARNING_MESSAGE);
            }
            ...
            if (JOptionPane.showConfirmDialog(this, "Esta Absolutamente seguro de continuar (1) ?") == JOptionPane.OK_OPTION) {
                if (JOptionPane.showConfirmDialog(this, "De Verdad esta seguro de continuar (2) ?") == JOptionPane.OK_OPTION) {
                    if (JOptionPane.showConfirmDialog(this, "Si se equivoca tendra que pagar 100 USD" + System.getProperty("line.separator") + "Desea continuar con la reconversion (3) ?") == JOptionPane.OK_OPTION) {
                        ...
                        if (!clave.equals("J-407111787")) {
                            JOptionPane.showMessageDialog(this, "Clave erronea" + System.getProperty("line.separator") + "Operación abortada");
                            return;
                        }

                        final String sFactor = JOptionPane.showInputDialog("Favor indicar el Factor de reconversión").toUpperCase();
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(this, "Factor inválido" + System.getProperty("line.separator") + "Operación abortada" + System.getProperty("line.separator") + _ex);
                            return;
                        }
                        ...
                        try {
                            ...
                            Conn.executeUpdate("UPDATE ava_efe_aux_report SET total = ROUND(total / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE ava_efe_rpt_summary SET total = ROUND(total / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE avance_efectivo SET a_pagar_bs = ROUND(a_pagar_bs / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE banco_saldo_anual SET saldoi = ROUND(saldoi / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE bancos SET saldoi = ROUND(saldoi / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE bancos_ch_anu SET monto = ROUND(monto / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE bancos_ch_anu_aux_rpt SET monto = ROUND(monto / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE bancos_cheque SET monto = ROUND(monto / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE bancos_operaciones SET debe = ROUND(debe / " + sFactor + ", 2), haber = ROUND(haber / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE cau_rpt_summary SET total = ROUND(total / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE causado SET resta_bs = ROUND(resta_bs / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE causado_aux_report SET total = ROUND(total / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE causado_avance_efectivo_nn SET apagar_bs = ROUND(apagar_bs / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE causado_det SET subtotal = ROUND(subtotal / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE compr_compra SET total_bs = ROUND(total_bs / " + sFactor + ", 2),"
                            ...
                            Conn.executeUpdate("UPDATE compr_det SET punitario = ROUND(punitario / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE compr_otros SET total_bs = ROUND(total_bs / " + sFactor + ", 2),"
                                    + "base_imponible_bs = ROUND(base_imponible_bs / " + sFactor + ", 2), "
                                    + "iva_grav_bs = ROUND(iva_grav_bs / " + sFactor + ", 2), "
                                    + "iva_porc_aplic = ROUND(iva_porc_aplic / " + sFactor + ", 2), "
                                    + "iva_porc_ret = ROUND(iva_porc_ret / " + sFactor + ", 2), "
                            ...
                            Conn.executeUpdate("UPDATE compr_rpt_summary SET total = ROUND(total / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE compr_servicio SET total_bs = ROUND(total_bs / " + sFactor + ", 2),"
                                    + "base_imponible_bs = ROUND(base_imponible_bs / " + sFactor + ", 2), "
                                    + "iva_grav_bs = ROUND(iva_grav_bs / " + sFactor + ", 2), "
                                    + "iva_porc_aplic = ROUND(iva_porc_aplic / " + sFactor + ", 2), "
                                    + "iva_porc_ret = ROUND(iva_porc_ret / " + sFactor + ", 2), "
                            ...
                            Conn.executeUpdate("UPDATE creditoadicional SET monto = ROUND(monto / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE creditoadicional_det SET monto = ROUND(monto / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE creditoadicional_rpt_summary SET monto = ROUND(monto / " + sFactor + ", 2)");
                            Conn.executeUpdate("UPDATE imp_mun_det SET total_fact = ROUND(total_fact / " + sFactor + ", 2), "
                            ...
                            Conn.executeUpdate("UPDATE islr_retencion_det SET total_fact = ROUND(total_fact / " + sFactor + ", 2), "
                                    + "base_imponible = ROUND(base_imponible / " + sFactor + ", 2), "
                                    + "gravable_bs = ROUND(gravable_bs / " + sFactor + ", 2), "
                                    + "islr_porc_ret = ROUND(islr_porc_ret / " + sFactor + ", 2), "
                                    + "islr_retenido_bs = ROUND(islr_retenido_bs / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE iva_retencion_det SET total_fact = ROUND(total_fact / " + sFactor + ", 2), "
                            ...
                            Conn.executeUpdate("UPDATE neg_pri_det SET total_fact = ROUND(total_fact / " + sFactor + ", 2), "
                                    + "base_imponible = ROUND(base_imponible / " + sFactor + ", 2), "
                                    + "gravable_bs = ROUND(gravable_bs / " + sFactor + ", 2), "
                                    + "retenido_bs = ROUND(retenido_bs / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE orden_pago SET total_bs = ROUND(total_bs / " + sFactor + ", 2),"
                            ...
                            Conn.executeUpdate("UPDATE ordenpago_aux_report SET total = ROUND(total / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE ordenpago_rpt_summary SET total = ROUND(total / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE otras_ret_det SET total_fact = ROUND(total_fact / " + sFactor + ", 2), "
                                    + "base_imponible = ROUND(base_imponible / " + sFactor + ", 2), "
                                    + "gravable_bs = ROUND(gravable_bs / " + sFactor + ", 2), "
                                    + "retenido_bs = ROUND(retenido_bs / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE presupe SET monto_ini = ROUND(monto_ini / " + sFactor + ", 2), "
                                    + "monto = ROUND(monto / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE presupi SET monto_ini = ROUND(monto_ini / " + sFactor + ", 2), "
                                    + "monto = ROUND(monto / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE tmppptoadicional SET monto_ini = ROUND(monto_ini / " + sFactor + ", 2), "
                                    + "monto = ROUND(monto / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE trasp_part_rpt_summary SET monto = ROUND(monto / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE trasppartidas SET monto = ROUND(monto / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE trasppartidas_det SET monto = ROUND(monto / " + sFactor + ", 2)");

                            Conn.executeUpdate("UPDATE unidad_tributaria_aplic SET valor_bs = ROUND(valor_bs / " + sFactor + ", 2)");
                            ...
                            try {
                                ...
                                JOptionPane.showMessageDialog(this, "Error al tratar de reversar la operación" + System.getProperty("line.separator") + _ex2);
                            }

                            JOptionPane.showMessageDialog(this, "Error al tratar de actualizar la Base de Datod" + System.getProperty("line.separator") + _ex);
                        } finally {
                            setCursor(null);
                        }
                    }
