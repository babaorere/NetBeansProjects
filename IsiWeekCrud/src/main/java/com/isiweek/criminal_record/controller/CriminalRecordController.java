package com.isiweek.criminal_record.controller;
...
public class CriminalRecordController {
    ...
    public String add(
        ...
        if (!bindingResult.hasFieldErrors("name") && criminalRecordService.nameExists(criminalRecordDTO.getName())) {
    ...
    public String edit(@PathVariable(name = "id") final Long id,
            @ModelAttribute("criminalRecord") @Valid final CriminalRecordDTO criminalRecordDTO,
            final BindingResult bindingResult, final RedirectAttributes redirectAttributes) {
        final CriminalRecordDTO currentCriminalRecordDTO = criminalRecordService.get(id);
        if (!bindingResult.hasFieldErrors("name") &&
                !criminalRecordDTO.getName().equalsIgnoreCase(currentCriminalRecordDTO.getName()) &&
                criminalRecordService.nameExists(criminalRecordDTO.getName())) {
            bindingResult.rejectValue("name", "Exists.criminalRecord.name");
        }
        if (bindingResult.hasErrors()) {
            return "criminalRecord/edit";
