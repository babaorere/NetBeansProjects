...
@Documented
@Constraint(validatedBy = CompanyEmailUnique.CompanyEmailUniqueValidator.class)
public @interface CompanyEmailUnique {

    String message() default "{Exists.company.email}";

    Class<?>[] groups() default {};

    Class<? extends Payload>[] payload() default {};

    class CompanyEmailUniqueValidator implements ConstraintValidator<CompanyEmailUnique, String> {

        private final CompanyService companyService;
        private final HttpServletRequest request;

        public CompanyEmailUniqueValidator(final CompanyService companyService, final HttpServletRequest request) {
        ...
        public boolean isValid(final String value, final ConstraintValidatorContext cvContext) {
            ...
            if (currentId != null) {
                try {
                    ...
                    if (value.equalsIgnoreCase(existingCompany.getEmail())) {
                        // Email hasn't changed, consider it valid
                        return true;
                    }
            ...
            return !companyService.emailExists(value);
        }
