...
public class LenderService {
    ...
    public ReferencedWarning getReferencedWarning(final Long id) {
        ...
        final Lender lender = lenderRepository.findById(id)
                .orElseThrow(NotFoundException::new);
        final LoanContract customerLoanContract = loanContractRepository.findFirstByCustomer(lender);
        if (customerLoanContract != null) {
            referencedWarning.setKey("lender.loanContract.customer.referenced");
            referencedWarning.addParam(customerLoanContract.getId());
