...
public class StatusEntityController {
    ...
    public StatusEntityController(final StatusEntityService statusEntityService) {
    ...
    @GetMapping("/add")
    public String add(@ModelAttribute("statusEntity") final StatusEntityDTO statusEntityDTO) {
        return "statusEntity/add";
    }

    @PostMapping("/add")
    public String add(@ModelAttribute("statusEntity") @Valid final StatusEntityDTO statusEntityDTO,
    ...
    public String edit(@PathVariable(name = "id") final Long id,
            @ModelAttribute("statusEntity") @Valid final StatusEntityDTO statusEntityDTO,
            final BindingResult bindingResult, final RedirectAttributes redirectAttributes) {
        if (bindingResult.hasErrors()) {
            return "statusEntity/edit";
        }
