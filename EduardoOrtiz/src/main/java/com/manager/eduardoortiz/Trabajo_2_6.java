...
//        final String nameFileOut = "C:/SEXTA.txt";
/**/
        // Para Linux
        final String nameFileIn = "/home/manager/UNICOS.txt";
        final String nameFileOut = "/home/manager/SEXTA.txt";
        ...
        try {
            ...
            while ((lineaIn = br.readLine()) != null) {
                ...
                // Separar la lineas en campos separados por espacio, puntos, comas, punto y coma
