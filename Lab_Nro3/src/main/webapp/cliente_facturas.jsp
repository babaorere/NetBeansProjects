...
<%@page import="com.webapp.lab_nro3.OCFactura" %>
...
<%
    ...
    List<Factura> list= Factura.getListCliente(numero);
...
<html>
    <head>
        ...
        <title>Cliente. Tabla de Facturas</title>
    ...
    <body>
        ...
        <h1 class="mycenter">Cliente. Tabla de Facturas</h1>
        <br>
        <ul>
            <li></li>
            <li></li>
