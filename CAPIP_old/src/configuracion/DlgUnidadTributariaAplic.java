...
public class DlgUnidadTributariaAplic extends javax.swing.JDialog {
    ...
    private void setCompBehavior() {
        ...
        tblMaster.getSelectionModel().addListSelectionListener((ListSelectionEvent _lse) -> {
    ...
    private void initComponents() {
        ...
        txtDesc.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        ...
        txtFechaVigencia.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        ...
        btnNew.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        txtValorBs.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Decreto / Descripción", "Fecha Vigencia", "Valor Bs.", "Reg"
            }
        ) {
        ...
        btnReturn.setBackground(new java.awt.Color(153, 153, 0));
        btnReturn.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
        btnReturn.setText("RETORNAR");
        btnReturn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
    ...
    private void txtFechaVigenciaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFechaVigenciaKeyTyped
    ...
    private void txtValorBsKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtValorBsKeyTyped
        if (txtValorBs.getText().length() >= 20) {
            evt.consume();
        }
    }//GEN-LAST:event_txtValorBsKeyTyped

    private void txtValorBsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtValorBsActionPerformed
    ...
    private void actUpdateTbl() {
        ...
        try {
            final ResultSet rs = Conn.executeQuery("SELECT * FROM unidad_tributaria_aplic ORDER BY fecha_vigencia DESC");
            while (rs.next()) {
     ...
     *
     */
    private boolean actValidSaveNew(final Map<String, Object> _param) {
        ...
        if (actValid(_param)) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    if (((java.sql.Date) _param.get("fecha_vigencia")).compareTo(fechaUltIVA) <= 0) {
                        throw new Exception("Fecha de Vigencia inválida");
                    }
                }
            } catch (final Exception _ex) {
                JOptionPane.showMessageDialog(this, "Error. No es posible validar la Fecha de Vigencia" + System.getProperty("line.separator") + _ex);
     ...
     *
     */
    private boolean actValidSaveOld(final Map<String, Object> _param) {

        final int rowSel = tblMaster.getSelectedRow();
        if (rowSel < 0) {
            return false;
        }
        _param.put("id_unidad_tributaria_aplic", ((UTModel) tblMaster.getValueAt(rowSel, COL_REG)).getId_unidad_tributaria_aplic());

        return actValid(_param);
    }
     ...
     *
     */
    private boolean actValid(final Map<String, Object> _param) {
        ...
        _param.put("desc", desc);
        _param.put("fecha_vigencia", fecha_vigencia);
        _param.put("valor_bs", valor_bs);
     ...
     *
     */
    private boolean actSaveNew(final Map<String, Object> _param) {

        try {
            final PreparedStatement pst = Conn.getConnection().prepareStatement("INSERT INTO unidad_tributaria_aplic"
                + "(id_user, id_session, date_session, descripcion, fecha_vigencia, valor_bs) "
                + "VALUES (?, ?, ?, ?, ?, ?)");
            pst.setLong(1, UserPassIn.getIdUser());
            pst.setLong(2, UserPassIn.getIdSession());
            pst.setTimestamp(3, UserPassIn.getDateSession());
            pst.setString(4, (String) _param.get("desc"));
            pst.setDate(5, (java.sql.Date) _param.get("fecha_vigencia"));
            pst.setBigDecimal(6, (BigDecimal) _param.get("valor_bs"));
     ...
     * Rev 04/10/2016
     */
    private boolean actSaveOld(final Map<String, Object> _param) {

        try {
            final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE unidad_tributaria_aplic "
                + "set id_user= ?, id_session= ?, date_session= ?, descripcion= ?, fecha_vigencia= ?, valor_bs= ? "
                + "WHERE id_unidad_tributaria_aplic= ?");
            pst.setLong(1, UserPassIn.getIdUser());
            pst.setLong(2, UserPassIn.getIdSession());
            pst.setTimestamp(3, UserPassIn.getDateSession());
            pst.setString(4, (String) _param.get("desc"));
            pst.setDate(5, (java.sql.Date) _param.get("fecha_vigencia"));
            pst.setBigDecimal(6, (BigDecimal) _param.get("valor_bs"));
            pst.setLong(7, (long) _param.get("id_unidad_tributaria_aplic"));
            if (pst.executeUpdate() != 1) {
                throw new Exception("Error. Al actualizar el Registro");
            }

            UTModel reg = UTModel.getxID((long) _param.get("id_unidad_tributaria_aplic"));
