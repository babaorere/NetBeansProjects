...
public class DlgIvaPorcAplic extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbxPartida = new javax.swing.JComboBox<String>();
        ...
        txtValorPorc.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        cbxPartida.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
...
//        }
    ...
    private boolean actValidSaveOld(final Map<String, Object> _param) {
        ...
        _param.put("id_iva_aplicado", ((IvaAplicModel) tblMaster.getValueAt(rowSel, COL_REG)).getId_iva_aplicado());

        return actValidSaveNew(_param);
    }
    ...
    private boolean actValidSaveNew(final Map<String, Object> _param) {
        ...
        _param.put("id_part_ppto", reg.getId());
        _param.put("valor_porc", valorPorc);
        return true;
    }
    ...
    private boolean actSaveNew(final Map<String, Object> _param) {
        ...
        if (!_param.containsKey("id_part_ppto") || !_param.containsKey("valor_porc")) {
            return false;
        }

        final int codigo = (Integer) _param.get("id_part_ppto");
        final BigDecimal valor_porc = (BigDecimal) _param.get("valor_porc");

        try {
            final PreparedStatement pst = Conn.getConnection().prepareStatement("INSERT INTO iva_aplicado"
    ...
    private boolean actSaveOld(final Map<String, Object> _param) {
        ...
        if (!_param.containsKey("id_iva_aplicado") || !_param.containsKey("id_part_ppto") || !_param.containsKey("valor_porc")) {
            return false;
        }

        final long id_iva_aplicado = (Long) _param.get("id_iva_aplicado");
        final int id_part_ppto = (Integer) _param.get("id_part_ppto");
        final BigDecimal valor_porc = (BigDecimal) _param.get("valor_porc");

        try {
            final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE iva_aplicado "
    ...
    private void cargarComboPartida() {
        ...
        try {
            final ResultSet rs = Conn.executeQuery("SELECT * FROM presupe ORDER BY codigo ASC");
            while (rs.next()) {
