...
public final class ORet_Rend extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public ORet_Rend(final java.awt.Window _parent) {
        super();
        initComponents();
    ...
    private void initComponents() {
        ...
        chkFilter.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
...
//        dispose();
    ...
    private void ReporteRendicion() {
        ...
        for (int i = 0; i < tblMaster.getRowCount(); i++) {
            ...
            list.add(new ORetRptModel(new java.util.Date(reg.getEjefis().getTime()), reg.getAnulado_sn().equals("S") ? "S" : "",
                reg.getId_otras_ret(), reg.getNum_fact(), reg.getBenef_rif_ci(), reg.getBenef_razonsocial(),
