...
public final class OtrasRet_DetModel {
     ...
     *
     */
    public OtrasRet_DetModel(final ResultSet _rs) throws Exception {
        id_otras_ret_det = _rs.getLong("id_otras_ret_det");
    ...
    public static ArrayList<OtrasRet_DetModel> getxId_causado(final long id_causado) throws Exception {
        ...
        final ResultSet rs = Conn.executeQuery("SELECT * FROM otras_ret_det WHERE id_causado= " + id_causado);
        while (rs.next()) {
     ...
     * @throws Exception
     */
    public static ArrayList<OtrasRet_DetModel> getxId_retencion(final long _id) throws Exception {
        ArrayList<OtrasRet_DetModel> list = new ArrayList<>();

        final ResultSet rs = Conn.executeQuery("SELECT * FROM otras_ret_det WHERE id_otras_ret= " + _id);
        while (rs.next()) {
            list.add(new OtrasRet_DetModel(rs));
        }
     ...
     * @throws Exception
     */
    public static OtrasRet_DetModel getxId(final long _id) throws Exception {

        final ResultSet rs = Conn.executeQuery("SELECT * FROM otras_ret_det WHERE id_otras_ret_det= " + _id);
        if (rs.next()) {
