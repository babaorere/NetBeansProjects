...
public final class TraspPartidas extends XJFrame {
     ...
     * @param _parent
     */
    public TraspPartidas(final JFrame _parent) {
        super(_parent);
        initComponents();
    ...
    private void setStartConditions() {
        ...
        try {
            ...
            Conn.getConnection().prepareStatement("DELETE FROM trasppartidas_det WHERE id_trasp= 0 AND DATE(date_session) <= '" + sFchDelete + "'").executeUpdate();
        } catch (final Exception _ex) {
    ...
    protected void UpdatePanels() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de cargar la tabla Origen" + System.getProperty("line.separator") + _ex);
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al tratar de cargar la tabla Destino" + System.getProperty("line.separator") + _ex);
        }
    ...
    private void initComponents() {
        ...
        btnPptoEgresoOrg.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        btnPptoEgresoOrg.setSelected(true);
        ...
        btnPptoIngresoOri.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        txtMontoTotalOri.setFont(new java.awt.Font("Tahoma", 2, 14)); // NOI18N
        txtMontoTotalOri.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtMontoTotalOri.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        ...
        btnPptoGastoDest.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        jtbPptoIngresoDest.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        txtMontoTotalDest.setFont(new java.awt.Font("Tahoma", 2, 14)); // NOI18N
        txtMontoTotalDest.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtMontoTotalDest.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        ...
        jtConcepto.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        jtConcepto.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        jtReferencia.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        jtReferencia.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jtReferencia.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        txtFechaTrasp.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        txtFechaTrasp.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        txtMontoTrasp.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        txtMontoTrasp.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtMontoTrasp.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        jbGenerar.setBackground(new java.awt.Color(153, 153, 0));
        jbGenerar.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        jbConsultar.setBackground(new java.awt.Color(153, 153, 0));
        jbConsultar.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
    ...
    private void jbGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGenerarActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al formatear monto origen" + System.getProperty("line.separator") + _ex);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al formatear monto destino" + System.getProperty("line.separator") + _ex);
            return;
        }
        ...
        try {
            ...
            for (int i = 0; i < tblOrigen.getRowCount(); i++) {
                ...
                final PreparedStatement pstPpto = Conn.getConnection().prepareStatement("SELECT * FROM " + strPpto + " WHERE codigo= ? AND ejefis= ? FOR UPDATE");
                ...
                final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE " + strPpto + " SET monto= monto - ? WHERE id= ?");
                ...
                final PreparedStatement pstTraspDet = Conn.getConnection().prepareStatement("UPDATE trasppartidas_det set id_trasp= ?  WHERE id_trasp_det= ?");
            ...
            for (int i = 0; i < tblDestino.getRowCount(); i++) {
                ...
                final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE " + strPpto + " SET monto= monto + ? WHERE codigo= ? AND ejefis= ?");
                pst.setBigDecimal(1, regTraspDet.getMonto());
