...
public final class BancosTransferencia extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public BancosTransferencia(final java.awt.Window _parent) {
     ...
     *
     */
    private String trimBanco(String _auxBanco) {
        if (_auxBanco == null) {
            return "";
        }

        String aux = _auxBanco.trim();
        if (aux.isEmpty()) {
            return "";
        }
    ...
    private void initComponents() {
        ...
        cbxDes = new javax.swing.JComboBox<String>();
        cbxOri = new javax.swing.JComboBox<String>();
        ...
        btnNuevo.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 940, 630));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (edo == edoNuevo) {
            ...
            try {
                ...
                final PreparedStatement pstOri = Conn.getConnection().prepareStatement("INSERT INTO bancos_operaciones("
                ...
                final ResultSet rsID = Conn.getConnection().prepareStatement("SELECT last_insert_id() AS last_id FROM bancos_operaciones").executeQuery();
                final int idOri;
                if (rsID.next()) {
                ...
                final PreparedStatement pstDest = Conn.getConnection().prepareStatement("INSERT INTO bancos_operaciones("
                    + "cuenta, banco, descripcion, fecha, tipo_operacion, " // 1, 2, 3, 4, 5
                    + "soporte_o_cheque, conciliado, debe, haber, id_trans_ori, " // 6, 7, 8, 9, 10
                    + "cuenta_numop, cuenta_numop_tipo, num_pag_ava, " // 11, 12, 13
                    + "ejefis, ejefismes, iduser) " // 14, 15, 16
            ...
            try {
                ...
                final ResultSet rsDest = Conn.getConnection().prepareStatement("SELECT * FROM bancos_operaciones "
                ...
                final PreparedStatement pstDest = Conn.getConnection().prepareStatement("UPDATE bancos_operaciones SET soporte_o_cheque= ?, descripcion= ?, debe= ?  "
    ...
    private void btnReversarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReversarActionPerformed
        ...
        try {
            final PreparedStatement pst = Conn.getConnection().prepareStatement("DELETE FROM bancos_operaciones WHERE  id='" + id + "' AND anulado_sn= 'N'");
            ...
            if (JOptionPane.showConfirmDialog(this, "¿ Seguro desea Reversar ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                ...
                final ResultSet rsDes = Conn.getConnection().prepareStatement("SELECT * FROM bancos_operaciones "
