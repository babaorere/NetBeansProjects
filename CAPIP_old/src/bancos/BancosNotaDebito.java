 ...
 */
public final class BancosNotaDebito extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public BancosNotaDebito(final java.awt.Window _parent) {
    ...
    public static String fechaActual() {
        java.util.Date fecha = Globales.getServerTimeStamp();
     ...
     * @param cuenta
     */
    private void MostrarDatosBancosDet(String cuenta) {
        ...
        final String sql;
        if (cuenta.isEmpty()) {
            sql = "SELECT * FROM bancos_operaciones WHERE tipo_operacion='ND' AND anulado_sn= 'N' ORDER BY id DESC";
        } else {
            sql = "SELECT * FROM bancos_operaciones  WHERE cuenta='" + cuenta + "' && tipo_operacion='ND' AND anulado_sn= 'N' ORDER BY id DESC";
        }
    ...
    private void initComponents() {
        ...
        setTitle("NOTAS DE DEBITO BANCARIO");
        setResizable(false);
        ...
        tblMaster.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "FECHA", "SOPORTE", "DESCRIPCIÓN", "MONTO BS.", "Reg"
            }
        ) {
        ...
        jLabel3.setText("DEBITOS BANCARIOS");
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 60, -1, -1));
        ...
        jLabel1.setText("TOTAL DEBITOS BS.");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        final String sMonto = txtMonto.getText().trim();
        if (sMonto.isEmpty()) {
        ...
        final String tipo_operacion = "ND";
        ...
        if (edo == edoNuevo) {
            try {
                ...
                pst.setDouble(8, 0.00d); // debe
                pst.setDouble(9, monto); // haber
            ...
            try {
                ...
                final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE bancos_operaciones SET soporte_o_cheque= ?, descripcion= ?, haber= ? "
    ...
    private void btnReversarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReversarActionPerformed
        ...
        try {
            ...
            if (JOptionPane.showConfirmDialog(this, " ¿ Seguro desea Reversar ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                ...
                final Double monto = reg.getHaber();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new BancosNotaDebito(null).setVisible(true);
            }
        });
    }
