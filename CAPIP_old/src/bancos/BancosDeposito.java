...
public final class BancosDeposito extends javax.swing.JFrame {
     ...
     * @param _parent
     */
    public BancosDeposito(final java.awt.Window _parent) {
    ...
    private void initComponents() {
        ...
        cmbCuentas.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        cmbCuentas.setForeground(new java.awt.Color(0, 51, 153));
        ...
        getContentPane().add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 60, -1, -1));
        ...
        txtSoporte.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        txtSoporte.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtSoporte.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtSoporte.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        txtSoporte.setEnabled(false);
        ...
        txtDescrip.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        txtDescrip.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtDescrip.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        txtDescrip.setEnabled(false);
        ...
        txtMonto.setBackground(new java.awt.Color(204, 153, 0));
        ...
        btnReversar.setFont(new java.awt.Font("Arial", 3, 14)); // NOI18N
        ...
        jtTotal.setBackground(new java.awt.Color(204, 102, 0));
        jtTotal.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        jtTotal.setDisabledTextColor(new java.awt.Color(102, 0, 0));
        jtTotal.setEnabled(false);
        jtTotal.setFont(new java.awt.Font("Arial", 3, 24)); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            final PreparedStatement pst = Conn.getConnection().prepareStatement("SELECT * FROM bancos_operaciones "
        ...
        if (edo == edoNuevo) {
            try {
                ...
                final PreparedStatement pst = Conn.getConnection().prepareStatement("INSERT INTO bancos_operaciones("
                    ...
                    + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                pst.setString(1, cuenta); // cuanta
                pst.setString(2, banco); // banco
                pst.setString(3, desc); // desc
                pst.setString(4, sFecha); // fecha
                pst.setString(5, tipo_operacion); // tipo
                pst.setString(6, soporte); // soporte
                pst.setString(7, ""); // conciliado
                pst.setDouble(8, monto); // debe
                pst.setDouble(9, 0.00d); // haber
                pst.setLong(10, ModelMapNextOp.getNext(Globales.getEjeFisYear(), cuenta)); // cuenta_numop
...
//                BancosContabilidad.sumarCuenta(cuenta, monto);
                ...
                JOptionPane.showMessageDialog(null, "Error al guardar los datos: " + System.getProperty("line.separator") + _ex);
                txtSoporte.requestFocusInWindow();
            }
            ...
            try {
                ...
                final PreparedStatement pst = Conn.getConnection().prepareStatement("UPDATE bancos_operaciones SET soporte_o_cheque= ?, descripcion= ?, debe= ? "
    ...
    private void btnReversarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReversarActionPerformed
        ...
        try {
            if (JOptionPane.showConfirmDialog(this, " ¿ Seguro desea Reversar ?", "Confirmar acción", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                ...
                final PreparedStatement pst = Conn.getConnection().prepareStatement("DELETE FROM bancos_operaciones "
