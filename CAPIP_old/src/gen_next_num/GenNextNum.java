...
public final class GenNextNum {
     ...
     * @param _sub_clave
     */
    public GenNextNum(final String _sub_clave) {
        CLAVE = String.valueOf(Globales.getEjeFisYear()) + "-" + _sub_clave.trim();
        id = 0;
    }
    ...
    public long checkNum() throws Exception {
        ...
        do {
            try (final PreparedStatement pst = Conn.getConnection().prepareStatement("SELECT * FROM map_next_id WHERE clave = ?")) {
