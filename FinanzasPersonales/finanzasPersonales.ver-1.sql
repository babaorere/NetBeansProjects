...
CREATE TABLE `tipoDeGastos` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_TipoDeGastos_Usuario_idx` (`Usuario_id`),
  KEY `fk_TipoDeGastos_Resultado_idx` (`Resultado_id`),
  CONSTRAINT `fk_TipoDeGastos_Resultado` FOREIGN KEY (`Resultado_id`) REFERENCES `resultado` (`id`),
  CONSTRAINT `fk_TipoDeGastos_Usuario` FOREIGN KEY (`Usuario_id`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tipoDeIngreso` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_TipoDeIngreso_Usuario_idx` (`Usuario_id`),
  KEY `fk_TipoDeIngreso_Resultado1_idx` (`Resultado_id`),
  CONSTRAINT `fk_TipoDeIngreso_Resultado1` FOREIGN KEY (`Resultado_id`) REFERENCES `resultado` (`id`),
  CONSTRAINT `fk_TipoDeIngreso_Usuario` FOREIGN KEY (`Usuario_id`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
FLUSH PRIVILEGES;
CREATE USER  IF NOT EXISTS  `mydbUser`@`localhost` IDENTIFIED BY '@12PASSword34';
