...
import Controller.TipoDeGasto.TipoDeGastoCrudController;
 ...
 *
 */
public final class TipoDeGastoCrudDialog extends javax.swing.JDialog {
     ...
     * @param inWin
     */
    public TipoDeGastoCrudDialog(final java.awt.Window inWin) {
        ...
        this.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosing(java.awt.event.WindowEvent e) {
                ...
                java.awt.EventQueue.invokeLater(() -> {
                    TipoDeGastoCrudController.actionSalir(me);
                });
            }
        });
    ...
    private void initComponents() {
        ...
        tblTabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Marca", "ID", "Tipo", "Usuario", "Monto"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Boolean.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class
            };
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        TipoDeGastoCrudController.Crear(this);
    }//GEN-LAST:event_btnCrearActionPerformed

    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        TipoDeGastoCrudController.Modificar(this);
    }//GEN-LAST:event_btnModificarActionPerformed

    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        TipoDeGastoCrudController.Eliminar(this);
        llenarTabla();
    }//GEN-LAST:event_btnEliminarActionPerformed

    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        TipoDeGastoCrudController.actionSalir(this);
    }//GEN-LAST:event_btnCancelarActionPerformed

    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        TipoDeGastoCrudController.Consultar(this);
    ...
    private void llenarTabla() {
        ...
        int iRow = 0;
        for (TipoDeGasto item : list) {
            row[0] = false;
            row[1] = item.getId();
            row[2] = item.getTipoDeGastos();
            row[3] = item.getUsuario().getNickname();
            row[4] = item.getValorGasto();
