package View.TipoDeGasto;

import static Controller.LoginController.actionSalir;
import Controller.TipoDeGasto.TipoDeGastoCruController;
 ...
 * @author manager
 */
public final class TipoDeGastoCruDialog extends javax.swing.JDialog {

    private Optional<TipoDeGasto> registroOpt;
     ...
     * @param inEditar
     */
    public TipoDeGastoCruDialog(final java.awt.Window inWin, Optional<TipoDeGasto> InRegistro, boolean inEditar) {
    ...
    public void myInitComponents() {
        ...
        this.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosing(java.awt.event.WindowEvent e) {
                ...
                java.awt.EventQueue.invokeLater(() -> {
                    TipoDeGastoCruController.actionSalir(me);
                });
            }
        });
        ...
        if (registroOpt.isPresent()) {
            TipoDeGasto registro = registroOpt.get();

            txtId.setText(String.valueOf(registro.getId()));
            cmbUsuario.setSelectedItem(registro.getUsuario().getNickname());
            txtTipo.setText(registro.getTipoDeGastos());
            txtValor.setText(String.valueOf(registro.getValorGasto()));
            txtFecha.setText(registro.getFechaGasto().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")));
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        TipoDeGasto registro = new TipoDeGasto(id, usuario, tipo, valor, fecha);

        // Guardar
        try {
            Optional<Integer> pkOpt = TipoDeGastoCruController.Crear(registro);
            if (pkOpt.isPresent()) {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        // Guardar
        try {
            Optional<Integer> pkOpt = TipoDeGastoCruController.Modificar(registro);
            if (pkOpt.isPresent()) {
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        TipoDeGastoCruController.actionSalir(this);
