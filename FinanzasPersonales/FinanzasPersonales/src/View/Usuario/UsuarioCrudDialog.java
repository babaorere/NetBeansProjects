 ...
 *
 */
public final class UsuarioCrudDialog extends javax.swing.JDialog {
     ...
     * @param inWin
     */
    public UsuarioCrudDialog(final java.awt.Window inWin) {
    ...
    private void initComponents() {
        ...
        if (tblTabla.getColumnModel().getColumnCount() > 0) {
            ...
            tblTabla.getColumnModel().getColumn(3).setMinWidth(125);
            tblTabla.getColumnModel().getColumn(3).setPreferredWidth(125);
            tblTabla.getColumnModel().getColumn(3).setMaxWidth(125);
        }
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        UsuarioCrudController.CrearUsuario(this);
    }//GEN-LAST:event_btnCrearActionPerformed

    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        UsuarioCrudController.ModificarUsuario(this);
    }//GEN-LAST:event_btnModificarActionPerformed

    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        UsuarioCrudController.EliminarUsuario(this);
        llenarTabla();
    }//GEN-LAST:event_btnEliminarActionPerformed

    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        UsuarioCrudController.actionSalir(this);
    }//GEN-LAST:event_btnCancelarActionPerformed

    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        UsuarioCrudController.ConsultarUsuario(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuarioCrudDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                UsuarioCrudDialog dialog = new UsuarioCrudDialog(new javax.swing.JFrame());
    ...
    private void llenarTabla() {
        ...
        for (Usuario usuario : list) {
            row[0] = false;
            row[1] = usuario.getId();
            row[2] = usuario.getNombreCompleto();
            row[3] = usuario.getFecha().toLocalDate();
