 ...
 *
 */
public final class BitacoraCreate extends javax.swing.JDialog {

    public BitacoraCreate(java.awt.Window parent) {
    ...
    private void initComponents() {
        ...
        setTitle("Consumir Servicio");

        jLabel1.setFont(new java.awt.Font("Noto Sans", 0, 18)); // NOI18N
        jLabel1.setText("Consumir Servicio");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        Bitacora b = new Bitacora(null, c.getIdcliente(), s.getIdServicio(), texto);
        Optional<Bitacora> ob = bCrud.create(b);

        if (!ob.isPresent()) {
            JOptionPane.showMessageDialog(null, "Bitacoora no creado");
            cmbCliente.requestFocus();
            return;
        }

        JOptionPane.showMessageDialog(this, "Bitacora creada con exito");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new BitacoraCreate(null).setVisible(true);
        });
    }
