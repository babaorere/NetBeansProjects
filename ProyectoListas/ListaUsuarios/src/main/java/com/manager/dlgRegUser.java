 ...
 * @author manager
 */
public class dlgRegUser extends javax.swing.JDialog {
     ...
     * @param parent
     */
    public dlgRegUser(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
     ...
     * @return
     */
    public Nodo InsertarInicio(Nodo ic, String cod, String nom, String ape, String sex, float suel) {
    ...
    public Nodo InsertarFinal(Nodo ic, String cod, String nom, String ape, String sex, float suel) {
        ...
        if (ic != null) {
            ...
            Nodo nAnt = ic.enlaceAnt;

            nuevo.enlaceSig = ic;
            ic.enlaceAnt = nuevo;

            nAnt.enlaceSig = nuevo;
            nuevo.enlaceAnt = nAnt;
        }
    ...
    void Resumen() {
        ...
        if (ic != null) {
            ...
            txtSuelMayor.setText(String.valueOf(mayor));
            txtMonto.setText(String.valueOf(df2.format(suma)));
        }
    }
    ...
    private void btnGuardarIniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarIniActionPerformed
        ...
        ic = InsertarInicio(ic, cod, nom, ape, sex, suel);
        LimpiarEntradas();
        VerDatos();
        Resumen();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgRegUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                dlgRegUser dialog = new dlgRegUser(new JFrame());
