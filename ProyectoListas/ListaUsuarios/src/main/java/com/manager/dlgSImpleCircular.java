...
public class dlgSImpleCircular extends javax.swing.JDialog {
    ...
    void Resumen() {
        ...
        if (ic != null) {
            ...
            txtMonto.setText(String.valueOf(mayor));
        }
    }
    ...
    private void initComponents() {
        ...
        btnBuscar.setMaximumSize(new java.awt.Dimension(150, 30));
        btnBuscar.setMinimumSize(new java.awt.Dimension(150, 30));
